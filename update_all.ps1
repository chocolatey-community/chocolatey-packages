...
$Options = [ordered]@{
    ...
    Report = @{
        ...
        Params= @{                                          #Report parameters:
            ...
            UserMessage = "[Ignored](#ignored) | [History](#update-history) | [Force Test](https://gist.github.com/$Env:gist_id_test) | [Releases](https://github.com/chocolatey/chocolatey-coreteampackages/tags) | **TESTING AU STREAMS VERSION**"       #  Markdown, Text: Custom user message to show
    ...
    Mail = if ($Env:mail_user) {
            @{
                ...
                UserMessage = 'Update status: https://gist.github.com/choco-bot/a14b1e5bfaf70839b338eb1ab7f8226f'
