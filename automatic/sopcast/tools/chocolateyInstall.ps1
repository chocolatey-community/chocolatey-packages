...
$uninstallRegistryPath_x86 = "HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\SopCast"
$uninstallRegistryPath_x64 = "HKLM:\Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\SopCast"
$installerType = 'EXE'
$url = '{{DownloadUrl}}'
$silentArgs = '/S'
