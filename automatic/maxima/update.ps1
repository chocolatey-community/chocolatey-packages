...
function global:au_GetLatest {
    ...
    @{
        ...
        URL64        = "https://sourceforge.net/projects/maxima/files/Maxima-Windows/${version}-Windows/maxima-sbcl-${version}-win64.exed"
        ReleaseNotes = "https://sourceforge.net/p/maxima/code/ci/master/tree/ChangeLog-${version}"
    }
}
