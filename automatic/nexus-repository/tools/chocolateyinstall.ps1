...
$PackageArgs = @{
  ...
  url64          = 'https://sonatype-download.global.ssl.fastly.net/repository/downloads-prod-group/3/nexus-3.64.0-03-win64.zip'
  checksum64     = '4cf43a6a86f62cea443717cc9faca5fc938f5c8a404d8a163f058e366abfd242'
