...
$PackageArgs = @{
  ...
  url64          = 'https://sonatype-download.global.ssl.fastly.net/repository/downloads-prod-group/3/nexus-3.63.0-01-win64.zip'
  checksum64     = '0adf124c6460563715255fe7adc443c92e638de2e67f38dc7fc074ef07acfac1'
