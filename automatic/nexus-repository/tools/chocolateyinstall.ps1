...
$PackageArgs = @{
  ...
  url64          = 'https://sonatype-download.global.ssl.fastly.net/repository/downloads-prod-group/3/nexus-3.57.0-01-win64.zip'
  checksum64     = '8966890107554f9ed4e3d4906a76f2b620fd483a71bf7e4fbc1f72ee3d743fe1'
