...
$packageArgs = @{
  ...
  fileType       = '7z'
  url            = ''
  url64          = 'https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/weekly-builds/FreeCAD_0.20.26155_Win-LPv12.5.4_vc17.x-x86-64.7z'
  softwareName   = 'FreeCAD'
  checksum       = ''
  checksumType   = ''
  checksum64     = '7D365CBFA931AE683C33F425C62CF6A6D2387DE93CD753790956448272B20A87'
