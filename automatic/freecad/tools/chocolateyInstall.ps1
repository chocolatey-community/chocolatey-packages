...
$packageArgs = @{
  packageName    = 'freecad'
  fileType       = '7z'
  url64          = 'https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/weekly-builds/FreeCAD_weekly-builds-38946-conda-Windows-x86_64-py311.7z'
  softwareName   = 'FreeCAD'
  checksum64     = 'D144BBABE791655DD1E0758BBD59A6D61C72CD56AD0E68593A0533B8861C55B8'
