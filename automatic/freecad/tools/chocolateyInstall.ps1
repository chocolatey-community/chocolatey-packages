...
$packageArgs = @{
  ...
  fileType       = '7z'
  url            = ''
  url64          = 'https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/weekly-builds/FreeCAD_weekly-builds-31155-2022-12-08-conda-Windows-x86_64-py38.7z'
  softwareName   = 'FreeCAD'
  checksum       = ''
  checksumType   = ''
  checksum64     = '7B64B72E4D8F166FA8DD7F79CC1675A2617BE1882180E3016386B72BE977B667'
