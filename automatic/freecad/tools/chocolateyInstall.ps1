...
$packageArgs = @{
  packageName    = 'freecad'
  fileType       = '7z'
  url64          = 'https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/weekly-builds/FreeCAD_weekly-builds-42523-conda-Windows-x86_64-py311.7z'
  softwareName   = 'FreeCAD'
  checksum64     = '8A4C1415773205E314F98A87012F78B77F8176345C06839BDE7A53D5F82AB7CA'
