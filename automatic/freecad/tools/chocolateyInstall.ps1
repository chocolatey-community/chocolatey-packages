...
$packageArgs = @{
  ...
  fileType       = '7z'
  url            = ''
  url64          = 'https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/weekly-builds/FreeCAD_0.20.26858_Win-LPv12.5.4_vc17.x-x86-64.7z'
  softwareName   = 'FreeCAD'
  checksum       = ''
  checksumType   = ''
  checksum64     = '4F020E4F8D5F2186E902825421A391C62AB4BFC4AFA1B2A50A263AB928446FEF'
