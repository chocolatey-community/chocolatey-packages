...
$packageArgs = @{
  packageName    = 'freecad'
  fileType       = '7z'
  url64          = 'https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/weekly-builds/FreeCAD_weekly-builds-38506-conda-Windows-x86_64-py311.7z'
  softwareName   = 'FreeCAD'
  checksum64     = 'CFAE0C710768858C981871C487DBC66506392A08FB81BC1C4EC85CD165BE197E'
