...
$packageArgs = @{
  packageName    = 'freecad'
  fileType       = '7z'
  url64          = 'https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/weekly-builds/FreeCAD_weekly-builds-39240-conda-Windows-x86_64-py311.7z'
  softwareName   = 'FreeCAD'
  checksum64     = '5C9D87EB0E04580A2EB798A547CDF7417D10F9B43E1968CCD33C288604CD5B1F'
