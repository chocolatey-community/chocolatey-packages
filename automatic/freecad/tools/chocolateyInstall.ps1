...
$packageArgs = @{
  packageName    = 'freecad'
  fileType       = '7z'
  url64          = 'https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/weekly-builds/FreeCAD_weekly-builds-42340-conda-Windows-x86_64-py311.7z'
  softwareName   = 'FreeCAD'
  checksum64     = 'ED3AA640EFB799F9516D0F41409CD187F4E103853385B717CBF63A0FDA4D5A84'
