...
$packageArgs = @{
  ...
  fileType       = '7z'
  url            = ''
  url64          = 'https://github.com/FreeCAD/FreeCAD/releases/download/0.19_pre/FreeCAD_0.19.23040-Win-Conda_vc14.x-x86_64.7z'
  softwareName   = 'FreeCAD'
  checksum       = ''
  checksumType   = ''
  checksum64     = 'EEF5C1BB682295CD920E9AB2C3D554069079977BAF3D201A5CBD4BFA13849B6B'
