...
$version = '139.0.7212.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1467793/mini_installer.exe'
  checksum      = '3015618EC05DA8920C4868A52D970BE98B5C092F503F8226A0DA7B18F2CC219A'
  checksumType  = 'sha256'
