...
$version = '138.0.7175.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1458603/mini_installer.exe'
  checksum      = 'B47A460E6D7AA1D9DDF627D0DB33EF504CFDE3B6BD59BFD91C6A57D23A219C4F'
  checksumType  = 'sha256'
