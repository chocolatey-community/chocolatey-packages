...
$version = '141.0.7344.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1498446/mini_installer.exe'
  checksum      = 'FFA9A49634437586A7B065EC800603E4FE78F2A761BF2A57B45BBB19664B93F4'
  checksumType  = 'sha256'
