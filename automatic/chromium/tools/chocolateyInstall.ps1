...
$version = '134.0.6986.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1412513/mini_installer.exe'
  checksum      = 'FFEDD6C44EE8150B7F0FD9AE1310D54D421B943B3168400AE622BDB4CF494B8B'
  checksumType  = 'sha256'
