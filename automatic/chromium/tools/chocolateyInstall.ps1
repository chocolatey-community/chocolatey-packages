...
$version = '147.0.7684.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1583676/mini_installer.exe'
  checksum      = 'C76CBC48258770B4C29050CF9DF8CC495667087FB24F368003C91A725C397706'
  checksumType  = 'sha256'
