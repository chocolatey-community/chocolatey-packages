...
$version = '142.0.7411.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1514876/mini_installer.exe'
  checksum      = 'DD92926EE8C21D84C4C75ACACEDB57432AE422D14E70372BE8EFC2A0EAFDF369'
  checksumType  = 'sha256'
