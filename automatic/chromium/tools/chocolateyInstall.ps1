...
$version = '151.0.7880.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1642883/mini_installer.exe'
  checksum      = '839D20D0C821CBA9E648D0E287AA89FAD675B001D396E7C4C791BC95F0AEF47E'
  checksumType  = 'sha256'
