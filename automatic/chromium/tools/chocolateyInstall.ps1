...
$version = '151.0.7872.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1640040/mini_installer.exe'
  checksum      = '11DAE4BF18F0F663D0B4F7DC8FDFA4B1B3241315BFBE36E1F14F63ECCE18E6C6'
  checksumType  = 'sha256'
