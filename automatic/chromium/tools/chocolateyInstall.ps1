...
$version = '146.0.7660.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1577129/mini_installer.exe'
  checksum      = 'EE7A1B9E67B06CED0243BCA5E6D28DFBCBF98FB79F6E02FD1E372C9564C581AD'
  checksumType  = 'sha256'
