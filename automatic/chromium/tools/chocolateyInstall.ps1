...
$version = '146.0.7650.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1572736/mini_installer.exe'
  checksum      = '18ABBDC3AA9C0CFB59944D64C89E9C3F7B43E8432513E8C3FE1E915BF42F15B4'
  checksumType  = 'sha256'
