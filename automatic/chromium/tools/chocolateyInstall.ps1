...
$version = '145.0.7603.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1562834/mini_installer.exe'
  checksum      = 'D497F81FCFF8B541031EDB380CDAF8554A1B8556B7FC237139A58BDD602BD0E0'
  checksumType  = 'sha256'
