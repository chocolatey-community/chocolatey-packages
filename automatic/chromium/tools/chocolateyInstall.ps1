...
$version = '133.0.6873.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1390166/mini_installer.exe'
  checksum      = '337160271199C75567412D3FE12B5A1C45B38E86072BF36B3C583997AC0B6B65'
  checksumType  = 'sha256'
