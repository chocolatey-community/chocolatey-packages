...
$version = '151.0.7905.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1649998/mini_installer.exe'
  checksum      = 'B06BDBB694E6282A4FD59E377BB80E763532F3D20283CE4823DECC0D0DC8AC7D'
  checksumType  = 'sha256'
