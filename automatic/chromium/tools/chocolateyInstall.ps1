...
$version = '140.0.7278.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1482762/mini_installer.exe'
  checksum      = 'ADDCD7B7931991FC91669038E1A87EEAF5B2DB28585A4ED236B17FC96098C9DA'
  checksumType  = 'sha256'
