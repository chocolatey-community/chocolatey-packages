...
$version = '137.0.7144.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1450969/mini_installer.exe'
  checksum      = '2B59045DEC8A3A880CA724CD4080154A12CBA606E16F1CB552FEFA37767498A3'
  checksumType  = 'sha256'
