...
$version = '134.0.6983.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1411473/mini_installer.exe'
  checksum      = '2738AA72610BBE2096507292EE35C9F81D43DDDA0885B4823920B23B33DB553A'
  checksumType  = 'sha256'
