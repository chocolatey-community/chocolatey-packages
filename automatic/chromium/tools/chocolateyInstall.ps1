...
$version = '136.0.7073.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1433263/mini_installer.exe'
  checksum      = '450D760A7929BDC45C1FCEF24D723217DEE6DDBFC96F06E0E68DB37AECCD1547'
  checksumType  = 'sha256'
