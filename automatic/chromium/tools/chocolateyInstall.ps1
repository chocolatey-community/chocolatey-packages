...
$version = '154.0.8023.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1684770/mini_installer.exe'
  checksum      = 'EF6968205F43A3381B7672705B20BEA88BC077E77AD04448DB9BB0C6F2D689B7'
  checksumType  = 'sha256'
