...
$version = '140.0.7262.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1478905/mini_installer.exe'
  checksum      = '5DA07DA0ED8014830D0C8D23E7FFAD31FDCD7FB3C2929BABBEA179B1DC524C8A'
  checksumType  = 'sha256'
