...
$version = '142.0.7393.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1510314/mini_installer.exe'
  checksum      = '33EFDF9E9D6012633F00260491A683C33BB07AB4F0A4CA2B660C39F20BC08FAB'
  checksumType  = 'sha256'
