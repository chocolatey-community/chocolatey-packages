...
$version = '144.0.7501.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1537184/mini_installer.exe'
  checksum      = '63CF43B171B7F84C0000366ED79CF2BDDFB4512C870F5A595926D2684E9C4C9F'
  checksumType  = 'sha256'
