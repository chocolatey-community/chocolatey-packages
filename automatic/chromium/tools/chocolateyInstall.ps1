...
$version = '147.0.7725.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1595951/mini_installer.exe'
  checksum      = '6A316E0E8BCD1DFE28DF1DE4C06C66ED8AE64F716969876C04389C3C4F9E2B33'
  checksumType  = 'sha256'
