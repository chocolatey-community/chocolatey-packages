...
$version = '135.0.7032.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1423647/mini_installer.exe'
  checksum      = '1EEBD76AAD7ACCBF42A9BCE15E3BAB40FCE1517A376C757E5B1EB1513FCB5ACD'
  checksumType  = 'sha256'
