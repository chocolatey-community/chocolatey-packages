...
$version = '141.0.7348.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1499218/mini_installer.exe'
  checksum      = '6237DDA6EB0135226534EFD78828E3C8EA9195F333B919A3F63FC13FAF17F2B8'
  checksumType  = 'sha256'
