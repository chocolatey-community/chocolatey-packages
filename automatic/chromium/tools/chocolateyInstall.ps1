...
$version = '131.0.6769.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1366708/mini_installer.exe'
  checksum      = '2CF45644FFF79A3D97DD54E0502807F36444F63279864109B23FA1EA645B23C8'
  checksumType  = 'sha256'
