...
$version = '145.0.7618.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1564619/mini_installer.exe'
  checksum      = 'C1D0C141921D82288EE6AFC8E4C2D5303F1166B7C1E67EE4E3653390BDAFC266'
  checksumType  = 'sha256'
