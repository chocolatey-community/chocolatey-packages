...
$version = '138.0.7153.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1453685/mini_installer.exe'
  checksum      = '58D3DA9CBD71FCD4C16245BA8BB48959E00ABF9F4E07DA0AD3E14104765915B8'
  checksumType  = 'sha256'
