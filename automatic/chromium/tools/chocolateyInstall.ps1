...
$version = '135.0.7006.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1417742/mini_installer.exe'
  checksum      = 'C23A71CF639C564B43E032962651759D8CB399776ABD7397D71E89B195B956BC'
  checksumType  = 'sha256'
