...
$version = '128.0.6586.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1324722/mini_installer.exe'
  checksum      = '69FF5BB76EDB63451BA33096352665D0F20568370ABB22AAE3732F9C95C21E65'
  checksumType  = 'sha256'
