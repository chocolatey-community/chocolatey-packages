...
$version = '140.0.7310.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1489441/mini_installer.exe'
  checksum      = '1DA499D43C7EC0843CB4C2D0B8AA70EEC3A867DAA7CBC4936EB0A86A06131065'
  checksumType  = 'sha256'
