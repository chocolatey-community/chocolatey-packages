...
$version = '128.0.6552.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1318278/mini_installer.exe'
  checksum      = '9DD146DC2D5405F8C93A80903570D9F9D3784745700AE3FC8EB702FE0849EDE8'
  checksumType  = 'sha256'
