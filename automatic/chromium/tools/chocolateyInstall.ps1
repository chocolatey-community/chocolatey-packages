...
$version = '130.0.6705.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1352467/mini_installer.exe'
  checksum      = 'DDAE77E1EFD23FF9014FE17AC6A2DCDCEA1AA33385A6CACAB9BD2791AC6C8C69'
  checksumType  = 'sha256'
