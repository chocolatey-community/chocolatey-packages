...
$version = '145.0.7574.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1556758/mini_installer.exe'
  checksum      = 'BDCA611DBA63326CEDD5C65F67D8F8C277641663F3987CDDC59F0220C8893073'
  checksumType  = 'sha256'
