...
$version = '136.0.7061.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1430146/mini_installer.exe'
  checksum      = '3E0A96F56C793A0B46E62A6448F5C5A435ACCF40E1C7002CF17B43B8F375E615'
  checksumType  = 'sha256'
