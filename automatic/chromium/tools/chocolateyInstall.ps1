...
$version = '131.0.6737.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1359210/mini_installer.exe'
  checksum      = 'A610B6AA0C77EC1E880857D43E231AAC2524659F2286BC2B5F3BC323651AB9E3'
  checksumType  = 'sha256'
