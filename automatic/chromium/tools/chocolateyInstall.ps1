...
$version = '135.0.7046.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1426814/mini_installer.exe'
  checksum      = 'ED7EE77CC5865E2BC48D97CDDCE6847160EA97B5C96C8CBA002619F86DE30BD5'
  checksumType  = 'sha256'
