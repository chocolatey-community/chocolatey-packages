...
$version = '145.0.7601.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1562695/mini_installer.exe'
  checksum      = '59EA9D4252B458C79EDB27D3FAAB1A5FE600DBD414938D1433BB306BCA190770'
  checksumType  = 'sha256'
