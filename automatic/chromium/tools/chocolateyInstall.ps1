...
$version = '148.0.7730.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1597794/mini_installer.exe'
  checksum      = 'E0CF384A628C2E7A13D54FA4587A8ED55797215F0951936AD32169131E8B43DD'
  checksumType  = 'sha256'
