...
$version = '128.0.6601.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1328416/mini_installer.exe'
  checksum      = '1160050D9526B9FDC40D615BB84862C323FEC75CE2ECE3E9399790F36D17B8F5'
  checksumType  = 'sha256'
