...
$version = '143.0.7483.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1531970/mini_installer.exe'
  checksum      = '30F68007A064881D1CC72A7766BD372624F42AAC3FD5C66D86C38B9DA6AFF1E1'
  checksumType  = 'sha256'
