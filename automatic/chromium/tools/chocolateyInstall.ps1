...
$version = '138.0.7174.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1458585/mini_installer.exe'
  checksum      = '324891F8C7DCBC13547C39C8F1B03ADEF0BD76515A0EC927A77AEDFECB4BDD48'
  checksumType  = 'sha256'
