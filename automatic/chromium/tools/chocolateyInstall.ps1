...
$version = '136.0.7099.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1439895/mini_installer.exe'
  checksum      = 'E25BE49B44A98E49FA47EEB5C00B1A5D33C4B93CB90A4D387ECBD29940E72B48'
  checksumType  = 'sha256'
