...
$version = '130.0.6708.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1352643/mini_installer.exe'
  checksum      = '6EDA01B391C350FB44765D2A01030C9FDCA58F03C9E905FEBB2972793E63D9A5'
  checksumType  = 'sha256'
