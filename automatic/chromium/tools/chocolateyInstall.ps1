...
$version = '140.0.7288.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1484751/mini_installer.exe'
  checksum      = '1BDC5296C6C09A4B2CAF1CF85BBB1FA11A3CFCF4B6AB325A420F8C4D35E404D2'
  checksumType  = 'sha256'
