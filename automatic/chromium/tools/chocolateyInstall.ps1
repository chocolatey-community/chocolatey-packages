...
$version = '144.0.7503.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1537717/mini_installer.exe'
  checksum      = 'BF8F0A1019505579574E3233DDB0C61FDE15B882013DCFDCB515FD6A73A0798B'
  checksumType  = 'sha256'
