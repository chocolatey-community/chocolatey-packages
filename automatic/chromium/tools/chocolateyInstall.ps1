...
$version = '134.0.6951.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1405195/mini_installer.exe'
  checksum      = 'D83A2811ACD06412E161F81E12D845CF7EBAD71C3740899CAE742613FE8CC008'
  checksumType  = 'sha256'
