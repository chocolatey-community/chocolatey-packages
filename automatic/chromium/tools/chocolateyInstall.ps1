...
$version = '144.0.7527.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1544237/mini_installer.exe'
  checksum      = '34308CC86A4F61951D7B8DB0453CA58332B493E1237A9C79569A6C82B814CA61'
  checksumType  = 'sha256'
