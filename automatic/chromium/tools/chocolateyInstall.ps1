...
$version = '129.0.6639.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1337117/mini_installer.exe'
  checksum      = '096DB318C9402BDB8C4F66A5019D8631AC2564603D2F37C69BA433ECBE2DE683'
  checksumType  = 'sha256'
