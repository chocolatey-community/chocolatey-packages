...
$version = '150.0.7860.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1636010/mini_installer.exe'
  checksum      = '6FC1197BF8992FF4A7A389B3E53B05119DCA9B7C629BA9608290E617FA1C6429'
  checksumType  = 'sha256'
