...
$version = '153.0.8000.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1676322/mini_installer.exe'
  checksum      = '8B3FC16408339A6622DB474369B125293B74C89B02C1BA306EE8D9195DD5973A'
  checksumType  = 'sha256'
