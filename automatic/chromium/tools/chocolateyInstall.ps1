...
$version = '142.0.7408.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1514087/mini_installer.exe'
  checksum      = '035642CAAA269D269FE6C41D2CD019612CE0DCF300757468981A47DF4D85F21F'
  checksumType  = 'sha256'
