...
$version = '133.0.6885.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1393414/mini_installer.exe'
  checksum      = '1E4B1AFDB72E6CE4C60C14A34B3172A7A50C000CAE045B5378EDDAB3B779CE4A'
  checksumType  = 'sha256'
