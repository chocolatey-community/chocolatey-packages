...
$version = '150.0.7864.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1637461/mini_installer.exe'
  checksum      = 'CBC383AC767D4CEC36254837B2CF8855D8E8BCE20364B7060E73779C7B5F5F89'
  checksumType  = 'sha256'
