...
$version = '127.0.6527.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1312132/mini_installer.exe'
  checksum      = 'C62B41199D81A163BFBDE6309C1F734349A030403AAE64F52A7E9C1F9325090E'
  checksumType  = 'sha256'
