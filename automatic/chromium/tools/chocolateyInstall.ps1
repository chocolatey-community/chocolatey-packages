...
$version = '151.0.7894.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1646963/mini_installer.exe'
  checksum      = '8627A7D2F963618C72FDB721F4F783CD7BB92E027522AE15733EFCFC4A13A7B1'
  checksumType  = 'sha256'
