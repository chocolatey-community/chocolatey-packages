...
$version = '127.0.6503.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1306161/mini_installer.exe'
  checksum      = '830227228A0031BBD99FE1D477C345E562539E5026F4FE911A3482C052BA1395'
  checksumType  = 'sha256'
