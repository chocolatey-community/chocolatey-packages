...
$version = '130.0.6706.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1352487/mini_installer.exe'
  checksum      = '13D994004FF77FF85AC3400060F7A1A1C90E87F411DD0C389C9426CE40E8B26B'
  checksumType  = 'sha256'
