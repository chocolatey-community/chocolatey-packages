...
$version = '142.0.7436.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1520688/mini_installer.exe'
  checksum      = '9A3AA67A26321EDD895E4C0555D3E9E2AFCDF8D38D039572075378A6F77DD8D4'
  checksumType  = 'sha256'
