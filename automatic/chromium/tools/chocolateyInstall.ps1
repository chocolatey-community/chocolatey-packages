...
$version = '128.0.6550.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1317828/mini_installer.exe'
  checksum      = '831329B5641709639FCB2EB5D1DE60CAD1A4B55C5EFD117921EFB5980542F8A2'
  checksumType  = 'sha256'
