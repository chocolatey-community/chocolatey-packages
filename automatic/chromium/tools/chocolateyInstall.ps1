...
$version = '144.0.7528.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1544817/mini_installer.exe'
  checksum      = 'F17B47DC6955C3F411C62A89DEC217D96A3A5872957D9EBA29BE5560632B0A7E'
  checksumType  = 'sha256'
