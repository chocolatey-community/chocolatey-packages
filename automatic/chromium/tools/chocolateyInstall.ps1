...
$version = '130.0.6688.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1349058/mini_installer.exe'
  checksum      = '019FE2569675180ABC2970E812D736A83CC59737ED81920B7AF1399B64EB6B8C'
  checksumType  = 'sha256'
