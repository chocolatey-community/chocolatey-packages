...
$version = '145.0.7628.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1567395/mini_installer.exe'
  checksum      = '9B8A29F5B0C32633CAA314DA72FC9F88FEE75BDDDCAC4196F29AECD4C02A0DFC'
  checksumType  = 'sha256'
