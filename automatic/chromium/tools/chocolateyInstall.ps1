...
$version = '134.0.6971.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1408841/mini_installer.exe'
  checksum      = '639D25A94DEC3D55F8754475890A1465E4FCAFDC575FC018249B29206C81E868'
  checksumType  = 'sha256'
