...
$version = '131.0.6758.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1364213/mini_installer.exe'
  checksum      = 'CF06CBA5F869C7C9CC6EF93F1966A35508EAF7E51982EC1141B3415B99532588'
  checksumType  = 'sha256'
