...
$version = '143.0.7453.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1525229/mini_installer.exe'
  checksum      = 'DAAF04110D423A9AADB04DA9438486C9206F9B022F40AE5DA24D1C5CCACFC6AD'
  checksumType  = 'sha256'
