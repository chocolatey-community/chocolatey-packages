...
$version = '132.0.6793.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1372108/mini_installer.exe'
  checksum      = '5459A67200F617779897EB2C8A7C560AA439D49C11DEB926C19571AFC748BF95'
  checksumType  = 'sha256'
