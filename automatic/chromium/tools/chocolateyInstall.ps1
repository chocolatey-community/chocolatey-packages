...
$version = '139.0.7248.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1475815/mini_installer.exe'
  checksum      = 'E1EF1FFCD7E5DD123CDBA26D442C4F8149C97B1E4E8A936DD495DE0EFFD87931'
  checksumType  = 'sha256'
