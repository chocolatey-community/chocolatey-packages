...
$version = '131.0.6766.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1365844/mini_installer.exe'
  checksum      = 'B835189FB6AB4A86EC28A93680DED323B07B29178A6098973E62ACA887AAD88F'
  checksumType  = 'sha256'
