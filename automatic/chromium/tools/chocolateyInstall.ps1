...
$version = '133.0.6853.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1386616/mini_installer.exe'
  checksum      = '6BC2C70B0B5A7FBB20DF86912C9E8354339D820DA28CA170A597A4D592D8D11E'
  checksumType  = 'sha256'
