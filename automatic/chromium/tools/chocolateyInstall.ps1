...
$version = '140.0.7312.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1489934/mini_installer.exe'
  checksum      = '3FFC1FA4C1D9FBF2FD2D2CF9A52250196B653CEC62EA3018047EE3786B2C2CDC'
  checksumType  = 'sha256'
