...
$version = '130.0.6714.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1354388/mini_installer.exe'
  checksum      = 'B97FE261E1ECE0711AF6FC1E78B6785C63811140A547C37068B64C717AACBBCF'
  checksumType  = 'sha256'
