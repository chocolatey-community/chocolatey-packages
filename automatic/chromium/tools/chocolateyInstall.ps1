...
$version = '141.0.7377.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1506405/mini_installer.exe'
  checksum      = '692DE942D346C65DAE1AF07D5E4A982B508BD6266A85848960745CFC3C6D5A19'
  checksumType  = 'sha256'
