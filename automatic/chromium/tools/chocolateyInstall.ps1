...
$version = '151.0.7913.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1652215/mini_installer.exe'
  checksum      = '06D832311E03ADF2FEE6DF0DC95E8179212F5824F572038F16582F0EFDECCFA3'
  checksumType  = 'sha256'
