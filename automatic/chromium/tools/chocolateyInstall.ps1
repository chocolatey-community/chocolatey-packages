...
$version = '139.0.7220.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1469123/mini_installer.exe'
  checksum      = 'D7016435ECC1E6AE2F2A3EB0C984D2C8BBF10CC14FD922E368D83FAF53B9C706'
  checksumType  = 'sha256'
