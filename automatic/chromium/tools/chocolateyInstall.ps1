...
$version = '138.0.7170.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1457810/mini_installer.exe'
  checksum      = 'BF10B6AD526A201A01346AC4F7241139C5909241DC23ABEE746233129578ED49'
  checksumType  = 'sha256'
