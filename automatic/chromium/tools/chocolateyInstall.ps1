...
$version = '130.0.6671.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1345022/mini_installer.exe'
  checksum      = 'E329735A92F6C34E3BF6738C887F0D82566B44239BCFA3CE1D8BCB5D48DFE5D7'
  checksumType  = 'sha256'
