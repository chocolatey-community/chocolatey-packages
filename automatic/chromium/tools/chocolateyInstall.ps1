...
$version = '152.0.7971.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1668107/mini_installer.exe'
  checksum      = '33AECE3BF99B30F9F92F712B360DEA32836C00C408902B88AE09C6AA42EC10B5'
  checksumType  = 'sha256'
