...
$version = '152.0.7955.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1663165/mini_installer.exe'
  checksum      = '16AB6FD2B6F52024808F9A152EADDD70449A20C12A725717FBFD18BF2EF9A39F'
  checksumType  = 'sha256'
