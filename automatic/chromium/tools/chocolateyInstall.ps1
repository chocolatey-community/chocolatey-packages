...
$version = '137.0.7109.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1442707/mini_installer.exe'
  checksum      = 'C8B286F04B047644732A0BDB1E2B5ED55AE248710F849D4B9F95B3C030A4A0E6'
  checksumType  = 'sha256'
