...
$version = '151.0.7920.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1653803/mini_installer.exe'
  checksum      = 'CB96483F3F4DFF2F46DEDF340CAD3775C6BD67C9A53D5650EB8547D6367AE951'
  checksumType  = 'sha256'
