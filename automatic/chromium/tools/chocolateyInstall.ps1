...
$version = '127.0.6483.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1301884/mini_installer.exe'
  checksum      = '5AD1EBA37B40C3B6E369EA3C02F38A684C2935D4046CE6E1343158F667835B15'
  checksumType  = 'sha256'
