...
$version = '146.0.7670.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1579610/mini_installer.exe'
  checksum      = '2E489E28E25971EFCA1A455796442932894766F8A6F2DBD2F9879A14B2516EFD'
  checksumType  = 'sha256'
