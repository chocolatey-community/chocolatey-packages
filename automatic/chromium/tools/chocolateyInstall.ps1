...
$version = '136.0.7069.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1432739/mini_installer.exe'
  checksum      = 'A213398D00CE2368B8F37AC6B7558D20FCF904709B84185449D8CDD7BACF9888'
  checksumType  = 'sha256'
