...
$version = '134.0.6985.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1412179/mini_installer.exe'
  checksum      = '774F08F66C0A5DAFB16C3690696C491AD6CADA4C166AB9BA1F761E3F473050FF'
  checksumType  = 'sha256'
