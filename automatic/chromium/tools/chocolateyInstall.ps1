...
$version = '138.0.7199.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1465131/mini_installer.exe'
  checksum      = '4A168607D7CD61FED35CAD5D232EDBA1BEAF93E03221AB19F178755FDD413637'
  checksumType  = 'sha256'
