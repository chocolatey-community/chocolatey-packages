...
$version = '131.0.6735.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1358697/mini_installer.exe'
  checksum      = '1ECBCC07DF9E4B9391F3BF514F28E234EA5BF55837076985E86E198E5F33F696'
  checksumType  = 'sha256'
