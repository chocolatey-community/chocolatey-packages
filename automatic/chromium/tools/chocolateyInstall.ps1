...
$version = '137.0.7134.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1449137/mini_installer.exe'
  checksum      = '2273AB54F3B597433378574278EAA36A0CC30E2420E2182ED26252830A13C8DB'
  checksumType  = 'sha256'
