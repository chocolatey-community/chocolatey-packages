...
$version = '141.0.7370.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1504478/mini_installer.exe'
  checksum      = '77CA4D378F6906E2EAE032B0E2715D0FFC65B3D972AE966BB8956D4DB7C2CDE2'
  checksumType  = 'sha256'
