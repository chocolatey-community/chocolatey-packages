...
$version = '144.0.7530.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1545433/mini_installer.exe'
  checksum      = '7A7B12A9F19DD02E0AB37F6589C23D64D79788DC5D009D02548C6EE992496245'
  checksumType  = 'sha256'
