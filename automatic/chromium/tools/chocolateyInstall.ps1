...
$version = '143.0.7474.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1529945/mini_installer.exe'
  checksum      = '3A99833CF11A0173407510FE13B57BF82972D27A7ED9984E1D83C4202C87C3E7'
  checksumType  = 'sha256'
