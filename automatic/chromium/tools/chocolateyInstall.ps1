...
$version = '153.0.8010.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1680144/mini_installer.exe'
  checksum      = '805FDE85F42AD930E0715BD33B940CAB0D4AAF0AAE8A0C4D5F2D9FD258AFC8C7'
  checksumType  = 'sha256'
