...
$version = '128.0.6603.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1328907/mini_installer.exe'
  checksum      = '70994C9AB0E024603B08D18CA0B7E6627012B44C268D56013236512DE9746B80'
  checksumType  = 'sha256'
