...
$version = '137.0.7146.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1451820/mini_installer.exe'
  checksum      = '559B47A532915D4D5978EE8C059D26A53664741A8A3D92979552EBE48E218733'
  checksumType  = 'sha256'
