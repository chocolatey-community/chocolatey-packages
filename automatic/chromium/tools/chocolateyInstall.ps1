...
$version = '131.0.6745.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1361483/mini_installer.exe'
  checksum      = '060844F6022C74F75D57ADB88250EDAB64823568E15D0B1D7175ECCC7B29F5BC'
  checksumType  = 'sha256'
