...
$version = '140.0.7339.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1496342/mini_installer.exe'
  checksum      = 'A8FFC8A440310CE774EFC7100E159494504C4F78653053F7FDDF4C994F29A3CB'
  checksumType  = 'sha256'
