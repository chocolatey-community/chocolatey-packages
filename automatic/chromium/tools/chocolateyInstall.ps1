...
$version = '128.0.6610.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1330785/mini_installer.exe'
  checksum      = '8677E843838137377FE8708E3E98EDD38603B70C0F37DD3C83A7B548A6FDCCE1'
  checksumType  = 'sha256'
