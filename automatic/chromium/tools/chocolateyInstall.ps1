...
$version = '126.0.6463.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1296754/mini_installer.exe'
  checksum      = 'B82C00F403AB08990D20BDDA8A4F3DB2619B4BF3882FA99AE61BDEEA2F37358F'
  checksumType  = 'sha256'
