...
$version = '134.0.6970.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1408786/mini_installer.exe'
  checksum      = '54A10254D51A1EA5FB557C9C68A0E5C2298DBB91E380FED090C015E0BA9201E5'
  checksumType  = 'sha256'
