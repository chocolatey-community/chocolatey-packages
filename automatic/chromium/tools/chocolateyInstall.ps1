...
$version = '126.0.6473.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1299662/mini_installer.exe'
  checksum      = 'BD7A4BA993E9EBF586D94A93ADBFE2B13125B7B8932F15C681C1458170CAF31E'
  checksumType  = 'sha256'
