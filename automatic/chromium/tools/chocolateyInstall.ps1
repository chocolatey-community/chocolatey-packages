...
$version = '145.0.7609.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1563338/mini_installer.exe'
  checksum      = '8365ACA0D9B82BE72DFD9DC46E70F39C6F921A5FFC24807A598ADB58482A78F4'
  checksumType  = 'sha256'
