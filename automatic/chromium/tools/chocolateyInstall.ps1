...
$version = '145.0.7591.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1561582/mini_installer.exe'
  checksum      = '257C81CD55548BBD84F67EEDE18B584AA94C46FDB5F0538BB14B3740D188D559'
  checksumType  = 'sha256'
