...
$version = '146.0.7669.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1578810/mini_installer.exe'
  checksum      = '02B9183A6566CE7B34321F15CE39EFE16A466DCE5A58E3B209B57F83D59312AC'
  checksumType  = 'sha256'
