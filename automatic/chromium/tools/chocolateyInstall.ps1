...
$version = '129.0.6647.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1339557/mini_installer.exe'
  checksum      = '9A7F0D68EE90F9F1FA064ADD5866B6279EE55359F5797EA07A1989A4F4E5662C'
  checksumType  = 'sha256'
