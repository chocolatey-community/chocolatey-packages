...
$version = '136.0.7078.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1434611/mini_installer.exe'
  checksum      = '510A1404E228E4438B63683D4A521895DBD1E0C2E898C2C14FD7AFE5AA80F8B9'
  checksumType  = 'sha256'
