...
$version = '127.0.6504.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1306210/mini_installer.exe'
  checksum      = '2080526EE2C5323D0FAAEDFA5064AF58931D75C2EF29F8F9D5D6DBFD78DD5D73'
  checksumType  = 'sha256'
