...
$version = '152.0.7968.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1666887/mini_installer.exe'
  checksum      = '59A5EFC99EA85CAD705EBFF1865D084A3A1C4C4A25EBDBF921B859C2ABA0D504'
  checksumType  = 'sha256'
