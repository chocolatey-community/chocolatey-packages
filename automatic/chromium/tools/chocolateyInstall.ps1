...
$version = '141.0.7346.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1498856/mini_installer.exe'
  checksum      = 'CD0CE6922CDF262C03BC0D518CD2273F6E7921CB791BE0CD0127C38D895310B4'
  checksumType  = 'sha256'
