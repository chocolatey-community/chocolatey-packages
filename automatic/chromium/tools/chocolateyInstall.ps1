...
$version = '131.0.6751.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1362283/mini_installer.exe'
  checksum      = '5B00C360623A9ACC0C2A74FF08121D90870B6709A9881C2EEBB8D41A87BE86E0'
  checksumType  = 'sha256'
