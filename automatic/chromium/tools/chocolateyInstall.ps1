...
$version = '144.0.7554.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1551718/mini_installer.exe'
  checksum      = '0FC2B3020DBFCC52EB051219C99717049C526252A88BC4B5039703F92052E318'
  checksumType  = 'sha256'
