...
$version = '151.0.7915.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1652950/mini_installer.exe'
  checksum      = 'EC29B82FE8AD22AF120B9E6628DAB382CCC06CF5679F9C106152979DB10169C3'
  checksumType  = 'sha256'
