...
$version = '134.0.6952.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1405221/mini_installer.exe'
  checksum      = 'B07826E8C33CF16343BF7C807BD82D2B19D3DC62D139F408C5DAF244650699C0'
  checksumType  = 'sha256'
