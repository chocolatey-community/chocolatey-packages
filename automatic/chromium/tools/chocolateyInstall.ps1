...
$version = '127.0.6532.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1312636/mini_installer.exe'
  checksum      = '768B8A9D9A92C68AAFC95A5E13E39A3B02BDF82A2DCDC63EB724729794A42AA1'
  checksumType  = 'sha256'
