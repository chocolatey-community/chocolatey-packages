...
$version = '130.0.6702.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1351950/mini_installer.exe'
  checksum      = '378407FEC2578E34103CECB024E0455FB27333E5BFE481503FF99101CEC69C6B'
  checksumType  = 'sha256'
