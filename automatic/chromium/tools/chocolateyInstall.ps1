...
$version = '126.0.6471.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1299117/mini_installer.exe'
  checksum      = '3E6244EA2BCD741490D3960811B1FAB71711460A84950E6915C6E8849105B854'
  checksumType  = 'sha256'
