...
$version = '133.0.6902.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1397193/mini_installer.exe'
  checksum      = '9F0AAABD1B6E4382A4E8165CE35502A0508E48F0A6C356E8238C807C16083E0A'
  checksumType  = 'sha256'
