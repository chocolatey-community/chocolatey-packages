...
$version = '134.0.6967.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1408417/mini_installer.exe'
  checksum      = 'D8F0B1B71FA39068FF5F6E604D8A2DEDDC36E233630A3B2DB15DAEDC91550755'
  checksumType  = 'sha256'
