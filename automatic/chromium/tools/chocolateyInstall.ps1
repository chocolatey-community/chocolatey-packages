...
$version = '133.0.6923.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1400513/mini_installer.exe'
  checksum      = '356663E37749D82E48D5986C96899262E199A5EA640DED72F2D8E1A15DBB4CCB'
  checksumType  = 'sha256'
