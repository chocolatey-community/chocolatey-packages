...
$version = '136.0.7050.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1427581/mini_installer.exe'
  checksum      = 'C05DCDEBF3AE8CE39DF5FB95ADD72DEC1FFFED60BB8E28C9F37680CB6A9BFBA0'
  checksumType  = 'sha256'
