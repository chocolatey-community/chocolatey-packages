...
$version = '132.0.6831.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1380920/mini_installer.exe'
  checksum      = '7064D2D66FD4FF531C5CDC070FF30FDDECC7B3E8D3BF8D69F707AD3D2E380BA1'
  checksumType  = 'sha256'
