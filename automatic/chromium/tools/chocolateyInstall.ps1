...
$version = '133.0.6872.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1390122/mini_installer.exe'
  checksum      = '8F5C40C2E982CF3155573769CEABBB619D5765819A30F257E39B195E5FF780E3'
  checksumType  = 'sha256'
