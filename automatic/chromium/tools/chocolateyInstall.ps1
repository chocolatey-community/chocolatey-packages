...
$version = '133.0.6934.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1401327/mini_installer.exe'
  checksum      = 'BCF7C1A8DADE612D854414FFF4B0F99C7A2C69EB72D0C6BB78BEA652C8BEE0BC'
  checksumType  = 'sha256'
