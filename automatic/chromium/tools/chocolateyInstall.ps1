...
$version = '139.0.7216.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1467941/mini_installer.exe'
  checksum      = 'E37DD2938B250B64B0E4131551B2570175A4CE0B2C243475666F2E2666A9F703'
  checksumType  = 'sha256'
