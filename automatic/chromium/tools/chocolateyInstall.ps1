...
$version = '143.0.7457.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1525916/mini_installer.exe'
  checksum      = 'F4AE3305894AA689DCA58C8DFE2EDB979544CFD0D49C2907FE0D5F032EBBEEED'
  checksumType  = 'sha256'
