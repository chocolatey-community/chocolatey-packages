...
$version = '128.0.6567.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1321383/mini_installer.exe'
  checksum      = 'C7EFB468C21920C25315238C8A299B5088386658A3E57FF8B0B715200AAD17C4'
  checksumType  = 'sha256'
