...
$version = '136.0.7103.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1440512/mini_installer.exe'
  checksum      = 'B9B2899333EA7FCA6994EBADA13ED42A5F41A94E96DA8BC92FEB982FEC59FFA7'
  checksumType  = 'sha256'
