...
$version = '140.0.7334.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1495856/mini_installer.exe'
  checksum      = '3161C3067CFB85E583EC941D4BA311776F20BF8247F0966CEC7B0C2400D2BC4E'
  checksumType  = 'sha256'
