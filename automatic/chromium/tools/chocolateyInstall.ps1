...
$version = '132.0.6830.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1380874/mini_installer.exe'
  checksum      = '0C0C9667E3B62F6EDB482F61218138D6C782EC02DC1B880EB9E8B746343D7C61'
  checksumType  = 'sha256'
