...
$version = '146.0.7663.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1577759/mini_installer.exe'
  checksum      = '76DA0F1F3A4476D07CAC71A2F2A4F35E2D60AF88E48929F53DEEACBB8DBB2D8D'
  checksumType  = 'sha256'
