...
$version = '141.0.7375.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1505789/mini_installer.exe'
  checksum      = '2A3CC7CC26F8EDC3B230A38CDF8A0F34D14868E848C609B69A61D3D9078885D7'
  checksumType  = 'sha256'
