...
$version = '154.0.8015.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1683334/mini_installer.exe'
  checksum      = '9B53ADAF34B3637F50DD8398C61B1253F3290BC2E9B7E693908F64F91A5BAACE'
  checksumType  = 'sha256'
