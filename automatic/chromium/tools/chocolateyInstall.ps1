...
$version = '144.0.7514.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1541325/mini_installer.exe'
  checksum      = 'D0EC25B4F81B037BF4037DBADD496F170E4535B8BB2EC0AA72A98A736451CF63'
  checksumType  = 'sha256'
