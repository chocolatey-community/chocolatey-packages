...
$version = '135.0.7045.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1426749/mini_installer.exe'
  checksum      = '02787B6D6734F850298291622D98BAF83D7A56109C79C06CBCF5B80849286B42'
  checksumType  = 'sha256'
