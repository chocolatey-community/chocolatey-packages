...
$version = '130.0.6684.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1347893/mini_installer.exe'
  checksum      = '5D7EC10205F75E7D811B1AA5C07D483C6F3B0737E299D40C8776ADEC2A779C24'
  checksumType  = 'sha256'
