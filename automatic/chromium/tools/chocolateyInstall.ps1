...
$version = '131.0.6759.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1364586/mini_installer.exe'
  checksum      = '5BB847EB37A57A4F776BA2BE28BA6B0B26C77E756C2EDCBE610A010D3EC535B8'
  checksumType  = 'sha256'
