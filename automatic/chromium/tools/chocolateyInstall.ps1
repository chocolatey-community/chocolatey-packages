...
$version = '131.0.6763.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1364852/mini_installer.exe'
  checksum      = 'B770764428897942367D6DB7C26968C38AFE5A0AFE50B280ADE772CCC40B9A54'
  checksumType  = 'sha256'
