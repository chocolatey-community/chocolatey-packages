...
$version = '151.0.7895.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1647312/mini_installer.exe'
  checksum      = 'C4ED0C41CEE088DDD00EC3AE902960DECA98CA8F6051625F9A38EEC6748933B8'
  checksumType  = 'sha256'
