...
$version = '140.0.7298.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1486823/mini_installer.exe'
  checksum      = '4B8C51CA798D8ACD64BEE8B4D486E24C3CF45735CBD8561375A5E5F50D2D5820'
  checksumType  = 'sha256'
