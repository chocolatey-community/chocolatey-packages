...
$version = '134.0.6950.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1405129/mini_installer.exe'
  checksum      = '114196185B37EE1630430B6BF10309E1EF2BDB3FFBCD2DB339224B09BA1CBB37'
  checksumType  = 'sha256'
