...
$version = '134.0.6958.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1406357/mini_installer.exe'
  checksum      = '615C3162FBFC3581DEF7880BD18642424F8F77AA5010536D77FB1B750C1F7977'
  checksumType  = 'sha256'
