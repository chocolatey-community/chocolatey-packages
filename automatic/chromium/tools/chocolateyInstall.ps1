...
$version = '139.0.7205.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1465726/mini_installer.exe'
  checksum      = 'C521BE766AAD6E8E3ECE1ED4408B6D950D26826A58AFAA5EB8BF4A6C515AFFA1'
  checksumType  = 'sha256'
