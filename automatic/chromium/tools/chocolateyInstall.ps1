...
$version = '143.0.7498.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1535736/mini_installer.exe'
  checksum      = 'FB8695ACE42EB8334FF587ECB6C75E41B841456DE2B27C4FF1199765248B42D8'
  checksumType  = 'sha256'
