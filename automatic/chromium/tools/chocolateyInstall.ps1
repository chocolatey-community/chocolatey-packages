...
$version = '129.0.6616.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1332590/mini_installer.exe'
  checksum      = '05256BC04F87A4B0FCAF6A784E6818CC317CF55690D483215DA97BE368B4DF77'
  checksumType  = 'sha256'
