...
$version = '142.0.7419.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1516090/mini_installer.exe'
  checksum      = '14DDCCCFE9F7C16552186DFDF4E51416DEE0E3C16A9AF33A60E429F24BEC4F49'
  checksumType  = 'sha256'
