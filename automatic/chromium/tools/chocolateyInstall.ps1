...
$version = '146.0.7648.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1572137/mini_installer.exe'
  checksum      = '5FFED5D47F1266D42FDD496E982793A4326E443D87EB2B6C554C0CA59A82D33A'
  checksumType  = 'sha256'
