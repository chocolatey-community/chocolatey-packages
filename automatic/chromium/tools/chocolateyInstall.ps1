...
$version = '137.0.7105.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1441405/mini_installer.exe'
  checksum      = 'DC37CBEE996E3EFD3150071A7C4EB93ACDA3B887D8B6BAA165A959BB4EA5BFD7'
  checksumType  = 'sha256'
