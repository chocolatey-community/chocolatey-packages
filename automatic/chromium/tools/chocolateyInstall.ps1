...
$version = '133.0.6883.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1393312/mini_installer.exe'
  checksum      = 'EEEFE6BFA323CA8306D7ED348694650E54ADCEA4B1A14BF3076D4E2FCCC96E8E'
  checksumType  = 'sha256'
