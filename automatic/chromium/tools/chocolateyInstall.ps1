...
$version = '142.0.7425.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1518331/mini_installer.exe'
  checksum      = 'DE5F3A1F90241AB62D299FD8679A3A784E2DB5670D38A4EB306C335422D332A3'
  checksumType  = 'sha256'
