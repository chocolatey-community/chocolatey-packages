...
$version = '132.0.6827.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1380238/mini_installer.exe'
  checksum      = 'A826A6EDDC8EFA7AA1AF0F18F00082FDACA6E5863F3CB901B2AED4F14475FAAB'
  checksumType  = 'sha256'
