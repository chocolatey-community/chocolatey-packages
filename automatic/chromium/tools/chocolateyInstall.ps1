...
$version = '130.0.6717.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1355530/mini_installer.exe'
  checksum      = '7ACF889C93DE81D35FAB5C9E04659F96ED93EE4E17CDEA61464595ECAA8A435F'
  checksumType  = 'sha256'
