...
$version = '145.0.7627.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1567346/mini_installer.exe'
  checksum      = '82DD8F939E1EE670974D4448D5B8B8867EDB1C7F32BA2D65FCEFFE165C029F7C'
  checksumType  = 'sha256'
