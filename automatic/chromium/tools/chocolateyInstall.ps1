...
$version = '130.0.6698.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1350595/mini_installer.exe'
  checksum      = 'D9440E8E060F8384CC4A03CBB14B345A2D44A124C7C75C7A31BE415A406B6CC7'
  checksumType  = 'sha256'
