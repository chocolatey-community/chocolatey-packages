...
$version = '136.0.7088.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1436676/mini_installer.exe'
  checksum      = 'BB9F8FE2B32F034921F6B36A7BDACE345C752D8CE7C27EBD2B26EBAA66C1961E'
  checksumType  = 'sha256'
