...
$version = '143.0.7496.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1535601/mini_installer.exe'
  checksum      = 'B017086554C0B62B474A69EFE7E9F18B9AB86295624C47F1999D1F0C5A3FF68A'
  checksumType  = 'sha256'
