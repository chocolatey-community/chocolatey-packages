...
$version = '133.0.6847.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1384837/mini_installer.exe'
  checksum      = 'A70C046B11DAD3743967CE1CFC4FA8EB97B034B85BB95BE3AAA0716C593CF238'
  checksumType  = 'sha256'
