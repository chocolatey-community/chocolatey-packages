...
$version = '137.0.7149.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1452332/mini_installer.exe'
  checksum      = '5BE95CC367B25486950C034E607F312020D2296E65EBFAF2E3B83263AB399B1F'
  checksumType  = 'sha256'
