...
$version = '142.0.7421.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1517056/mini_installer.exe'
  checksum      = 'E702AE6E031BFA8CCA5DACE15462A2D80D5BC2F317EC73798C9C21BE6CC47301'
  checksumType  = 'sha256'
