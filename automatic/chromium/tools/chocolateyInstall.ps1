...
$version = '141.0.7371.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1504611/mini_installer.exe'
  checksum      = 'D8DB89CA2817C0DD95E0CA002369697C9B240306E9ADDA1FC7D711D6707EA4B1'
  checksumType  = 'sha256'
