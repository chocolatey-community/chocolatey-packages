...
$version = '138.0.7187.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1461841/mini_installer.exe'
  checksum      = '416B23DA5B07248F8E821C0AFB35728FE3C917DF528333CE212C8EA8DD9730FC'
  checksumType  = 'sha256'
