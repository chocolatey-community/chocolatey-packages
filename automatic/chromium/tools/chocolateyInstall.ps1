...
$version = '152.0.7974.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1668344/mini_installer.exe'
  checksum      = 'F4286411645FDB25FA8A0DF55C6ACEE89783405545B7B1FABAED990372FA792B'
  checksumType  = 'sha256'
