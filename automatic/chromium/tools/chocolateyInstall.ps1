...
$version = '137.0.7128.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1447588/mini_installer.exe'
  checksum      = '8072092B3F91C07B93C8EDDF151B07899055369061AA6D483392639FB8264409'
  checksumType  = 'sha256'
