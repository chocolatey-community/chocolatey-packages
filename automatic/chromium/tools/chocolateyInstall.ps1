...
$version = '133.0.6919.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1400177/mini_installer.exe'
  checksum      = '172C4EB5EDF4CBB681DADDFD929B399B67E2A0C4AD91E5EE48C333728A5AA4E5'
  checksumType  = 'sha256'
