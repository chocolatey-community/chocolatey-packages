...
$version = '135.0.7021.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1421079/mini_installer.exe'
  checksum      = '6FFC462F343B8285D9497C0294EE0BB5ED62AEB3C93CAC5C23E4D9EE48149C06'
  checksumType  = 'sha256'
