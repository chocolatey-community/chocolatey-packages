...
$version = '132.0.6782.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1369915/mini_installer.exe'
  checksum      = '127369B9B4DDD61948EEDD1BBE426CD4740903C2A335A3255A1705523989191D'
  checksumType  = 'sha256'
