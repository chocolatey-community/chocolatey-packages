...
$version = '130.0.6699.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1351079/mini_installer.exe'
  checksum      = '76DDE7E55EA88A45B2196984CE9E6B54495FACF6003A25405E6D72A8160215C0'
  checksumType  = 'sha256'
