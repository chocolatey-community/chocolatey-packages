...
$version = '130.0.6670.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1344633/mini_installer.exe'
  checksum      = '3F1FFDD0C96D7BA1E9DA4F8F327B3D490998FB578F294EBCCEB44A4EA5F832F2'
  checksumType  = 'sha256'
