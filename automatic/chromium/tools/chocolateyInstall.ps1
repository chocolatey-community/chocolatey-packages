...
$version = '152.0.7969.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1667147/mini_installer.exe'
  checksum      = '23450A6EC1E2133D500A42AD1F152803C83594EA9A52E7D505216C200A77C077'
  checksumType  = 'sha256'
