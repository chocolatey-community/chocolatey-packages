...
$version = '128.0.6581.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1323902/mini_installer.exe'
  checksum      = '1D2D64D325D2D4712657D4799CA30AE269511C25102946DF3BA0546684A21DA4'
  checksumType  = 'sha256'
