...
$version = '142.0.7423.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1517725/mini_installer.exe'
  checksum      = '69E1AF17162F8F64FB90D2BCD67CA90F2C51BC13CEA93E0FFE9B456C5ADEC604'
  checksumType  = 'sha256'
