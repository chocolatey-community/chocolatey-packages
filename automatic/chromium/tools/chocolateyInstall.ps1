...
$version = '136.0.7098.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1439837/mini_installer.exe'
  checksum      = '4808127EF6BCAB81EF81A597C95D6824167547E72E9BA0184135C9F5167A1D93'
  checksumType  = 'sha256'
