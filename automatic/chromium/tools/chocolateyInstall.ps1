...
$version = '140.0.7295.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1486122/mini_installer.exe'
  checksum      = 'FFE810106081CAE53C37E590B5D5B0BDCB5203BE9CA53E6ACE70C604ABC3A264'
  checksumType  = 'sha256'
