...
$version = '140.0.7263.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1479421/mini_installer.exe'
  checksum      = '3968FE5147EF605663CED42A1245811A3459B964A78A94AF86B7C04BF3522843'
  checksumType  = 'sha256'
