...
$version = '138.0.7176.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1458677/mini_installer.exe'
  checksum      = 'C194A1FC71EC65F7456F0BCC38FC0DADB413DDF161A0A1E75A19D1CEE2650714'
  checksumType  = 'sha256'
