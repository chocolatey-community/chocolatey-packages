...
$version = '145.0.7587.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1560981/mini_installer.exe'
  checksum      = '1883939A061F26832F357E80595C347B05DDB7E490F00FD5C250CB35A5EEE7DC'
  checksumType  = 'sha256'
