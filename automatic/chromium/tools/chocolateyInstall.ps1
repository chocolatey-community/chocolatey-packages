...
$version = '133.0.6930.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1401058/mini_installer.exe'
  checksum      = 'FE9A44CC15E911336A53DF00E59B0A040A6BAD0EDCE92CE13CFF5F469D7DE440'
  checksumType  = 'sha256'
