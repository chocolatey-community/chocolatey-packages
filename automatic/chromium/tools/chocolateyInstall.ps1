...
$version = '152.0.7929.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1656397/mini_installer.exe'
  checksum      = 'F286012D9E34F21682655AB40DD9F3F4FBDB24F9F2FD2213B8A8C9BA188812E8'
  checksumType  = 'sha256'
