...
$version = '138.0.7155.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1454372/mini_installer.exe'
  checksum      = '9578137A80EC13025F161F1509C788D12A023434690739221927FBAC68CA60D0'
  checksumType  = 'sha256'
