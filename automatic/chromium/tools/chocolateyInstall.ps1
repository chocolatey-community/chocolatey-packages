...
$version = '143.0.7479.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1531475/mini_installer.exe'
  checksum      = '4AE473DC7DAF5CF6C33230A87945ADABBE3F1C2AC13E0C59AE0A17DEC408395C'
  checksumType  = 'sha256'
