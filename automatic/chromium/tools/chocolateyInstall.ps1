...
$version = '147.0.7706.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1590713/mini_installer.exe'
  checksum      = '6CAD82B130E3D6C7C68EF912A752CB0E6015094BED41F681CC45503F099C34FE'
  checksumType  = 'sha256'
