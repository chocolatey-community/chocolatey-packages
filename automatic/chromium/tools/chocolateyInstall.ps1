...
$version = '150.0.7848.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1633231/mini_installer.exe'
  checksum      = '9C623B8E394439D67CB4DB3D72211D67EAF59D5C3FEFB2E210C37B09575A1A38'
  checksumType  = 'sha256'
