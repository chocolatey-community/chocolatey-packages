...
$version = '151.0.7909.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1650743/mini_installer.exe'
  checksum      = '9084BFDF4AA46F4B78429D95CD6197965CE101AA308FFA7DEDB8A89CE23E6E64'
  checksumType  = 'sha256'
