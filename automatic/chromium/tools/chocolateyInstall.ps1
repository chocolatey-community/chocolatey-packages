...
$version = '136.0.7084.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1436414/mini_installer.exe'
  checksum      = '07A4EB441A5F3DE494B5D866CEC7ED692BE27C454AD5634975FA973CEA1804C1'
  checksumType  = 'sha256'
