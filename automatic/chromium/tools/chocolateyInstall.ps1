...
$version = '144.0.7546.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1549539/mini_installer.exe'
  checksum      = '54FD1D83CC7D3AC3868CFC74C2C1F621C19C725E0973028885E1F60D0BD574F7'
  checksumType  = 'sha256'
