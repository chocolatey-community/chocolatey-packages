...
$version = '128.0.6602.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1328602/mini_installer.exe'
  checksum      = '80841B6030D4363FA9C6A68695BF22FC4CEEDC6E5BFC023C6B065C9CD6DC7EA8'
  checksumType  = 'sha256'
