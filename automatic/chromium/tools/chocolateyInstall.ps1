...
$version = '136.0.7097.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1439454/mini_installer.exe'
  checksum      = 'A87E715A88DB46B7E4DDA98269D858FACAE56A52187B89DB33DB1CAC27CC72DF'
  checksumType  = 'sha256'
