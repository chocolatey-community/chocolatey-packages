...
$version = '147.0.7716.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1593169/mini_installer.exe'
  checksum      = 'D63C05D5AABE3D89D363DEBC7439009C31016ACD2BE8853C5974A19C32126FD1'
  checksumType  = 'sha256'
