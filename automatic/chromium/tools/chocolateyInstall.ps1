...
$version = '152.0.7964.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1665339/mini_installer.exe'
  checksum      = '592F5631BAC84A82918565521F5A709703E4300A0838B1CFD58EB8A37D3B2C61'
  checksumType  = 'sha256'
