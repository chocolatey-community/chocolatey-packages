...
$version = '133.0.6867.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1389696/mini_installer.exe'
  checksum      = 'D98C4F0AB028789E229CE73C6FF0B95CFE08D3CD4CBD574D69C4CA4E53574395'
  checksumType  = 'sha256'
