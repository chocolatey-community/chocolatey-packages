...
$version = '145.0.7593.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1561726/mini_installer.exe'
  checksum      = '4CBC0B5EDFDC4A2BE0C6BEBC59F449DE4BA25F858E30BFC6A4BE50901878FD4D'
  checksumType  = 'sha256'
