...
$version = '143.0.7469.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1528679/mini_installer.exe'
  checksum      = '6D26D8A82E0AEC496EB7B6A9F0CED2AA21EE2529F321DE3E273740AF119539B4'
  checksumType  = 'sha256'
