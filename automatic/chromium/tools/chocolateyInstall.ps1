...
$version = '152.0.7945.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1660697/mini_installer.exe'
  checksum      = 'E4BDDF4836DD1C8109FDEE71C886A7B3F4E7BE7C7477F76B08BC10B3C9B8B2D7'
  checksumType  = 'sha256'
