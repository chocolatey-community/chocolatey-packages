...
$version = '139.0.7251.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1476352/mini_installer.exe'
  checksum      = '94EF2C806F9D458C37DB71F6198DE790C14F1410B195BE6224BB854B7BFE4CC3'
  checksumType  = 'sha256'
