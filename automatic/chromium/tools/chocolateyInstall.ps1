...
$version = '133.0.6900.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1396556/mini_installer.exe'
  checksum      = '5B4D97CF4EA0DA599FC847DAA9E28E2C789247AC50DB998CCECBB247E6BA510C'
  checksumType  = 'sha256'
