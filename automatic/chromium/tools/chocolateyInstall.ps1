...
$version = '129.0.6615.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1332228/mini_installer.exe'
  checksum      = '3E70ED95B63252252AD92A39AFC664A8CCC1FF6E0E49BE659303F71B82B001C1'
  checksumType  = 'sha256'
