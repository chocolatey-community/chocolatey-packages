...
$version = '136.0.7101.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1440039/mini_installer.exe'
  checksum      = 'D613039710DD4D0BD8D3F4CD1FD37AD15C3490997F17468870F3058CAAB8D755'
  checksumType  = 'sha256'
