...
$version = '148.0.7728.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1596822/mini_installer.exe'
  checksum      = '12BE45E70937FE42E551DF62C357DAF4B60B01DDE25A436E04F05D80FD41DD9A'
  checksumType  = 'sha256'
