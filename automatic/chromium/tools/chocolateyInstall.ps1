...
$version = '136.0.7058.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1429921/mini_installer.exe'
  checksum      = '244629E65CF4BD9D62D8E3B8CB5EC9E1F3BD5E2C01C435E8E8E4967ED2CC0744'
  checksumType  = 'sha256'
