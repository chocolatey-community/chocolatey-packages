...
$version = '143.0.7447.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1523655/mini_installer.exe'
  checksum      = '4351121F0BA1AF86CCCF02D735FF785F8C5170F07BA82AA5C401039F984FCFAD'
  checksumType  = 'sha256'
