...
$version = '133.0.6878.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1391846/mini_installer.exe'
  checksum      = '2D464DBC5F8FD68FE3E8A58515F6A546AEFA33BEAC0101590D8EE19DB4E2865C'
  checksumType  = 'sha256'
