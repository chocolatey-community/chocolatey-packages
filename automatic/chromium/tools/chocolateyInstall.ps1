...
$version = '132.0.6801.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1374324/mini_installer.exe'
  checksum      = '8D5992E8ABD56E5C46580F6A2A02E883C433C6AED363293508C8E579769F3572'
  checksumType  = 'sha256'
