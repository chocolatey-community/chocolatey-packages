...
$version = '133.0.6924.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1400628/mini_installer.exe'
  checksum      = 'C426B14BA2E9B73973DD488EAC4D3A64C4A4898BC96DF10A4F4DE34EF0AE6CF1'
  checksumType  = 'sha256'
