...
$version = '146.0.7662.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1577709/mini_installer.exe'
  checksum      = 'E1109E0B4F69BEBD6783360EF5A01F434C528F2F4C2312ADF334931C1B99A70F'
  checksumType  = 'sha256'
