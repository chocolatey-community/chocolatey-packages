...
$version = '142.0.7404.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1512809/mini_installer.exe'
  checksum      = '6000E4F44F93BD11F2650728243B7F67C92CA7E07F6F50698AB8027C0DD0D315'
  checksumType  = 'sha256'
