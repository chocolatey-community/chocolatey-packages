...
$version = '129.0.6655.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1340771/mini_installer.exe'
  checksum      = '76E15FBA6CE35B52B0D607AB33C6994B062C84C351DAE4FED458ED889ED16F4F'
  checksumType  = 'sha256'
