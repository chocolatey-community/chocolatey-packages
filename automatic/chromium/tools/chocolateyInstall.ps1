...
$version = '138.0.7178.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1459257/mini_installer.exe'
  checksum      = 'D1BF60A2974BF4B56056333DFAF83F640C5A8745827EA8ABA00333B96B5ED43A'
  checksumType  = 'sha256'
