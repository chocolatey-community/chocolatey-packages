...
$version = '153.0.8001.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1676400/mini_installer.exe'
  checksum      = '69595FD403369CB20AE31E4B82E495FE9A107B9189A5F427306993F6049FFFFB'
  checksumType  = 'sha256'
