...
$version = '153.0.7984.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1672062/mini_installer.exe'
  checksum      = 'EA323A5C5DA9DDAC42FAE747055CA9C453FE02031946AA1A2D4E8B46C53C6376'
  checksumType  = 'sha256'
