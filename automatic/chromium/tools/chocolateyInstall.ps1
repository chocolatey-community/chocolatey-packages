...
$version = '136.0.7100.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1439958/mini_installer.exe'
  checksum      = 'E7842271CA1954D8502C8918F34C211B5F3A0EA3780996D2CD51A370C17C0CA7'
  checksumType  = 'sha256'
