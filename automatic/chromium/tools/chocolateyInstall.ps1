...
$version = '145.0.7612.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1563677/mini_installer.exe'
  checksum      = '3276D23FF33B0B75DE0095A9AC8E206390D26FB78212FA2B36E4E24CC7692ACA'
  checksumType  = 'sha256'
