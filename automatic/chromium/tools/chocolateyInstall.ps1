...
$version = '151.0.7886.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1644540/mini_installer.exe'
  checksum      = '473B6DD23F0CDFBDC60EFF83B27DF0DB112AB5CBEBCE28073BD068299C7A7537'
  checksumType  = 'sha256'
