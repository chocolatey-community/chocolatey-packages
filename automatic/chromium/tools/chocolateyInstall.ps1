...
$version = '150.0.7869.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1639004/mini_installer.exe'
  checksum      = '86B8308F9F61EE19C415E8B85E95D834490560FB6F37702DDB8EB66C2D3D1F79'
  checksumType  = 'sha256'
