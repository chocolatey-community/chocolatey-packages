...
$version = '133.0.6836.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1382212/mini_installer.exe'
  checksum      = 'CB5F093192E5BCF72578F96372BC1813C558610054B12AEE13801FB54ED91C6B'
  checksumType  = 'sha256'
