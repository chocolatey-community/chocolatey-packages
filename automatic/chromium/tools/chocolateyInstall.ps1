...
$version = '126.0.6468.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1298333/mini_installer.exe'
  checksum      = 'FF7AE745E97A7D6AA66DFF16FCD38841AF1C3AA0C2E8663071284311572BEC47'
  checksumType  = 'sha256'
