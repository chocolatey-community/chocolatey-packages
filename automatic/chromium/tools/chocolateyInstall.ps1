...
$version = '146.0.7642.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1570863/mini_installer.exe'
  checksum      = '02FBA7FB5E41DCCA2BCA9628623E628BC34A25FBE01BE87D4E9CDFF8126B329F'
  checksumType  = 'sha256'
