...
$version = '153.0.7982.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1671436/mini_installer.exe'
  checksum      = '0DC46AA079490B08614F4A25FAB708615A201F0DEC08412538BCD617E55FFDF4'
  checksumType  = 'sha256'
