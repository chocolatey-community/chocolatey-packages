...
$version = '133.0.6903.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1397558/mini_installer.exe'
  checksum      = '700EAF2572F0E6779622CADA8DE63C8F9EECDC6283BDE27A18123E17D1527154'
  checksumType  = 'sha256'
