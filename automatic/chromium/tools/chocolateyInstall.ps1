...
$version = '133.0.6874.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1390596/mini_installer.exe'
  checksum      = '52FF61349A121A58365BC2A3E0B5E25AF1C26F2387A37B7B7FB03CEE04B451ED'
  checksumType  = 'sha256'
