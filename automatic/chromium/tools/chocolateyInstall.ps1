...
$version = '152.0.7959.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1664357/mini_installer.exe'
  checksum      = 'BE11FB52A3A55272876C1124346ECD0E6B7F59C474687BAF6901CA2714917107'
  checksumType  = 'sha256'
