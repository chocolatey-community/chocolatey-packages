...
$version = '153.0.7990.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1672718/mini_installer.exe'
  checksum      = 'D393E4CF213BE01A9FB55488FF80D3FF24A4286D9350467AAE7F4EA19614309B'
  checksumType  = 'sha256'
