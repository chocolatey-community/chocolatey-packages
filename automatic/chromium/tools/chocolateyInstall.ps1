...
$version = '140.0.7260.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1478324/mini_installer.exe'
  checksum      = '32E23DB562835B42E5EA456993047F2FDF087480984FA2642388EC717DA50F7E'
  checksumType  = 'sha256'
