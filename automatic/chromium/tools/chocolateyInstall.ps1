...
$version = '151.0.7917.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1653636/mini_installer.exe'
  checksum      = '270BD9156A67EC642F3133D54CCDEBAF81C6D9CF289C922A6A246597C12FBC90'
  checksumType  = 'sha256'
