...
$version = '135.0.7008.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1417864/mini_installer.exe'
  checksum      = '0299D297E8D7A9453098498D6B41D59AC1C960E652A7B854477503D77BB6006D'
  checksumType  = 'sha256'
