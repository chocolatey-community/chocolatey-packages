...
$version = '144.0.7504.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1538239/mini_installer.exe'
  checksum      = 'AC12306606577E53611B2B3875F4216BDD2ABB3FF6E28B722CEF2FAD040820B7'
  checksumType  = 'sha256'
