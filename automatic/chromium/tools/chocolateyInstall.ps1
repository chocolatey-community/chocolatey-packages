...
$version = '145.0.7632.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1567724/mini_installer.exe'
  checksum      = '0FDAE7B4A430EE8106957A0F7E10FC581E6834AF264B5F7A797205763ACECEBA'
  checksumType  = 'sha256'
