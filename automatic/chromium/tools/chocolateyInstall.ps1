...
$version = '140.0.7268.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1480248/mini_installer.exe'
  checksum      = '7CFF3A9AA2DD8A742DEB115A1AF8C44517C308544FB2B8E6190702A383A501F1'
  checksumType  = 'sha256'
