...
$version = '139.0.7225.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1470882/mini_installer.exe'
  checksum      = 'C265CC31F06C84D0EB0BE78CB6964E24A19417401FE6E8948A0B0CF5B0C44C0E'
  checksumType  = 'sha256'
