...
$version = '133.0.6911.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1399566/mini_installer.exe'
  checksum      = '11985768A10149CBEE6885333BDEA0A353EB5400C904091031EC2FF6FF69C6A8'
  checksumType  = 'sha256'
