...
$version = '151.0.7911.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1651479/mini_installer.exe'
  checksum      = '82DC97712AE1D1C8B62FE19ED72CE56FD3B4B33E2EDEC14BAF52126B5379A34C'
  checksumType  = 'sha256'
