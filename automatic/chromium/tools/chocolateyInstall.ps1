...
$version = '150.0.7847.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1632686/mini_installer.exe'
  checksum      = '272715995EC75CDC3545375CFEA4614BCE4CA353FFDA9A75E58D567FD6AB7346'
  checksumType  = 'sha256'
