...
$version = '133.0.6912.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1399605/mini_installer.exe'
  checksum      = '38B05F930CE9CD3E86C70B6D0C1F935851A84D6FC2F99ABC6608A4E7211DAD17'
  checksumType  = 'sha256'
