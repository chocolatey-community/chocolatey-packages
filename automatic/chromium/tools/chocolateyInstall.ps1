...
$version = '147.0.7689.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1585145/mini_installer.exe'
  checksum      = '57B847D3FE23C9EEED0CC4A4CA3F7112264B472C92567F370FFF772D03BFB205'
  checksumType  = 'sha256'
