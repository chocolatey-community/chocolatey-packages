...
$version = '151.0.7914.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1652423/mini_installer.exe'
  checksum      = '9AB119E7378010A9D0C6DEC600F69EB51AC6D124ADF6F605A0901C2F2F6C7203'
  checksumType  = 'sha256'
