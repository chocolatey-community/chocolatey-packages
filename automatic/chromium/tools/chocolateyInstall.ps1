...
$version = '126.0.6465.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1297356/mini_installer.exe'
  checksum      = '0F36787327A5CEA3BF2E9C166010B92464ECABDDCCAE493B0B75409B396596B5'
  checksumType  = 'sha256'
