...
$version = '140.0.7299.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1486996/mini_installer.exe'
  checksum      = 'E63A18F286CD76E3DF735C90212F0EB9005FF77952C5787540D84E43A0C01161'
  checksumType  = 'sha256'
