...
$version = '140.0.7291.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1485670/mini_installer.exe'
  checksum      = '893A3E5BF2A1B8E716CB303D515DB38505A94FEF656BEB573549A5A508F2B615'
  checksumType  = 'sha256'
