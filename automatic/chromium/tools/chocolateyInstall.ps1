...
$version = '133.0.6854.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1387040/mini_installer.exe'
  checksum      = '0CD4952C0A384702399DEA4ACB4626248CB75D147D37E6AA3BBB3C0D5041E3E9'
  checksumType  = 'sha256'
