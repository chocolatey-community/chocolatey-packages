...
$version = '140.0.7296.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1486159/mini_installer.exe'
  checksum      = '83BE8690A6BBDD96B382B24C6480AD0194D87CB2F0AA6A835379D3170458CC51'
  checksumType  = 'sha256'
