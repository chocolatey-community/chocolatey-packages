...
$version = '144.0.7522.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1542769/mini_installer.exe'
  checksum      = 'E3AB84F8B689F3D963BF791B0DFF710B4E12E1363FC612FD2ABDFE2870159A94'
  checksumType  = 'sha256'
