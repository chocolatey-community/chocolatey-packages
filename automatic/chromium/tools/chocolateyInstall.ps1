...
$version = '136.0.7063.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1430607/mini_installer.exe'
  checksum      = '4B3B55E5D68CE8ADF1701326050F075287C1236F11C7D5B01C253BE170492340'
  checksumType  = 'sha256'
