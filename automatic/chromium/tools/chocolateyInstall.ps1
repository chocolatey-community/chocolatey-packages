...
$version = '136.0.7051.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1428310/mini_installer.exe'
  checksum      = '8BA1FA4C67B50BAA87786C1A5E5F2866467D22B716C727E39097C02DB7C09B84'
  checksumType  = 'sha256'
