...
$version = '133.0.6866.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1389545/mini_installer.exe'
  checksum      = '5004A76A350A59684022C3FE92602D60428EB1B1EE2EC8A37E7C101F71D9B8BF'
  checksumType  = 'sha256'
