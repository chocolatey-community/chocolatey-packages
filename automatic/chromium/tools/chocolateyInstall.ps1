...
$version = '133.0.6857.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1387313/mini_installer.exe'
  checksum      = '076B833BABA0E2FF3E093EDB580553F00FA73D5BEF5193E4246057FA8B23F8A0'
  checksumType  = 'sha256'
