...
$version = '131.0.6756.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1363805/mini_installer.exe'
  checksum      = 'FE0DB2BE59C83018B744B2AC133D7872C72963CA79A56DD95561A8E742CD6F71'
  checksumType  = 'sha256'
