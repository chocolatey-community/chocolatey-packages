...
$version = '143.0.7448.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1524092/mini_installer.exe'
  checksum      = '12B00DCAB701CE056BFAD189F371EAB4F20FCBA686CF6FF19C48840B19AFED3D'
  checksumType  = 'sha256'
