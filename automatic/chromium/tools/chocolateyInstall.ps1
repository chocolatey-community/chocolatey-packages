...
$version = '134.0.6954.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1405324/mini_installer.exe'
  checksum      = '0A38293D6B761BD7A80E74C523C1A96E85D175CC8847DA14D4211F76468B5B9E'
  checksumType  = 'sha256'
