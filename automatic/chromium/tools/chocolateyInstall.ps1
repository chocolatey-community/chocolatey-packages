...
$version = '151.0.7881.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1642904/mini_installer.exe'
  checksum      = '5CA56872F091BFE9A2FC0B1FBF90F8D4C7923DE68F42D8AD8CBDD0ADB9010DA5'
  checksumType  = 'sha256'
