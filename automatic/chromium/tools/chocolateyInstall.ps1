...
$version = '146.0.7658.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1576429/mini_installer.exe'
  checksum      = '6A23E0E72EE9386CD39C9CD3591AFEBA963ADF65AA6E22E0D1BE454BF36FDA50'
  checksumType  = 'sha256'
