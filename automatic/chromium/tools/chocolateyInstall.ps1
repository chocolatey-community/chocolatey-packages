...
$version = '133.0.6840.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1383827/mini_installer.exe'
  checksum      = 'CABD9B8477CBDA30AB3E1B829574A4CBC322EF3B5AFE2C52ECDD31E949912A2F'
  checksumType  = 'sha256'
