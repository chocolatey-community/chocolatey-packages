...
$version = '145.0.7590.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1561557/mini_installer.exe'
  checksum      = '57CB3298744A4B26D9A5C5D5831C0F6683E51A0B14F985A2C3347AF8B0FA0566'
  checksumType  = 'sha256'
