...
$version = '129.0.6626.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1334453/mini_installer.exe'
  checksum      = '1595D703E154DCFDDF297EDBED8C4A48D0C9ECFBB1B9F25D4737C18FAED785D6'
  checksumType  = 'sha256'
