...
$version = '137.0.7143.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1450539/mini_installer.exe'
  checksum      = '7D49DEA76356A9C49A76C184F38993D93F6872E56E2C664A199E23AB1EB79BE6'
  checksumType  = 'sha256'
