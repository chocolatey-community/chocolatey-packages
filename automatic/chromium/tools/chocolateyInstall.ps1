...
$version = '154.0.8022.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1684656/mini_installer.exe'
  checksum      = '4413392F80B157695BB2AE7E2708928A2DF73B686A2226F1026CAB07D3D97BC1'
  checksumType  = 'sha256'
