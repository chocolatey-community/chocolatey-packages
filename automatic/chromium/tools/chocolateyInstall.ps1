...
$version = '136.0.7053.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1428799/mini_installer.exe'
  checksum      = '513365936476089328AFE539E9E0B70459A04EB15790DEC11A10B65A034BBEF8'
  checksumType  = 'sha256'
