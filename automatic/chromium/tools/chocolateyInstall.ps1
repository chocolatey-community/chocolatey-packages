...
$version = '129.0.6644.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1338732/mini_installer.exe'
  checksum      = '72380F08C3C50C9D886F3EA96FBD23DC597548F922C8A0F1B1B95EA9DEC238A5'
  checksumType  = 'sha256'
