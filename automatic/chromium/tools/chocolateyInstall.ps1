...
$version = '140.0.7282.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1483085/mini_installer.exe'
  checksum      = 'B9FFCE98CA504452A19867B1A55574C1957637512D9C33EF1C51E18E6F0BB6E8'
  checksumType  = 'sha256'
