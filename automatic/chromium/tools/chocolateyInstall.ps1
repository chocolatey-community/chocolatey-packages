...
$version = '138.0.7204.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1465620/mini_installer.exe'
  checksum      = '6FB46E24C784E786431BF6631DC1CD59AAE1B568CC602E1DFCA13A9DAD986018'
  checksumType  = 'sha256'
