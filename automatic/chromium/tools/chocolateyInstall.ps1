...
$version = '144.0.7523.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1542952/mini_installer.exe'
  checksum      = 'EA7698BE94EF38007FEC9A2E9A1FE9B8A97D3564E05CAB7B24FDB8B8D5962085'
  checksumType  = 'sha256'
