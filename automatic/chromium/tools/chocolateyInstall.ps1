...
$version = '132.0.6795.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1372721/mini_installer.exe'
  checksum      = 'ADB66E6B52FA8061996ABEE44B32F4F527EA21DE58C824A954ADF06E62ABB1BB'
  checksumType  = 'sha256'
