...
$version = '128.0.6566.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1321331/mini_installer.exe'
  checksum      = 'B4F5D0FBE7413FD48FA67E010C539FFA155E7779FDEE5066B5D4C8154BD729EB'
  checksumType  = 'sha256'
