...
$version = '129.0.6648.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1339672/mini_installer.exe'
  checksum      = 'DB47576E4FC826F92DAFB30D20056622B51E5195F986058C2FDD678BC0424DEA'
  checksumType  = 'sha256'
