...
$version = '142.0.7394.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1510702/mini_installer.exe'
  checksum      = 'EB18A1600FEDB77865E24BF582A4DBA29D704688A7BDD90A8BA109ACC8CADDD4'
  checksumType  = 'sha256'
