...
$version = '140.0.7264.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1479717/mini_installer.exe'
  checksum      = '087EC20D0B144E2FBC13D39B4569062329FD078D3D935DDFA7E0E7E320165122'
  checksumType  = 'sha256'
