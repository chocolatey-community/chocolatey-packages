...
$version = '136.0.7065.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1431320/mini_installer.exe'
  checksum      = 'D2E031CF3B753B33D62549B6419A2466280217C2A3D1FCF38CA0E6E09E110FF0'
  checksumType  = 'sha256'
