...
$version = '152.0.7941.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1659418/mini_installer.exe'
  checksum      = 'E077EE7D438B4D8E86B7C134DD7DC0AC737B46188F7AEE1E9A2C62F9CAB435FD'
  checksumType  = 'sha256'
