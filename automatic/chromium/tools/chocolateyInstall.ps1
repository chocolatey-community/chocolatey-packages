...
$version = '150.0.7856.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1635493/mini_installer.exe'
  checksum      = '4642B21B98B3072522FDD06E5E58A8F0DD6C06C508F4214D653B103DC7051E09'
  checksumType  = 'sha256'
