...
$version = '139.0.7242.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1474063/mini_installer.exe'
  checksum      = '7D447F12596F4654BF3E39910793399F677B074CCAD5E8E23BC8BD824976A237'
  checksumType  = 'sha256'
