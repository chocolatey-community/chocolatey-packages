...
$version = '134.0.6957.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1405879/mini_installer.exe'
  checksum      = '358E838B37FA6739AEA8BEB6993A10C2506A5335F3FEA71388D9540A6B512332'
  checksumType  = 'sha256'
