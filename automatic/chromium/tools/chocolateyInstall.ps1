...
$version = '147.0.7685.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1584192/mini_installer.exe'
  checksum      = '0B8598BE50352FAE3FA21990E1B4C8738F3A4A4EDBD464CBF7AFE5FAB328DBA7'
  checksumType  = 'sha256'
