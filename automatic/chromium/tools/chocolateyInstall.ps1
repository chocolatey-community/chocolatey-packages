...
$version = '142.0.7409.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1514324/mini_installer.exe'
  checksum      = '2EE0D0AA088AE72F58C458A2436E5ACDC52103090849C41BEFA560A03E1D2481'
  checksumType  = 'sha256'
