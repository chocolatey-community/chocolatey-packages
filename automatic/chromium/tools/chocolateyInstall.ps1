...
$version = '138.0.7160.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1455375/mini_installer.exe'
  checksum      = 'AAE58C812D48B36732D7A5B85237F6B23A1286A7D229B1779DAA54B0FAD7EB4A'
  checksumType  = 'sha256'
