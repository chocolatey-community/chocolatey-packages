...
$version = '136.0.7056.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1429710/mini_installer.exe'
  checksum      = '46D9B1BAA9C1D676ABD37346E1692B0DE9EFCBF0DB61A5EAEFAE761CF98793E4'
  checksumType  = 'sha256'
