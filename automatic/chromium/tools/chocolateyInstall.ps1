...
$version = '127.0.6510.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1307691/mini_installer.exe'
  checksum      = '806F4C5EE04804DF54C498FD6B9491FDAC47C84F27E6D0C32FD96631D20FACDA'
  checksumType  = 'sha256'
