...
$version = '134.0.6946.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1403843/mini_installer.exe'
  checksum      = '4D81692C0BE65EA187EEFECE3ADD540533C690A57B4708C5FD355616589DF42A'
  checksumType  = 'sha256'
