...
$version = '146.0.7653.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1574545/mini_installer.exe'
  checksum      = 'C616A0AC4DA5282A21B0B1394F2087C04C5CAE590AB76C6B3B28471463C341E8'
  checksumType  = 'sha256'
