...
$version = '127.0.6493.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1303563/mini_installer.exe'
  checksum      = '3799363D394D7DBB2187801EFC364FE26714D3BC8A5AC71D7319573AEAA47DB5'
  checksumType  = 'sha256'
