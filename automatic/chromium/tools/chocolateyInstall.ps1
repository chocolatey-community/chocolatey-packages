...
$version = '134.0.6988.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1413117/mini_installer.exe'
  checksum      = '39A97F4EAF4BC8AC242F0090FDBA098AD33BA0B129F334DFEB165D7C532FD6F3'
  checksumType  = 'sha256'
