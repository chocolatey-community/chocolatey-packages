...
$version = '153.0.7996.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1675604/mini_installer.exe'
  checksum      = '24DDBF60AD9AB5B43E054888B42D81F9467F0A6FF07FD166838BB75AECAC0DDB'
  checksumType  = 'sha256'
