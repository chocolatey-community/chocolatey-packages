...
$version = '139.0.7238.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1473764/mini_installer.exe'
  checksum      = '8DC081FA63F8DDBDE19EF884B1DB83D500723D8DD79FF05A2521C2FCED7A550B'
  checksumType  = 'sha256'
