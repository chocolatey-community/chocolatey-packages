...
$version = '135.0.7000.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1416055/mini_installer.exe'
  checksum      = '404190D512880D457F2C388C820E9F5177D48ACA2CD42A4F9C6F8DFA1FCDA4FE'
  checksumType  = 'sha256'
