...
$version = '154.0.8014.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1683076/mini_installer.exe'
  checksum      = '3C64F9EA28675E5A653E1123FDD02750171BA684662011D08C5426D3CF21FC38'
  checksumType  = 'sha256'
