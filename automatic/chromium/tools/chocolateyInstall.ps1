...
$version = '133.0.6871.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1390048/mini_installer.exe'
  checksum      = 'DDACD21DD5F217504BA5654FD712AB8C35ADF647F27BDA8DCB481E4AF838BBF4'
  checksumType  = 'sha256'
