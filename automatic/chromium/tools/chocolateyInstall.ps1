...
$version = '130.0.6689.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1349207/mini_installer.exe'
  checksum      = '6A9A393A6DE40EC7FB3AE3EAA804A09C6DEE176FBC0C59FBF3AD49A3AFD77820'
  checksumType  = 'sha256'
