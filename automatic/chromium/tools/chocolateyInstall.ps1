...
$version = '130.0.6715.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1354709/mini_installer.exe'
  checksum      = 'C27FD7497E237AC63A55376B82803CA52109CFF941FBFCC7967B520C13EF6B1A'
  checksumType  = 'sha256'
