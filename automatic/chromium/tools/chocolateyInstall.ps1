...
$version = '140.0.7297.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1486385/mini_installer.exe'
  checksum      = '1D5553B102E58DAF135CBDD120C300C5BF83964054F22D89270CD096952256F4'
  checksumType  = 'sha256'
