...
$version = '139.0.7210.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1467407/mini_installer.exe'
  checksum      = 'A9AFE74C832A2718E30A2734C5BFE60E0F9F51C3AFCE8B031EA18E0CDD30655D'
  checksumType  = 'sha256'
