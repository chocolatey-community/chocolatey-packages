...
$version = '133.0.6845.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1384221/mini_installer.exe'
  checksum      = 'E326E9FFB2F2EBF03F7AC94858268C9478D604EAEF90D9FFC42FEC304A5F4D0E'
  checksumType  = 'sha256'
