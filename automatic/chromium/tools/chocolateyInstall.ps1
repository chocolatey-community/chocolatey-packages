...
$version = '150.0.7835.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1628148/mini_installer.exe'
  checksum      = '0A2728327BFD80101C4A030198A2CD23B10F020DE0C0608D50626321E2679590'
  checksumType  = 'sha256'
