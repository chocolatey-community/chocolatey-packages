...
$version = '129.0.6661.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1342705/mini_installer.exe'
  checksum      = 'CA4AA0717FC6D7FF8A61B5380AD0B64AD51A92D0DC0299F4D98C770D7E8A1710'
  checksumType  = 'sha256'
