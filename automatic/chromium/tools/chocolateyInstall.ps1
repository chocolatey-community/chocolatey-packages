...
$version = '138.0.7180.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1460341/mini_installer.exe'
  checksum      = '61D9F3339CA7BA667F3263A117481049BD433ABFCD2FBC0F47DECAD1059FA3D4'
  checksumType  = 'sha256'
