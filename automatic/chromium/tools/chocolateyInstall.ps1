...
$version = '135.0.7024.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1421827/mini_installer.exe'
  checksum      = '181ACC1479F2BE097CEC48A4463C5D140A800E2036F5DE2E22011F3DAECAB41D'
  checksumType  = 'sha256'
