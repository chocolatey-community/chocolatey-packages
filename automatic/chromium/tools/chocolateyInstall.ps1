...
$version = '143.0.7484.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1532043/mini_installer.exe'
  checksum      = '6DFA80492EEEC0B0DBDCFC8CBC4FA83ED010C7DECF8388883DF6808EB4B24090'
  checksumType  = 'sha256'
