...
$version = '131.0.6776.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1368061/mini_installer.exe'
  checksum      = '632BE125354D8FD3E5201A008AE3B435AA3B8FE638C014C2039E587F29B26E4E'
  checksumType  = 'sha256'
