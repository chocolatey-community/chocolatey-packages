...
$version = '129.0.6650.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1340096/mini_installer.exe'
  checksum      = 'F5DF24A3EC270158218D5152CFEB54DCAF6DC2441235009C90B3B02589E1B278'
  checksumType  = 'sha256'
