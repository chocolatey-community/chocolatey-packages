...
$version = '128.0.6584.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1324061/mini_installer.exe'
  checksum      = '9BEF664EE296298773B8C0809B08CD9306ADA448BF3F3964E6CBCF6CEDF81A60'
  checksumType  = 'sha256'
