...
$version = '143.0.7497.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1535656/mini_installer.exe'
  checksum      = '8CF3C7061B166014FDF4EBCC2979E2FC5B51D92AD71AF7A8CB87E2B4ADB80E0A'
  checksumType  = 'sha256'
