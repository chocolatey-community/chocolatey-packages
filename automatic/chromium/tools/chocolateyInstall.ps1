...
$version = '134.0.6945.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1403475/mini_installer.exe'
  checksum      = 'F55DED804BA3BEA9CAABEAA312499CEF34E4266FDBA5CE6D43A294B2A43FE36E'
  checksumType  = 'sha256'
