...
$version = '152.0.7966.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1666104/mini_installer.exe'
  checksum      = '6EE60D887159CFAB9941B2AC39026DA73F4F031EF4A332FEC4C56041DA102742'
  checksumType  = 'sha256'
