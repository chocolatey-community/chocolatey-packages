...
$version = '139.0.7235.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1472968/mini_installer.exe'
  checksum      = 'A7F07083D0B0B58D518DFB0A532B2CCCB2F5E587E74F5550DAF742328DD176F9'
  checksumType  = 'sha256'
