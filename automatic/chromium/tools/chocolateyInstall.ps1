...
$version = '148.0.7731.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1598192/mini_installer.exe'
  checksum      = 'D814B9B075B1E615BFC25BB338F57E64C4278F6EE9391EC2AA70DFC49A849286'
  checksumType  = 'sha256'
