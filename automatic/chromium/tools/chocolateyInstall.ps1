...
$version = '138.0.7203.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1465335/mini_installer.exe'
  checksum      = '4855AF97057C51A62CA7285430CE3561DFC71461995A9F1B8446E908788801CF'
  checksumType  = 'sha256'
