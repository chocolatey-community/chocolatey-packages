...
$version = '150.0.7849.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1633640/mini_installer.exe'
  checksum      = '3397E828B77FCCA4DCC54AF7F03EA550E4509059ADDC315B0E2A49ADAD57D5A8'
  checksumType  = 'sha256'
