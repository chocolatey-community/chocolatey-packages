...
$version = '143.0.7495.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1535560/mini_installer.exe'
  checksum      = 'FE0EBCC40F6759FC546B0133FD850C69BFB8042183583EA2ABEBC12274C37C81'
  checksumType  = 'sha256'
