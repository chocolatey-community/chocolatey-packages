...
$version = '152.0.7926.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1655892/mini_installer.exe'
  checksum      = 'F0CC9B3CD24E25A81DC010B5D66ABF9AE849242D71078D19B7E0256662FDA564'
  checksumType  = 'sha256'
