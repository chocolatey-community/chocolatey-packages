...
$version = '152.0.7946.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1660727/mini_installer.exe'
  checksum      = 'BB961EB53FBDF9747A89EEE558934D0E191325C8B738CAF05046C4EF084AB593'
  checksumType  = 'sha256'
