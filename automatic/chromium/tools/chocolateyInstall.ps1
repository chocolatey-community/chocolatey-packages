...
$version = '133.0.6870.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1390024/mini_installer.exe'
  checksum      = '494B0DC5D74E429C289F3F7D8AFB53CC19EE8FDBEB3686398F6FA0B1E340BE01'
  checksumType  = 'sha256'
