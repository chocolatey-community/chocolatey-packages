...
$version = '144.0.7525.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1543504/mini_installer.exe'
  checksum      = '194B0D810A1BBE4DE3A03C542DE64CCC1393DB13CC57D4EB001068E045FC3A9B'
  checksumType  = 'sha256'
