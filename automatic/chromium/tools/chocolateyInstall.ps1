...
$version = '150.0.7850.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1634130/mini_installer.exe'
  checksum      = '3A0173C7EDD20F63BD589E455789A3EE2007A53938C0AC618AD5B5B18D7E3C69'
  checksumType  = 'sha256'
