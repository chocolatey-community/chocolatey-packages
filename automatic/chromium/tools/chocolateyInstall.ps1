...
$version = '144.0.7508.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1539600/mini_installer.exe'
  checksum      = '33CAB321BC54B4CC8E210E08EC6DAC3441E61A1E758457EBC95F79BE1C6E4F54'
  checksumType  = 'sha256'
