...
$version = '140.0.7326.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1493218/mini_installer.exe'
  checksum      = '28CF98C61F603D456443BBCD86D34703C1953CAD15A54E130B4E1C267100EED2'
  checksumType  = 'sha256'
