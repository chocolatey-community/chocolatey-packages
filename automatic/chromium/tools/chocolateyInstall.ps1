...
$version = '144.0.7509.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1539814/mini_installer.exe'
  checksum      = '93B7D8FB7F56A0C2FCE808BB780BBCD0B8604B23EAC0284740D8F98CFA562225'
  checksumType  = 'sha256'
