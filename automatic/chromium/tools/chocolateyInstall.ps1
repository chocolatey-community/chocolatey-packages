...
$version = '135.0.7004.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1417213/mini_installer.exe'
  checksum      = 'B163869A6406D9C04025C852D37C25BE90C51F30660D90CD9FC594B0B742B38D'
  checksumType  = 'sha256'
