...
$version = '139.0.7243.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1474136/mini_installer.exe'
  checksum      = 'C5B18A5B74932564CB33B4C308F83E81BA16DDA56C406BF80CD7BF293DCA187E'
  checksumType  = 'sha256'
