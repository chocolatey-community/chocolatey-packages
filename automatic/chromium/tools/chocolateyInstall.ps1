...
$version = '127.0.6515.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1308876/mini_installer.exe'
  checksum      = '9C485F043799D10AD4564028A52F1BA2AE778F89332B762FD181825353386FAA'
  checksumType  = 'sha256'
