...
$version = '152.0.7953.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1662785/mini_installer.exe'
  checksum      = 'E90096B4717328735C9F47FF012041B2689D6525A264FB0B8E0E3DBC556293BC'
  checksumType  = 'sha256'
