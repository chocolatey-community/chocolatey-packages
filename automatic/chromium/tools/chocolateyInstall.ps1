...
$version = '147.0.7695.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1586453/mini_installer.exe'
  checksum      = 'D51E3E4A6E4C89DCE69118696D3715187DE4522490C424ACAC93833B5C0EA241'
  checksumType  = 'sha256'
