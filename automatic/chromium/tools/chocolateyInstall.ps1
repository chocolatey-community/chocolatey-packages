...
$version = '147.0.7691.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1585263/mini_installer.exe'
  checksum      = '3778CE56D7FB242812598E7CC6FAEF607D8D31722560B47933F1F5F123531B30'
  checksumType  = 'sha256'
