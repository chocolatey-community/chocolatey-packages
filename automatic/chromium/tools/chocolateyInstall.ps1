...
$version = '147.0.7724.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1595856/mini_installer.exe'
  checksum      = '3822932B02944CC9314E7A47F125B2CB08BD14F799AC464E2A11331AA2B7C4AE'
  checksumType  = 'sha256'
