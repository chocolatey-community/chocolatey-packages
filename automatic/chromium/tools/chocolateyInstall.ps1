...
$version = '134.0.6997.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1414810/mini_installer.exe'
  checksum      = '26EED3B7A6CEF5B470E6366612705804998B544C8B897FC6543207EDD6864DE4'
  checksumType  = 'sha256'
