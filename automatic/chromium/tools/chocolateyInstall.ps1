...
$version = '136.0.7086.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1436542/mini_installer.exe'
  checksum      = '23265920F90A0F11EE46A4378D0C30F5E05DB3AAC1097654165D79FC6B47E8D8'
  checksumType  = 'sha256'
