...
$version = '134.0.6979.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1411294/mini_installer.exe'
  checksum      = '07C73DCE25365DA061BB67321E0B7426E4352BCF804CAC88CC5C0EB535DBE5F0'
  checksumType  = 'sha256'
