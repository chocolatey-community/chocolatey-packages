...
$version = '145.0.7625.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1566819/mini_installer.exe'
  checksum      = 'CBCAA3E7E37345B1B04DF64FE2D798B754B8F38CFE96D6927F9FFC92233E86B2'
  checksumType  = 'sha256'
