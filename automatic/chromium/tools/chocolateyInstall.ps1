...
$version = '127.0.6486.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1302775/mini_installer.exe'
  checksum      = '596A466DA45490C744EA4BCC3AC0E3C2AEC6D32596D61EFF327F4F3E96A3984A'
  checksumType  = 'sha256'
