...
$version = '152.0.7942.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1659522/mini_installer.exe'
  checksum      = 'CC4C16AB440F71953E023C635E2636CB7D23BADBEB65D9CA0D1CF2FC58416DFB'
  checksumType  = 'sha256'
