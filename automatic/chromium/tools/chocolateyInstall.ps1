...
$version = '127.0.6489.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1303090/mini_installer.exe'
  checksum      = 'F7BD132835CCC2DAE7BD3EC262D6F9A36DC09D39F8BAA4697C1F72DC4D5CC72F'
  checksumType  = 'sha256'
