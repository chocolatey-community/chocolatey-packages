...
$version = '143.0.7492.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1534915/mini_installer.exe'
  checksum      = 'D025A2B8995395085B2EC4820314B7A13E5B109059BFA061399E5B6376BB57FF'
  checksumType  = 'sha256'
