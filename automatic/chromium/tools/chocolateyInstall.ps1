...
$version = '153.0.7981.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1670890/mini_installer.exe'
  checksum      = '649E7E7FAD1C63F4B992CF52DE4A167EEE051AF28C8FBF306A4A2245EAE66681'
  checksumType  = 'sha256'
