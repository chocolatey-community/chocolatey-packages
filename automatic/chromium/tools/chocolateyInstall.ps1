...
$version = '142.0.7405.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1513080/mini_installer.exe'
  checksum      = '9122C2F6D8C83580AF835856046F369A683280AC385B327A739E01B87867C60B'
  checksumType  = 'sha256'
