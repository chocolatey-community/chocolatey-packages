...
$version = '140.0.7309.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1489308/mini_installer.exe'
  checksum      = 'B22A4556F3A59767E11A97E068EAD2CDD779C0850181BF21FA1D824CAD6B2313'
  checksumType  = 'sha256'
