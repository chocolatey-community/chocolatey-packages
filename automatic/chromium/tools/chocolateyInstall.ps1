...
$version = '136.0.7085.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1436478/mini_installer.exe'
  checksum      = 'F859D13CAAA4492A6AF4DBAF0CDE2636FB5F726F56319D88BD89BBB436B82025'
  checksumType  = 'sha256'
