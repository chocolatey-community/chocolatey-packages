...
$version = '135.0.7028.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1422968/mini_installer.exe'
  checksum      = 'C49AA51F95F1EC83E93EA308C4D3B430CE8098A902AA0B4FE129162690458768'
  checksumType  = 'sha256'
