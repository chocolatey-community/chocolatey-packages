...
$version = '146.0.7636.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1569531/mini_installer.exe'
  checksum      = '75CFB020A21BAEC6E1A1474B08FCD1459906F962A4F3A1F8A144D4295567749A'
  checksumType  = 'sha256'
