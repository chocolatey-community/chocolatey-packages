...
$version = '150.0.7862.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1636760/mini_installer.exe'
  checksum      = '104FBC398D884D3DCADA444936A648529C1B063FCE8F02A19E42BA1394FB9930'
  checksumType  = 'sha256'
