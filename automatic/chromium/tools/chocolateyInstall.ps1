...
$version = '154.0.8033.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1688611/mini_installer.exe'
  checksum      = '18EEBB2FE2CA0F38299D4DD8E2B62D791BFB06E49651AC6FFD92300ABEA43A1D'
  checksumType  = 'sha256'
