...
$version = '139.0.7257.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1477096/mini_installer.exe'
  checksum      = 'F70CEAA2461E80307A9B91CF9DD0D04BA9B1C86DAF55570242817DC2E8376687'
  checksumType  = 'sha256'
