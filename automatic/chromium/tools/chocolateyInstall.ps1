...
$version = '132.0.6813.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1376870/mini_installer.exe'
  checksum      = 'F56FE204FC8C98D991FA7F7CF6E7ED1F79B5F871CCD9F5FA51FCD357801DEEB7'
  checksumType  = 'sha256'
