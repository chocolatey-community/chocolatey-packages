...
$version = '138.0.7166.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1456388/mini_installer.exe'
  checksum      = 'AF19A270DFF53AF0F2060B8E3E78847E580FD4D800EE7FA14D6305B273149AD4'
  checksumType  = 'sha256'
