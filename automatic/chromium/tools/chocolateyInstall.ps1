...
$version = '139.0.7226.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1470967/mini_installer.exe'
  checksum      = '90E39E9DC690FF1E02F3218369B3C4CEEFECDDB0D8662919D72F725C69F0B175'
  checksumType  = 'sha256'
