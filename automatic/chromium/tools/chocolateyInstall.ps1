...
$version = '133.0.6861.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1388121/mini_installer.exe'
  checksum      = 'C57769FA7282F1A1BC74AE093A5B84480DD3039E3B54ECA696A0177B0A1FA5EE'
  checksumType  = 'sha256'
