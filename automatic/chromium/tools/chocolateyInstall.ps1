...
$version = '153.0.7995.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1675164/mini_installer.exe'
  checksum      = 'E4E4539D0C9DFC82BAC6F4236E5371563233C71DB2ADA4568F86DFFFB20069E5'
  checksumType  = 'sha256'
