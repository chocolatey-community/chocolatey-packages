...
$version = '151.0.7918.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1653662/mini_installer.exe'
  checksum      = 'D1611CA90EE97EAD9FE088DBDAE54AE2BBDFF015DDCCE96E3A449B7EBEE884E4'
  checksumType  = 'sha256'
