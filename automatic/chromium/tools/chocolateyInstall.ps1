...
$version = '133.0.6856.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1387292/mini_installer.exe'
  checksum      = 'FBBB09E5215D17632B76B45D9FBF27C69715FD71517C3DD17FB1B6389ADA1798'
  checksumType  = 'sha256'
