...
$version = '153.0.7985.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1672277/mini_installer.exe'
  checksum      = '12531873604501793235701109175826B99BF25A11219FFE38765A226CA875E5'
  checksumType  = 'sha256'
