...
$version = '134.0.6969.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1408555/mini_installer.exe'
  checksum      = '6B4DC42BC9238FE2166220DF612FE2171D79B71E18ABF213FF4F3403278846A0'
  checksumType  = 'sha256'
