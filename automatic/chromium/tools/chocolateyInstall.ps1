...
$version = '144.0.7517.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1542104/mini_installer.exe'
  checksum      = '36B13AB58F7558BA836ABE42DDA880B7BE198B3F8B39FC0FDABD50B86326D7E7'
  checksumType  = 'sha256'
