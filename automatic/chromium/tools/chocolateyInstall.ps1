...
$version = '147.0.7698.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1587599/mini_installer.exe'
  checksum      = '24EF4C8F5DFE5FB7B97DD35694CD73129AE9990B960A77CE9C1A9C4D09C6CE06'
  checksumType  = 'sha256'
