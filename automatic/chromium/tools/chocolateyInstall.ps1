...
$version = '151.0.7897.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1647986/mini_installer.exe'
  checksum      = '0E4DF4C4A9C11854E81712BA9D25AA2751FC15856D584E42DA87C81E3B378991'
  checksumType  = 'sha256'
