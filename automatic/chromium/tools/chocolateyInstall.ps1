...
$version = '150.0.7834.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1627721/mini_installer.exe'
  checksum      = 'C050BC7EB195BBDF9839D3141396BE9130C6E86A6EC30068D39631D953767E6A'
  checksumType  = 'sha256'
