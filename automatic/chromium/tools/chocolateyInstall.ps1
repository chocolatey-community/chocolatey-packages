...
$version = '138.0.7154.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1454205/mini_installer.exe'
  checksum      = 'CF30509B9CBDBA4810CF9F49BBA99E96DEC7644A4AF00DCEAB8C0FCFC7E029A3'
  checksumType  = 'sha256'
