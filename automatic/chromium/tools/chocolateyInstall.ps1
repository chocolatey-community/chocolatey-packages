...
$version = '133.0.6858.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1387362/mini_installer.exe'
  checksum      = 'FCBB32AD00FD60418DF7556E6BC2AFD6594DE2C2EE5FE2B4D0D477FFEE0DE872'
  checksumType  = 'sha256'
