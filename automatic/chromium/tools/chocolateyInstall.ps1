...
$version = '135.0.7013.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1418838/mini_installer.exe'
  checksum      = '3D598207CFB5BCD3A0F6357FD109A4988DFFE393D7C849EEA2552B8EC45B34BF'
  checksumType  = 'sha256'
