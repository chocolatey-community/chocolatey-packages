...
$version = '140.0.7289.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1485009/mini_installer.exe'
  checksum      = 'CC66A8B4F650B2F5C4CC4157CD99FB0B5908640418C874928FEE0F1718BCB734'
  checksumType  = 'sha256'
