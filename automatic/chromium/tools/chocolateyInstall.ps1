...
$version = '152.0.7954.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1663072/mini_installer.exe'
  checksum      = 'F1D73A7C85DBAD871FE9C1A977D73DAAC315AA8335D53C69BC06C5415D09D59C'
  checksumType  = 'sha256'
