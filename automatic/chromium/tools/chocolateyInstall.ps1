...
$version = '145.0.7573.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1556605/mini_installer.exe'
  checksum      = '683753266068A81CFD2799A7C2867068A3D6F050C678306CC30800E4C06E8F92'
  checksumType  = 'sha256'
