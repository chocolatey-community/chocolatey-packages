...
$version = '141.0.7366.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1503143/mini_installer.exe'
  checksum      = '2D80E3EF1B8D2BDDA3D6761640B2F524F54111DDE3B5A21AD5662B2D54E2439C'
  checksumType  = 'sha256'
