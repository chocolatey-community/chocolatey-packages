...
$version = '154.0.8029.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1687723/mini_installer.exe'
  checksum      = '9CF66945B6E8362077DC0084E32EBDF57BF1C37F453C6BA3388BBA6A2F31197B'
  checksumType  = 'sha256'
