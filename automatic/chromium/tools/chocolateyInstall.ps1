...
$version = '142.0.7407.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1513802/mini_installer.exe'
  checksum      = 'C79C74C0921D4A3795960EF43A4B4F1CDBB8BE6AE29A230AC0D2A0201891214E'
  checksumType  = 'sha256'
