...
$version = '129.0.6622.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1333963/mini_installer.exe'
  checksum      = 'F954379720745E5BC02AEDCACFE020F340D5A6692C921D1652B5384E86AD2504'
  checksumType  = 'sha256'
