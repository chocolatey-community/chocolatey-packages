...
$version = '129.0.6614.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1331527/mini_installer.exe'
  checksum      = 'DB93D1840304B06CCAB72F904D6D029F14EF00B89C6F8A6170BC696BAC75F605'
  checksumType  = 'sha256'
