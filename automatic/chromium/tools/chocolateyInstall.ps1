...
$version = '151.0.7921.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1653940/mini_installer.exe'
  checksum      = 'C47200C6D898DA102B70BC1735C240108FD05CD17C600B3993697C1B558E42CA'
  checksumType  = 'sha256'
