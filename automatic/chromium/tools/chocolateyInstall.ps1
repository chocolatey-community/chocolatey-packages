...
$version = '146.0.7635.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1569124/mini_installer.exe'
  checksum      = 'FD9875DB59E82FEDD14FD2A31708FC5509A448A080172988A40F6453523EA6B7'
  checksumType  = 'sha256'
