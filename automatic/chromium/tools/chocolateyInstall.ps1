...
$version = '133.0.6839.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1383498/mini_installer.exe'
  checksum      = 'CB87C80D8C606FB70B6CC07C1543D1093A47736C8781704AA049A6B12F61FDCA'
  checksumType  = 'sha256'
