...
$version = '153.0.7993.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1673889/mini_installer.exe'
  checksum      = 'ECB4DC6D83B693E2810273AC5A743805D3945704255B010FE37EF43CEAD8D398'
  checksumType  = 'sha256'
