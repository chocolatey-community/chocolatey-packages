...
$version = '133.0.6864.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1388834/mini_installer.exe'
  checksum      = '3E11E591F94F6C2452A53C2FB5ADFC58BE032B9388EC96DC89FB452B7113D2D9'
  checksumType  = 'sha256'
