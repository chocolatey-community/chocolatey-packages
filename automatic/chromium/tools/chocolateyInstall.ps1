...
$version = '153.0.7997.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1675677/mini_installer.exe'
  checksum      = '95068008EB5E687F3F5A2FF6C286404CEDEE04C0DAA4106518EC0D5E91327870'
  checksumType  = 'sha256'
