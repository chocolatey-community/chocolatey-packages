...
$version = '133.0.6869.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1389971/mini_installer.exe'
  checksum      = '6BF7C356F09379045C1DBA04747D71C3F48A1CC0411C70BB34E206A4E343A1A1'
  checksumType  = 'sha256'
