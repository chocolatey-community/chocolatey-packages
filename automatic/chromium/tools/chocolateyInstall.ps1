...
$version = '134.0.6973.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1409537/mini_installer.exe'
  checksum      = 'CFB98C8F23143ED1017F77FB0E3F70665F133673B0270387C5DA3281B63BC79F'
  checksumType  = 'sha256'
