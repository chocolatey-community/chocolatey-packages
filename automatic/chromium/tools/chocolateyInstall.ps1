...
$version = '150.0.7845.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1632026/mini_installer.exe'
  checksum      = 'FED174EE72CD31F0A2FFD6D31B2E6F4A734D86B99376E98BAF7A90761218C8BF'
  checksumType  = 'sha256'
