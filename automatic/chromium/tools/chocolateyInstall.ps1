...
$version = '145.0.7607.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1563049/mini_installer.exe'
  checksum      = 'BC0EBE429AC31F00D9A7791FEFEA7C2DED33CC643864C995D8138A1A1843FE01'
  checksumType  = 'sha256'
