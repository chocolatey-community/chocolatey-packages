...
$version = '145.0.7624.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1566528/mini_installer.exe'
  checksum      = '1E1C458719FB8CB431ABB7C3C7C99FA8C7510B4746CB2700F6F6D18AD0717390'
  checksumType  = 'sha256'
