...
$version = '143.0.7460.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1526668/mini_installer.exe'
  checksum      = '7E5453FFF86F3802736A318E7DA55A03AC8DB439CC83FA11509B3C4F1B0C320C'
  checksumType  = 'sha256'
