...
$version = '132.0.6822.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1378585/mini_installer.exe'
  checksum      = '345D9DFA5276934F1785685C44919B573CF84886C16CBF4BC756D507AB414BB0'
  checksumType  = 'sha256'
