...
$version = '152.0.7949.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1661136/mini_installer.exe'
  checksum      = '5C95D0122D4004D2181041BA7C420F720E00DE5C97ECBDDF9E0EEBED05757368'
  checksumType  = 'sha256'
