...
$version = '143.0.7490.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1534148/mini_installer.exe'
  checksum      = '9DB66DEEE536312D9135E57A594D69100413BE41D11502EBEB4020B4C224FFA5'
  checksumType  = 'sha256'
