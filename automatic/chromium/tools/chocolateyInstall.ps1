...
$version = '140.0.7271.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1480584/mini_installer.exe'
  checksum      = '717FFA4801697118DBCF3A04EAE621F56703C32ABDC43D5361752A9F48DC4E5A'
  checksumType  = 'sha256'
