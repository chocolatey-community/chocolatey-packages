...
$version = '141.0.7361.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1502360/mini_installer.exe'
  checksum      = '5DFC7487D4547552BE1A472BA49063321248383D1039F98CE7B84BDD50B18FC9'
  checksumType  = 'sha256'
