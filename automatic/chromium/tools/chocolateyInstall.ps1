...
$version = '135.0.7044.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1426684/mini_installer.exe'
  checksum      = 'B229E7FB6BE3F842AF2CFFD39861291AD8C61ED132A0CD0641F5F23E3BC50EB2'
  checksumType  = 'sha256'
