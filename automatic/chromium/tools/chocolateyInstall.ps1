...
$version = '136.0.7055.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1429310/mini_installer.exe'
  checksum      = 'EDBD328FE59A82ED6F10F055F6B0D8A3D6B4A91611BA661DD197A789B00DEF19'
  checksumType  = 'sha256'
