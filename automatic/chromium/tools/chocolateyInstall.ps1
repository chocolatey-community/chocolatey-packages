...
$version = '138.0.7198.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1464824/mini_installer.exe'
  checksum      = '5D60321A6D9E4DB9745C63ABD38E8E0BABA9298FCFE4CF934560B47ECB468239'
  checksumType  = 'sha256'
