...
$version = '130.0.6677.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1346396/mini_installer.exe'
  checksum      = 'CDACC3E95F3393C51D959B63E6BF5B3A42BD4C8A9F374776593FBC72459CEEEE'
  checksumType  = 'sha256'
