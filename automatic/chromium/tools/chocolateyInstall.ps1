...
$version = '132.0.6786.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1370977/mini_installer.exe'
  checksum      = 'B06FE0C24B4AE28FB7D3B5ACE2CFA184FFF23B5C962D38A31598C63F5FD4C03E'
  checksumType  = 'sha256'
