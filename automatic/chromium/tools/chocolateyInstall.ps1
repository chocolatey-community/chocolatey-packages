...
$version = '128.0.6554.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1318303/mini_installer.exe'
  checksum      = 'B8003C119A5A96A3A59539B6E9062A2B2A58F78CFD5B0FA287D94768EB908E56'
  checksumType  = 'sha256'
