...
$version = '128.0.6551.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1318136/mini_installer.exe'
  checksum      = 'CE1DBD49F72BECE8172F15906464BF8B7DBF6648A9E19D324066B8E65449B529'
  checksumType  = 'sha256'
