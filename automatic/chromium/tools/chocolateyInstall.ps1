...
$version = '135.0.7035.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1424118/mini_installer.exe'
  checksum      = '493F9C39D2577883BB68F8CCDD89A0D8446A9FD69FEAE5D15C33320C02883270'
  checksumType  = 'sha256'
