...
$version = '147.0.7693.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1585549/mini_installer.exe'
  checksum      = '4B82A900FCC1AFD6F3253F5004AD313888F38D8471C526A2927051B4310AAACE'
  checksumType  = 'sha256'
