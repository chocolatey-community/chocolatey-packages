...
$version = '137.0.7118.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1444604/mini_installer.exe'
  checksum      = '60E3B099AC217585413719B69760D34083E4D78E3CE549E672A0B1C424AA0CBD'
  checksumType  = 'sha256'
