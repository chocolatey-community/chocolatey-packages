...
$version = '127.0.6487.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1302958/mini_installer.exe'
  checksum      = 'F3A90C486E6CB2E31D10B2E829A6F29810CCCE685B81EF62362765FC9EE3FF39'
  checksumType  = 'sha256'
