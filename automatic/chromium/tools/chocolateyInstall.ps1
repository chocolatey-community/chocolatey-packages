...
$version = '132.0.6820.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1378012/mini_installer.exe'
  checksum      = '784E550F139A95F9C44C93D5EFB692D9C7C191B82E0989FB085CEF5435866EC4'
  checksumType  = 'sha256'
