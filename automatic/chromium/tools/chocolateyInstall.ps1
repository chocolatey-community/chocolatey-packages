...
$version = '145.0.7602.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1562789/mini_installer.exe'
  checksum      = '45C918A9B60C9DF43FD6B957EE297BFA73D1BBB74B1270D415131710EF362442'
  checksumType  = 'sha256'
