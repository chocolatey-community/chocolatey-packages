...
$version = '138.0.7152.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1453129/mini_installer.exe'
  checksum      = 'E6A9387E81C767C0B9E59F36F1A5E80EBDCB8219085AFA0321A1F3CADA1879B7'
  checksumType  = 'sha256'
