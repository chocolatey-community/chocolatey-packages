...
$version = '133.0.6916.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1399973/mini_installer.exe'
  checksum      = '716AE1DC358BB782C9642DCBE5A6739C64EBB0F719E5EF120B7EA9E134099375'
  checksumType  = 'sha256'
