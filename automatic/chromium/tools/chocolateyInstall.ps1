...
$version = '141.0.7368.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1503728/mini_installer.exe'
  checksum      = '56F08E7481B65824DD61E513109576F11CE14D8FB621E64368659C87C085B0C0'
  checksumType  = 'sha256'
