...
$version = '143.0.7487.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1532936/mini_installer.exe'
  checksum      = '74BDA6B2A6251BE61D7E0EEB31E277A97BB449FDDA6CDA828231C02534A413DC'
  checksumType  = 'sha256'
