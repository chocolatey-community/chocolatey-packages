...
$version = '133.0.6855.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1387215/mini_installer.exe'
  checksum      = 'E585B88DF91DB1D1941E0886D73B6DB0F143011952D774702FD15793DE97B1A9'
  checksumType  = 'sha256'
