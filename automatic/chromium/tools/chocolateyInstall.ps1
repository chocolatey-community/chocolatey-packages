...
$version = '143.0.7468.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1528623/mini_installer.exe'
  checksum      = '6773B6C69355375A3CD600FF8D3DCD154756E10B9E946A2384944B73CBB9EEB1'
  checksumType  = 'sha256'
