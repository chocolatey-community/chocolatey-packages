...
$version = '144.0.7500.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1536431/mini_installer.exe'
  checksum      = '4A32EA290E04196B14810AEF6B7A45C492F86C6C07EE327796BA0E6008FFB189'
  checksumType  = 'sha256'
