...
$version = '146.0.7676.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1581374/mini_installer.exe'
  checksum      = 'FEE2861C792AF56741880F03386C11C35B51DBF1E3F9C938646A9BBB3C3F8712'
  checksumType  = 'sha256'
