...
$version = '145.0.7569.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1555311/mini_installer.exe'
  checksum      = '7A73D59772D0646C8CE919A3F4E4F1CA3FFE20F396271D55BA6206A11EAE4029'
  checksumType  = 'sha256'
