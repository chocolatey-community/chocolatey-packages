...
$version = '133.0.6846.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1384534/mini_installer.exe'
  checksum      = 'BCABB24AD8037B8DA8D7508711CFCD7B57D5C0433C5F740DEAD6B44922B9E6D5'
  checksumType  = 'sha256'
