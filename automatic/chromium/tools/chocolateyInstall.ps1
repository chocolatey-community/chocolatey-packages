...
$version = '140.0.7300.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1487383/mini_installer.exe'
  checksum      = 'F8D9EEB9DF4F277E187723AB4091850E8C7BE86F417AD83B6E0B340F1C0A88C1'
  checksumType  = 'sha256'
