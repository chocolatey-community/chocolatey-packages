...
$version = '138.0.7182.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1460738/mini_installer.exe'
  checksum      = '1EE3BF231F9DDB72E695A036499F97C1BE8A1EC0B90AF5620E37EC4EDC73F3BF'
  checksumType  = 'sha256'
