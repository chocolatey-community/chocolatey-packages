...
$version = '154.0.8013.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1682456/mini_installer.exe'
  checksum      = '220ACFA523635DE8B95B586089510E8945E6F0029EDB07DDBE82C5F17BB46FAA'
  checksumType  = 'sha256'
