...
$version = '143.0.7485.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1532506/mini_installer.exe'
  checksum      = '0E61FEE3D6EF5EC8FB2E102AB80948EB713AF05BB27FC6CAA474202C6FF1F738'
  checksumType  = 'sha256'
