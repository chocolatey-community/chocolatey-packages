...
$version = '135.0.7009.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1417918/mini_installer.exe'
  checksum      = '8B0ADA177C3AD077D0CADA46D319E30C640BE3A7D00AC604836BFA9487BA974B'
  checksumType  = 'sha256'
