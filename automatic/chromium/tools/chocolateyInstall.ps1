...
$version = '141.0.7359.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1502093/mini_installer.exe'
  checksum      = 'C25F62D01C5EB457770362AA0CD419974CA254AA11FCC3086F0751FD906CBA39'
  checksumType  = 'sha256'
