...
$version = '139.0.7223.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1470456/mini_installer.exe'
  checksum      = 'A8BF86F232A43B1D2A285AD7B685CEFEF108FF8E2D9851152737EE45EB79570E'
  checksumType  = 'sha256'
