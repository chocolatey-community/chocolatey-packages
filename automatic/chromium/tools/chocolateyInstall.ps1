...
$version = '152.0.7975.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1668361/mini_installer.exe'
  checksum      = '21896B6077C341D9C01E9D64C5AC4851478D0D24A8D6BE1EC0F339A434C11BB6'
  checksumType  = 'sha256'
