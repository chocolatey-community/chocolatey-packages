...
$version = '147.0.7700.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1588244/mini_installer.exe'
  checksum      = 'C1CD633E7590ACD607AB8E90169B364726A8BEE413518A2FAB32F7D6917EB14B'
  checksumType  = 'sha256'
