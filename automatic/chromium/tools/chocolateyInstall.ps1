...
$version = '133.0.6925.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1400689/mini_installer.exe'
  checksum      = 'FD45EE0F9F5498549092EE69E803C08F2B84A3EBD58AFA4EB737141E6C230937'
  checksumType  = 'sha256'
