...
$version = '145.0.7560.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1552553/mini_installer.exe'
  checksum      = '028CCD0F13F77504C141B2790B7BE85291FCC8CC75A1A5FC5DEF8DFEDAB32EBB'
  checksumType  = 'sha256'
