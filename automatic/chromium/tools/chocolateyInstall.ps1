...
$version = '146.0.7673.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1580672/mini_installer.exe'
  checksum      = 'DF964DA1B3484368E785303178272BCBA5C6F902DD6E28CE732221184B724C25'
  checksumType  = 'sha256'
