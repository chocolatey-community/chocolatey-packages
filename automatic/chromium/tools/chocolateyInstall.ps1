...
$version = '128.0.6544.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1316315/mini_installer.exe'
  checksum      = '11C7AF31DA94DC99B382DAFD8696452CC865C303ED45B2759E7F619663A57C6A'
  checksumType  = 'sha256'
