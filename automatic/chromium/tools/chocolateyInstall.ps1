...
$version = '132.0.6800.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1374275/mini_installer.exe'
  checksum      = '9097277E6416632219C8A498BBF172BFE83D36ABEEB33F2F09F34F265F720EB2'
  checksumType  = 'sha256'
