...
$version = '139.0.7230.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1471422/mini_installer.exe'
  checksum      = '639E55216659C4F6EF13DDFC5F4DC73B76699916DC92F7CEA471B25A33C493F8'
  checksumType  = 'sha256'
