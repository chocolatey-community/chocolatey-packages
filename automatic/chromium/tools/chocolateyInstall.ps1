...
$version = '140.0.7321.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1492465/mini_installer.exe'
  checksum      = '8AB1F7ADC3A58EDB07440F7877C4BEE9A2B9138E6A463F94DE6CC76BC242220D'
  checksumType  = 'sha256'
