...
$version = '126.0.6466.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1297478/mini_installer.exe'
  checksum      = 'E0DFACF1979C60B333049D0F515BB267A020289D3B479ECA3C2C026BD469F16D'
  checksumType  = 'sha256'
