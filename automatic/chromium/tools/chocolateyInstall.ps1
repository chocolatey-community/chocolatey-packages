...
$version = '146.0.7680.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1582024/mini_installer.exe'
  checksum      = '1F1F2A975CAA4D2F7C3417E06C31FFDDD056887F08BE936F75635C5C61D0A79E'
  checksumType  = 'sha256'
