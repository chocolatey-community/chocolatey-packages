...
$version = '148.0.7732.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1598453/mini_installer.exe'
  checksum      = 'F1155287A3053FB2C6DAC5C89FD248A3174DDF1CFD9F3AEA3471B4B8AB07F978'
  checksumType  = 'sha256'
