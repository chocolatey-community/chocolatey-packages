...
$version = '145.0.7620.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1564992/mini_installer.exe'
  checksum      = '9120B2469622FECAAE4A1B0A1315C4D619DD75175250DAE1428692EDC40469A7'
  checksumType  = 'sha256'
