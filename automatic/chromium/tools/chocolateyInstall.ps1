...
$version = '136.0.7060.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1430014/mini_installer.exe'
  checksum      = '4ECDA95184E5758B2107231F92C3305A9B6C3F97DA972D0C55CF7BB508066980'
  checksumType  = 'sha256'
