...
$version = '144.0.7529.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1545242/mini_installer.exe'
  checksum      = '7D255FFE571BA5684C87492408139CF5D3C215CDC1FF7AD68A43BF3B212CF1E0'
  checksumType  = 'sha256'
