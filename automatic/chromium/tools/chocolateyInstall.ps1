...
$version = '153.0.7999.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1676164/mini_installer.exe'
  checksum      = 'DF86A0BDA0BCA1C914C259751BBD6F78F9EC2E5633D4830492A9ECB4A9278506'
  checksumType  = 'sha256'
