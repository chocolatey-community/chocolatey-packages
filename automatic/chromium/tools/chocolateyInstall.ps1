...
$version = '128.0.6541.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1315554/mini_installer.exe'
  checksum      = '289A3EFECC8B9D2A27F3516B51F04321719CB47E7B1BF8F417AF2020D3888F10'
  checksumType  = 'sha256'
