...
$version = '132.0.6817.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1377401/mini_installer.exe'
  checksum      = '63C50EC40FC4F42473D90D1B2001995CCD92459BCC20DBFECEE3D63B6B4E4A95'
  checksumType  = 'sha256'
