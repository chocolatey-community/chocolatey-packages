...
$version = '144.0.7502.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1537342/mini_installer.exe'
  checksum      = '46CE99F7A3123836D94846C806A0C94E5D1206BC4BF644D996DDBDA3903BB301'
  checksumType  = 'sha256'
