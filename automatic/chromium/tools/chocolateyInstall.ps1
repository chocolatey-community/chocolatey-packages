...
$version = '131.0.6774.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1367969/mini_installer.exe'
  checksum      = '3B85840388C83F12AB6973EDF8FABF7368D0FC20026BE6A0C2F76B566D7CB8FA'
  checksumType  = 'sha256'
