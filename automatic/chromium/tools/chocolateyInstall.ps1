...
$version = '137.0.7147.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1452224/mini_installer.exe'
  checksum      = 'DEE077327CA3F1F42BD7B6658495C7206C86F947EE6AB0746EFBF2119648B72D'
  checksumType  = 'sha256'
