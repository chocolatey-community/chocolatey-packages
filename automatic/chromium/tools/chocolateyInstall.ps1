...
$version = '126.0.6474.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1299731/mini_installer.exe'
  checksum      = '7FC54B0A4D47010B46093E4D58CE138716C23BBAF9C8C82DB0D39EF1703E7009'
  checksumType  = 'sha256'
