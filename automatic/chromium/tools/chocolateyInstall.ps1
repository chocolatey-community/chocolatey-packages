...
$version = '136.0.7052.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1428548/mini_installer.exe'
  checksum      = '47DE9ED202D60E7D12FD1F2A47B62A93BB67DCA1119C6E2F1E68F358575DBEEC'
  checksumType  = 'sha256'
