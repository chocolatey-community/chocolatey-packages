...
$version = '144.0.7506.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1538648/mini_installer.exe'
  checksum      = '986AF5D2185DF878DD09B9BE5633C7B2BD1D49170064EF04EF86C179C0F58411'
  checksumType  = 'sha256'
