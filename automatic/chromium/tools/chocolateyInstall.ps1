...
$version = '146.0.7659.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1576808/mini_installer.exe'
  checksum      = 'E1971017D1B15EE469C4B7CC13E0751C459871B53C042E1E106D6C3483224306'
  checksumType  = 'sha256'
