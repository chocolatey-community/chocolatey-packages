...
$version = '142.0.7438.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1521493/mini_installer.exe'
  checksum      = 'B8CFA617F7B6B26573BE199548DB11E0716A00793FE92552563C105CC81EAE7E'
  checksumType  = 'sha256'
