...
$version = '129.0.6666.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1343298/mini_installer.exe'
  checksum      = 'E94FE4B7B786606BE7DA344788FFAB9C3285FC3D7249D0CA212B0F112CEFE066'
  checksumType  = 'sha256'
