...
$version = '138.0.7162.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1455461/mini_installer.exe'
  checksum      = 'DCEAED1504EC0D051AA336A9478C5116AFA906777F84E6DF0F734188C566BE13'
  checksumType  = 'sha256'
