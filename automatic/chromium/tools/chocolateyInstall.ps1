...
$version = '143.0.7477.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1530911/mini_installer.exe'
  checksum      = '0E94425FBCEFB686D0B594C809D57FD12080F09B0A23E05EC70F40A2952F2837'
  checksumType  = 'sha256'
