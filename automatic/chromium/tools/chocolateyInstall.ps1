...
$version = '130.0.6675.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1346190/mini_installer.exe'
  checksum      = 'B960328B104B0A869D97319480209F022E5FA6212DC5BECE2D8D98E5E1D6AFAA'
  checksumType  = 'sha256'
