...
$version = '152.0.7927.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1656206/mini_installer.exe'
  checksum      = '83628CEB141DBD60F40E7853D71FE071B70384EF6977863CF37482FBDD1A1529'
  checksumType  = 'sha256'
