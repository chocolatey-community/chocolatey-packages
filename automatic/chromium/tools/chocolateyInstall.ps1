...
$version = '145.0.7592.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1561658/mini_installer.exe'
  checksum      = '82ADD7BEB179E19EC03E64531C41B1E6197F664C10CE5B8B4323406365EDE240'
  checksumType  = 'sha256'
