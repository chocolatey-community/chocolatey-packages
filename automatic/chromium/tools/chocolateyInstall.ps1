...
$version = '144.0.7544.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1549021/mini_installer.exe'
  checksum      = '6A7CD56999BE4B4890F3C179F999ECEF8590690DE3FB2257A8C1A75368CA5D99'
  checksumType  = 'sha256'
