...
$version = '146.0.7633.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1568274/mini_installer.exe'
  checksum      = 'A27AB9F822CEB90C200B42115780DFFA18CB6B2552BD013A003321C29B26A0F1'
  checksumType  = 'sha256'
