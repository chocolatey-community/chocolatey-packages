...
$version = '141.0.7363.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1502464/mini_installer.exe'
  checksum      = 'DBECF4E45F6A196D682B8B1CE458198035FF93E955B092736523E1BE3F43CF4D'
  checksumType  = 'sha256'
