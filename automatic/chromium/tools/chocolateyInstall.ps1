...
$version = '133.0.6915.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1399903/mini_installer.exe'
  checksum      = 'EA340CD78B82CE8B8B7A2645EF3FC363EB51DF4654D893017B98A75633B03B8D'
  checksumType  = 'sha256'
