...
$version = '137.0.7141.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1450183/mini_installer.exe'
  checksum      = '99C49209AD88BBAD5AE36F65CA1B6EAE137E07F203542F67D0EB78CE2347F694'
  checksumType  = 'sha256'
