...
$version = '131.0.6736.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1359033/mini_installer.exe'
  checksum      = '3639F1C2CA0416B2E75C98ABBEE6A47B24D000929A7A20E083CBB712FE6E6025'
  checksumType  = 'sha256'
