...
$version = '151.0.7912.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1651772/mini_installer.exe'
  checksum      = '29CF50FC593E6FB30DC6FB96F825433E8B70F7FE201F5EBE6B488D629EC7BE5F'
  checksumType  = 'sha256'
