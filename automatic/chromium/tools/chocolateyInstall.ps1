...
$version = '151.0.7873.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1640822/mini_installer.exe'
  checksum      = '0B494EA196BABCF1F5D8805F0AA1EB772CDA0C527C52EEE122CC5CD500F0CF15'
  checksumType  = 'sha256'
