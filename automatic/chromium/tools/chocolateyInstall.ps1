...
$version = '127.0.6530.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1312520/mini_installer.exe'
  checksum      = 'A85807635E2BE10747E966D5E5716C940B2296F19A25DEDF809795C2CF947B55'
  checksumType  = 'sha256'
