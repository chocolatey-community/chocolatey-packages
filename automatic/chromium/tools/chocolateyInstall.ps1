...
$version = '146.0.7651.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1573294/mini_installer.exe'
  checksum      = '9F7DE0B68FCD381D2F6DB493B5C2423E55A06E671BE34A1D12C5629DB97636D0'
  checksumType  = 'sha256'
