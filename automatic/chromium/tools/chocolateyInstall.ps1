...
$version = '143.0.7465.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1528351/mini_installer.exe'
  checksum      = '97F4B9FB0B55D6FC1D99B38CA012368E932F51A050EFA6A6C9AB1DCFB541D8F4'
  checksumType  = 'sha256'
