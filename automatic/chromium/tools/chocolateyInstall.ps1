...
$version = '145.0.7629.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1567505/mini_installer.exe'
  checksum      = '9D6229013E872FEAF16DC7E04538487E26707FD1889C230AB4C6D4D16561D8BB'
  checksumType  = 'sha256'
