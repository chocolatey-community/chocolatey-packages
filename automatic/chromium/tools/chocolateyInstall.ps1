...
$version = '127.0.6531.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1312564/mini_installer.exe'
  checksum      = '6ABD7DE41621D85CBDED175188719BDB1E440DE5B7A044B6A343AB17209DD113'
  checksumType  = 'sha256'
