...
$version = '127.0.6502.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1306120/mini_installer.exe'
  checksum      = '67C4D5E7E6F276565DEF0CC3281B2AB0930908EA8C33F3B266922B2CC7B743B7'
  checksumType  = 'sha256'
