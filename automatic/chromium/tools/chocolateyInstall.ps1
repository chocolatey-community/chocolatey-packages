...
$version = '137.0.7117.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1444440/mini_installer.exe'
  checksum      = '9FEAE185B584F6FFE41CD1F6F3C271DF4E705E5BD33057DEBCB2D6078761FCB8'
  checksumType  = 'sha256'
