...
$version = '135.0.7037.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1424772/mini_installer.exe'
  checksum      = '928AD1D8A6E5901AA27D368442C356ED9D7A04980283E9E1039FFF03EFFAE945'
  checksumType  = 'sha256'
