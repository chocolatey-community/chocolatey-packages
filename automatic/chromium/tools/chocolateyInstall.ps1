...
$version = '152.0.7934.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1656912/mini_installer.exe'
  checksum      = 'E690C102A50905A13F802D10E40C62233BACBF8BBFCE1948068977FA3DF5A7B6'
  checksumType  = 'sha256'
