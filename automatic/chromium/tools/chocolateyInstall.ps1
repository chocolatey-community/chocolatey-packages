...
$version = '141.0.7384.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1508618/mini_installer.exe'
  checksum      = '92DD693AE5F02C3136B0AC7748F705BD4D3FAC782DD826CC12E0906FC60C9E53'
  checksumType  = 'sha256'
