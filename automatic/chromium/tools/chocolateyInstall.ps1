...
$version = '140.0.7285.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1483845/mini_installer.exe'
  checksum      = '4F5F5E94B92CF98D71922DD9A9218505AD9EEFFEB5B2383E663C248EFC6F7EBA'
  checksumType  = 'sha256'
