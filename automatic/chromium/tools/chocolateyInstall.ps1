...
$version = '146.0.7655.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1575494/mini_installer.exe'
  checksum      = 'F2ADC56796459BC16A5FF2D8858C45BADC7BF4206627D2BE33053ABA3B1D9473'
  checksumType  = 'sha256'
