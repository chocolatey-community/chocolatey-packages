...
$version = '133.0.6868.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1389913/mini_installer.exe'
  checksum      = '0ACBBC3B911D2CD31022E0FB003CBD9558F7A1103575DB650722014E77A973E7'
  checksumType  = 'sha256'
