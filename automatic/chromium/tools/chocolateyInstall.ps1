...
$version = '128.0.6549.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1317606/mini_installer.exe'
  checksum      = 'A77BD23D55002F41AF141080A4E79780E0482187646A39EA6E0F1F0FB09F0F0F'
  checksumType  = 'sha256'
