...
$version = '147.0.7687.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1584651/mini_installer.exe'
  checksum      = '9CD9EF4FE97CB796CA4ADF1146356C0C243E1F651E65F6D6FFCC1353E78A993F'
  checksumType  = 'sha256'
