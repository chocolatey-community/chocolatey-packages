...
$version = '141.0.7343.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1498013/mini_installer.exe'
  checksum      = 'BB90F11A13B95C45112F7FBB7DD38A9026D1B416FA059B509390330F22695FA2'
  checksumType  = 'sha256'
