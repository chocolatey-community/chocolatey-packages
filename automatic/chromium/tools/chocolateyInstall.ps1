...
$version = '145.0.7610.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1563473/mini_installer.exe'
  checksum      = '2604E33794F40CC1C113D0A7A5B37B58BFDD00333A8CAB76D82B1585737576EF'
  checksumType  = 'sha256'
