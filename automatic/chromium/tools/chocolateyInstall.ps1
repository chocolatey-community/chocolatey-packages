...
$version = '138.0.7164.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1455703/mini_installer.exe'
  checksum      = '3EB979857E1A0281BE056E747EEB304F43E628FE0A7C45ABF9F0D38CAA5CAEC5'
  checksumType  = 'sha256'
