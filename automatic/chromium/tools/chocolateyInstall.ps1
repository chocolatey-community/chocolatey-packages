...
$version = '136.0.7091.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1437535/mini_installer.exe'
  checksum      = 'A5B72186B5A9946C854CC4EB39EB752473428A83A28FCB07D4424AF168158DEB'
  checksumType  = 'sha256'
