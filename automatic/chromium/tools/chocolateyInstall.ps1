...
$version = '144.0.7534.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1547054/mini_installer.exe'
  checksum      = 'E7B53BF696517EF2C83BFD56F1955285B065174B3B78683084CE4044757A4935'
  checksumType  = 'sha256'
