...
$version = '151.0.7878.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1642768/mini_installer.exe'
  checksum      = '83A8FBCF1C52286480D8F3A235924B3089F3B575DCC2AA7E84B1C11AFC79F14F'
  checksumType  = 'sha256'
