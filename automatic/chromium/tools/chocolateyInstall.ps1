...
$version = '131.0.6761.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1364688/mini_installer.exe'
  checksum      = 'E5E587A15031970DC4C9D81E646A604076078128CC2F6C2C32F4896CBFF7C994'
  checksumType  = 'sha256'
