...
$version = '138.0.7173.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1458448/mini_installer.exe'
  checksum      = 'C344724FA61BC5BD1EA35D0FE0592FBDAB6DA42C475797A439038F19350D6683'
  checksumType  = 'sha256'
