...
$version = '131.0.6772.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1367575/mini_installer.exe'
  checksum      = 'EBA354E42730B619DD2A4AA66DAE3FA4351F15EFB074E77DAE47AEE045DF6A1A'
  checksumType  = 'sha256'
