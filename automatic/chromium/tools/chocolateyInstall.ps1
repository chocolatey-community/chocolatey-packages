...
$version = '129.0.6667.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1343334/mini_installer.exe'
  checksum      = 'F1AA99A936C188BB81097A8B71FBFA12E7872E1B1691D2223692DFABD31780DC'
  checksumType  = 'sha256'
