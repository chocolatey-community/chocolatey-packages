...
$version = '141.0.7355.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1500608/mini_installer.exe'
  checksum      = '1BA9F747BE4280CE99BE50B2A7801C297C06EECC9C38D26A2DB5388FAFAB3BD8'
  checksumType  = 'sha256'
