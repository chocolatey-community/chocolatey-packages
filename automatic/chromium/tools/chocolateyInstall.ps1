...
$version = '133.0.6943.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1402638/mini_installer.exe'
  checksum      = '608F50C0970528024FE0E0A80D0AAB0C4A10D54D820BB1C0B036CD2ADA62AA9F'
  checksumType  = 'sha256'
