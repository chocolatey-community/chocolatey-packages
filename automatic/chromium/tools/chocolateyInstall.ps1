...
$version = '146.0.7640.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1570766/mini_installer.exe'
  checksum      = '2C7CEBEFC76C0A26ABEACB28EC6BDEE758453700A2E9045CD32AC8A79F49CF5D'
  checksumType  = 'sha256'
