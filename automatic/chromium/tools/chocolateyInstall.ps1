...
$version = '137.0.7133.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1448866/mini_installer.exe'
  checksum      = '29E31EDF078C810FCA85CA34215BCBDFB108A0F9F3FF782F5473966810C453E5'
  checksumType  = 'sha256'
