...
$version = '150.0.7857.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1635547/mini_installer.exe'
  checksum      = '77744E568C3214FBF752AE00B2BEDD3CFEF383D5336FD0CCCCBE38EA367B43D1'
  checksumType  = 'sha256'
