...
$version = '127.0.6496.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1304671/mini_installer.exe'
  checksum      = 'A7C2F7A4C127E1035D4D842914E52739DBD40DEC2DE47DD34692338E184C831B'
  checksumType  = 'sha256'
