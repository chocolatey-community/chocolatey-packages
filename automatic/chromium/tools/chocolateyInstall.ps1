...
$version = '141.0.7365.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1502769/mini_installer.exe'
  checksum      = 'A8B5289D97DA1E05067FA319F463027C3E2B0CF97FAF903041C372FB6708E573'
  checksumType  = 'sha256'
