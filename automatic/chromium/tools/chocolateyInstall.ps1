...
$version = '146.0.7645.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1571311/mini_installer.exe'
  checksum      = 'F7646294C59E77C53FCDD4D78A5E663D67A50198D59EC07E5F3B661AEE499B26'
  checksumType  = 'sha256'
