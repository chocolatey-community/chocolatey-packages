...
$version = '153.0.7994.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1674833/mini_installer.exe'
  checksum      = 'A4348D99190B2256C65C9D2970AD23A65BE6B4E1C6BB4841E028B447B90F4772'
  checksumType  = 'sha256'
