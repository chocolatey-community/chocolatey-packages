...
$version = '151.0.7887.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1644672/mini_installer.exe'
  checksum      = 'F4883795FBC12BB7297761C9C1D8F237249063D69BBE4BA34AF83B9BA33E9D13'
  checksumType  = 'sha256'
