...
$version = '135.0.7036.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1424394/mini_installer.exe'
  checksum      = '877E5EE0A59038815559B7BFA730F7A3391B20350E7C896ED34B037E2B05D303'
  checksumType  = 'sha256'
