...
$version = '141.0.7383.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1508176/mini_installer.exe'
  checksum      = '3127165B926543A78ED16389749BA0DECAEACA63EA935C8DA21C5FDA975A4382'
  checksumType  = 'sha256'
