...
$version = '132.0.6787.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1371032/mini_installer.exe'
  checksum      = '9E7C22FA3108D75440DB60672909DB37D9343662BC6C5D501A299BCABBCC491A'
  checksumType  = 'sha256'
