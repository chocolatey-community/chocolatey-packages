...
$version = '140.0.7292.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1485909/mini_installer.exe'
  checksum      = '311A24A84B5BAD97C3036F129B7A467F24D6F9AA67722A517499A472070F5A26'
  checksumType  = 'sha256'
