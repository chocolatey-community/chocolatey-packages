...
$version = '130.0.6697.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1350413/mini_installer.exe'
  checksum      = '739C3F6B4F965B64AA2C2AFE44BA4143AD850B10A40812DC826CE2BA26AC13CD'
  checksumType  = 'sha256'
