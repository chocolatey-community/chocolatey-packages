...
$version = '152.0.7962.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1664554/mini_installer.exe'
  checksum      = 'E303D8204D9D21A5CF72253E88493F03FDF0A598E8A0839EFFCDB89348AEF1BC'
  checksumType  = 'sha256'
