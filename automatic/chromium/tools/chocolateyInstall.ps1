...
$version = '127.0.6497.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1304924/mini_installer.exe'
  checksum      = 'DC70A8EA9D4E86DAFAD155740B6A83311AFD7EB3B57AFB649FFBC7BC9D461082'
  checksumType  = 'sha256'
