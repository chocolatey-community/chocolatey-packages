...
$version = '141.0.7357.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1501210/mini_installer.exe'
  checksum      = '9B574C6BB915486D4CA4000DCD25EB010B4D343BF6616E45C9E331AD2A234501'
  checksumType  = 'sha256'
