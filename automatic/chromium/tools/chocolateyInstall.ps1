...
$version = '142.0.7418.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1515844/mini_installer.exe'
  checksum      = '3D657614DEA8230DD33EFCFD6F36BDA054EC496862D002DE057B102ACE4C62C1'
  checksumType  = 'sha256'
