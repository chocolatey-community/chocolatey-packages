...
$version = '134.0.6974.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1409943/mini_installer.exe'
  checksum      = '2C1C7C748D29E11DE49398913AA7A29B5044FB1D59C64EAC8E49223F5D6E4A9A'
  checksumType  = 'sha256'
