...
$version = '146.0.7679.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1581593/mini_installer.exe'
  checksum      = 'E5A37B486EABE45F1AEBCFAE8876F2984F966406D538F6DFE5A885B09D9B7969'
  checksumType  = 'sha256'
