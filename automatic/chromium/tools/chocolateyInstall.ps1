...
$version = '152.0.7960.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1664436/mini_installer.exe'
  checksum      = '93DF8461500FFA6262A6B13681548B6AA0E5014A137D2A261B2F39C06CE4058D'
  checksumType  = 'sha256'
