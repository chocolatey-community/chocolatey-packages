...
$version = '138.0.7157.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1454804/mini_installer.exe'
  checksum      = '61DA434F90638303B2AE1DD8BEE9916D6C69DD23E17B82458C383B857566B589'
  checksumType  = 'sha256'
