...
$version = '130.0.6692.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1349625/mini_installer.exe'
  checksum      = 'B3BE8616B977A4248C07032F9C2539826305682130FD61DABFA12FA52CCB3C73'
  checksumType  = 'sha256'
