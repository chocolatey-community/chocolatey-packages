...
$version = '153.0.8002.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1677081/mini_installer.exe'
  checksum      = '877E0B37A90CD8EF037F41027734E832C8D403F436CBBFA710609EC29B4EF963'
  checksumType  = 'sha256'
