...
$version = '141.0.7342.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1497644/mini_installer.exe'
  checksum      = '05C61EE66BBED0DBA7FA75B5031DDCDAF54AA4D0BBA6CE9230B17814E2C9C0CA'
  checksumType  = 'sha256'
