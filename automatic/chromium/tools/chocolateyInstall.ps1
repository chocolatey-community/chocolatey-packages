...
$version = '133.0.6913.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1399655/mini_installer.exe'
  checksum      = 'FB9A7F5572731A0CA1DF795F1698483171FD7D3E205DE4674FC53BCD89F65431'
  checksumType  = 'sha256'
