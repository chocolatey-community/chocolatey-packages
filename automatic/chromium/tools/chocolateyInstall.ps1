...
$version = '140.0.7261.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1478776/mini_installer.exe'
  checksum      = 'F39D899D89D4F9A4AF5C16675459273647E5C4B21EB4907D53E729847B114394'
  checksumType  = 'sha256'
