...
$version = '140.0.7283.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1483214/mini_installer.exe'
  checksum      = 'A09239F2ACE7E2D3A87167CB11A23D66D3A64AAECA90141FDC4E8AC7F683EDEB'
  checksumType  = 'sha256'
