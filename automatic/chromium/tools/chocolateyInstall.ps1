...
$version = '142.0.7416.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1515351/mini_installer.exe'
  checksum      = 'D215E6D1F800449C4F7813E17950FDD3029BE04452C6B57D5BBB5BE8D873A36F'
  checksumType  = 'sha256'
