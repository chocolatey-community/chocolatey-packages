...
$version = '140.0.7273.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1481132/mini_installer.exe'
  checksum      = '26216B72D253EDFE733060489E84A384403D45D78D35A458689F02541025C42C'
  checksumType  = 'sha256'
