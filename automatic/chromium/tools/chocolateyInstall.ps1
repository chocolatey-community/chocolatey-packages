...
$version = '140.0.7333.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1495779/mini_installer.exe'
  checksum      = '25B6A451D27E61AC94B6F72DE146AC9AC74E55EA8B28FFCD67162BAE1A818949'
  checksumType  = 'sha256'
