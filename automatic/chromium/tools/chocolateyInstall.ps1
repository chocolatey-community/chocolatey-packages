...
$version = '129.0.6649.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1340040/mini_installer.exe'
  checksum      = '2E6A99DC3B8CDC10CFC2AEC8C9A542FA506C4216B2A92412DAF7A8F4555FC5E3'
  checksumType  = 'sha256'
