...
$version = '139.0.7249.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1476000/mini_installer.exe'
  checksum      = '89860B177B12173A0995B54BBBA84E9389DEA40D98DA8E1861245809C00178FF'
  checksumType  = 'sha256'
