...
$version = '131.0.6773.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1367916/mini_installer.exe'
  checksum      = '918A8AF9176BC887C3D072B6BC52E7F25497B9A85C4231AC0F8238EE9AB2F0F4'
  checksumType  = 'sha256'
