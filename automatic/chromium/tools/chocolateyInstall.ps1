...
$version = '133.0.6896.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1396343/mini_installer.exe'
  checksum      = '1C63564A95CCF67A64F8CBA20ADD6C90E67191241DCAFA1ED2437EF6502718BF'
  checksumType  = 'sha256'
