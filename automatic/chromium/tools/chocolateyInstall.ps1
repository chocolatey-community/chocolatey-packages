...
$version = '140.0.7272.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1480863/mini_installer.exe'
  checksum      = '85FB0354186D6A714DF6FD8D426EB9C4C99F6F73B34D5CADC8B9A43492EE4CD6'
  checksumType  = 'sha256'
