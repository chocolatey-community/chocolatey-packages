...
$version = '150.0.7858.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1635624/mini_installer.exe'
  checksum      = '1D2BC075C668D7684984CF3926186B9B2F505E212B5E9FE33C73446363A4A1A5'
  checksumType  = 'sha256'
