...
$version = '141.0.7382.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1508074/mini_installer.exe'
  checksum      = 'E7E723399C9FF9E12AE4A6E9C27DAB03C0FB531B54C714FA91494CC41A623FE6'
  checksumType  = 'sha256'
