...
$version = '126.0.6469.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1298554/mini_installer.exe'
  checksum      = '28A2C1DB6581E33C7159AE01174D60241CBE371763ACF396904E7054F844DCBB'
  checksumType  = 'sha256'
