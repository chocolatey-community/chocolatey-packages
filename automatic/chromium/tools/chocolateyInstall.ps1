...
$version = '142.0.7410.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1514746/mini_installer.exe'
  checksum      = '823C498CF40D71A10A517415FDBF1811E0475B45D9EA3E6649029A3A35A91967'
  checksumType  = 'sha256'
