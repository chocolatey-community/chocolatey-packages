...
$version = '134.0.6998.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1415177/mini_installer.exe'
  checksum      = 'F4544AD620621A56FEB371762E41221838CD19897FBE1DD97FFE862DD3BBB571'
  checksumType  = 'sha256'
