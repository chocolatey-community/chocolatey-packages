...
$version = '138.0.7161.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1455437/mini_installer.exe'
  checksum      = '0AE999E6F8849C0C95D541BC247AEC607CE4FF742AB603893066F927245C9516'
  checksumType  = 'sha256'
