...
$version = '135.0.7022.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1421285/mini_installer.exe'
  checksum      = '4A2368354D9EB4DF6C89FFADF369D09F3F7F2CEC64BE17A83DC35417A3681EE9'
  checksumType  = 'sha256'
