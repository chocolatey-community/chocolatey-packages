...
$version = '128.0.6594.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1327140/mini_installer.exe'
  checksum      = '486B8A4D9867B8DA72D98980FA33F589B763C8DE101FBF86C85FBD9FAD3E0635'
  checksumType  = 'sha256'
