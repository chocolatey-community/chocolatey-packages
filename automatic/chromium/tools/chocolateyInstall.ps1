...
$version = '148.0.7729.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1597508/mini_installer.exe'
  checksum      = '1F2B545585FE25CF99F966697E37F8D5C3DA3D450BAD08F6AD32E8561ACA64B2'
  checksumType  = 'sha256'
