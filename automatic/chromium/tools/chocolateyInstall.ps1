...
$version = '140.0.7329.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1494122/mini_installer.exe'
  checksum      = 'C8A1F9A3062E7E2DB4BD78FC575A0784F41BB6D739A799451B8ADD4A99424478'
  checksumType  = 'sha256'
