...
$version = '140.0.7306.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1489143/mini_installer.exe'
  checksum      = '76B434A828C7AE48D829EBA9C37E3FE5817CFFF3C584F821B607FAC7B13FECC4'
  checksumType  = 'sha256'
