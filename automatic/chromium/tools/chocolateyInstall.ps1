...
$version = '150.0.7854.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1635392/mini_installer.exe'
  checksum      = '72D99FAC6567F1684B49F229A2D977297D947C4E9C7E4C9D5EEBD4D2CD9CAEF2'
  checksumType  = 'sha256'
