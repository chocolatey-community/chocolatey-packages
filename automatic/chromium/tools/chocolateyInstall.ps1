...
$version = '141.0.7364.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1502526/mini_installer.exe'
  checksum      = '0118C8771597AF59BAE6C4F982F0E20E81CBAB2EE358823CE7996F16DF591A39'
  checksumType  = 'sha256'
