...
$version = '140.0.7302.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1488084/mini_installer.exe'
  checksum      = 'AA4CB0728F4346CDF1A3DBEE77EB7190FBC74363BB36F4AE9C78EB05AEF92E45'
  checksumType  = 'sha256'
