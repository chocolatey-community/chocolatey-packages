...
$version = '141.0.7388.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1508930/mini_installer.exe'
  checksum      = '43EF983A6BEAB1FABA55B7FC8932E5B7EBD21CD0562D9196451F6C808B5D9CD6'
  checksumType  = 'sha256'
