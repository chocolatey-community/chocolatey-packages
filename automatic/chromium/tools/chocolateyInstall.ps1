...
$version = '146.0.7661.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1577528/mini_installer.exe'
  checksum      = '8FA69BEDBE4C5301B8E0DA615A30221A4F8C13F4E77A04E86549843352DFF830'
  checksumType  = 'sha256'
