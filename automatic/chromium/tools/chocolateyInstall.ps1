...
$version = '140.0.7311.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1489571/mini_installer.exe'
  checksum      = '8D225EEB4B257837AB8156DF44D81E7173B0DAC0C44C2B6D4B5ACD9AFDA073C1'
  checksumType  = 'sha256'
