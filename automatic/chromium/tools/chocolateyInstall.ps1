...
$version = '143.0.7493.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1535296/mini_installer.exe'
  checksum      = 'A9B864FEFD4033150D5BE47D72A3A6C69B7DD85A8596E2625425FB300E111D94'
  checksumType  = 'sha256'
