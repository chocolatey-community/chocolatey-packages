...
$version = '136.0.7066.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1431715/mini_installer.exe'
  checksum      = '5826B029348CFF66E7C6F5435C3E2DE5C17B2B9B46C86EAE00DB1C7C59BB56DA'
  checksumType  = 'sha256'
