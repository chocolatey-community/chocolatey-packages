...
$version = '146.0.7657.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1576082/mini_installer.exe'
  checksum      = '328EAF9C31A6081E75C761774D7F7690E5832ABA918823DCF83C36009422D19E'
  checksumType  = 'sha256'
