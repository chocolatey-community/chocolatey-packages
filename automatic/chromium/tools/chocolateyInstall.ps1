...
$version = '139.0.7231.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1471659/mini_installer.exe'
  checksum      = 'C8536E795628A39C799415B43C095862B681623581F04DDFA69557534032EE03'
  checksumType  = 'sha256'
