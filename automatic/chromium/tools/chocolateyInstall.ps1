...
$version = '133.0.6942.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1402262/mini_installer.exe'
  checksum      = '673C98537BCDAD8D1EF24B26197F5643025A7BB494E72B0C04C6A5FA583376F8'
  checksumType  = 'sha256'
