...
$version = '143.0.7499.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1535995/mini_installer.exe'
  checksum      = 'FC19F2AB34D7A2C8E940C333AB494B3C9EDD0A087EF15AFA69CFE06F9A4BC48D'
  checksumType  = 'sha256'
