...
$version = '144.0.7548.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1550505/mini_installer.exe'
  checksum      = '8FABFD5092B222B688974FFBB234DA9D2F6F5525576E70010416ADB11400C8A6'
  checksumType  = 'sha256'
