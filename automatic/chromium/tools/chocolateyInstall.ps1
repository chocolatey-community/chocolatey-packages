...
$version = '137.0.7111.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1443134/mini_installer.exe'
  checksum      = '9C9171907BB5B33BAF68FF429845FCD44C42239FA2B493C9FFDEF3C68FFE93FC'
  checksumType  = 'sha256'
