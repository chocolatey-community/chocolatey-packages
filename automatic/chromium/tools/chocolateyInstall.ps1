...
$version = '140.0.7320.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1492418/mini_installer.exe'
  checksum      = '5D1CE9BC84152BCD807ACD67B876DED614399ABB9732B2E83C3A1BA50485453E'
  checksumType  = 'sha256'
