...
$version = '132.0.6783.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1370276/mini_installer.exe'
  checksum      = 'BC272B081D5442135FFBD54D54ED3849CE133B848D306C670E79FF2D7F722B2A'
  checksumType  = 'sha256'
