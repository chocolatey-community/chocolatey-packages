...
$version = '129.0.6620.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1333579/mini_installer.exe'
  checksum      = 'B7F28D945B3C048DA32F0A9743BC572B8A95BF9B0B1B183C57BEE74534C0023A'
  checksumType  = 'sha256'
