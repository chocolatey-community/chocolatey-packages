...
$version = '135.0.7017.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1420119/mini_installer.exe'
  checksum      = 'A141B01940A18A2AC916E89A3CF89258288B4ABD7435A8BD81C3440E4CE51749'
  checksumType  = 'sha256'
