...
$version = '137.0.7136.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1449221/mini_installer.exe'
  checksum      = '81F9A40C2634242556AC82FBA48D5A046083F259EFEA8FDB6A4416907025F829'
  checksumType  = 'sha256'
