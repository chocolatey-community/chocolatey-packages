...
$version = '145.0.7622.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1565933/mini_installer.exe'
  checksum      = '29B070CB02DEDFDA6E6F6812F1F44E1F454ECC7281E5627E3C979C31D45105C2'
  checksumType  = 'sha256'
