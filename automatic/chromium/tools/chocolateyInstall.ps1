...
$version = '139.0.7252.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1476724/mini_installer.exe'
  checksum      = 'DCB38E13DA7CFAF292E1BBBDC108D83944DBACA2752F01F0CADEC21D0E042470'
  checksumType  = 'sha256'
