...
$version = '138.0.7185.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1461762/mini_installer.exe'
  checksum      = 'A2D2B627E68D1A4D37011AB6D10CC1C073284A6D3B72E0A7502E2B162C272B69'
  checksumType  = 'sha256'
