...
$version = '140.0.7284.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1483540/mini_installer.exe'
  checksum      = '3240D1DDFFB76A2CE35C54746AF4E679EF0C1955186568A5E2F6226ECABC3A9B'
  checksumType  = 'sha256'
