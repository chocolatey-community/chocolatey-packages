...
$version = '136.0.7068.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1432365/mini_installer.exe'
  checksum      = '566936C075AED08103F73F5AE92FE020BDACD0859F4AF08DFFBD5A45BB33AC69'
  checksumType  = 'sha256'
