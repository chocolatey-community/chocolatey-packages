...
$version = '131.0.6738.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1359540/mini_installer.exe'
  checksum      = '6E1F7DECEDD27A2BC14AB9DA75367D9016817AB989B7B1A2BB6D2172ACB92FB6'
  checksumType  = 'sha256'
