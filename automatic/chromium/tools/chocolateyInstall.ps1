...
$version = '133.0.6927.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1400816/mini_installer.exe'
  checksum      = '3543ABE720B74962D56EC3AE77B64D20180CE39D1D5DCAB8B7041443C7C2FEB5'
  checksumType  = 'sha256'
