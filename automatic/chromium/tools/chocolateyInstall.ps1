...
$version = '141.0.7353.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1499968/mini_installer.exe'
  checksum      = '2B68B85C028DA57DEA3E508F64EF5CC171AAE59B9C9874A940147D174684BB9D'
  checksumType  = 'sha256'
