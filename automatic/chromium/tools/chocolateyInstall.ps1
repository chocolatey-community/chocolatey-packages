...
$version = '151.0.7893.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1646663/mini_installer.exe'
  checksum      = '09860696157B39C7A64173C9B23E76E8811AF1558C2FCB3ADE9274AAC1558D6A'
  checksumType  = 'sha256'
