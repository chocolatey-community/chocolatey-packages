...
$version = '147.0.7682.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1583093/mini_installer.exe'
  checksum      = 'F3365597D252B8BAC1930CCFFC7BD76FD48BCAAEA68E701768C43A75AC05F7D6'
  checksumType  = 'sha256'
