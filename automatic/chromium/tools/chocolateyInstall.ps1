...
$version = '144.0.7545.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1549408/mini_installer.exe'
  checksum      = '09F15C18A7F8CCD5E4D0220B2F30C797940B6D96011DE80DD31A9B68B562CD3D'
  checksumType  = 'sha256'
