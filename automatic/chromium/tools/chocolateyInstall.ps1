...
$version = '151.0.7888.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1645096/mini_installer.exe'
  checksum      = '52C7D8D5E128B0E1D237151A7B31DFBBD7627B9389B5D0D12D6197900D6ECE2F'
  checksumType  = 'sha256'
