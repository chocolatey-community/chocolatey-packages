...
$version = '128.0.6568.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1321419/mini_installer.exe'
  checksum      = 'C15069426548AC7C9B6635EB04C50E9F2F780BD550537FCC67C13A588DE27229'
  checksumType  = 'sha256'
