...
$version = '139.0.7208.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1466852/mini_installer.exe'
  checksum      = 'D2803F4A838E3FE3F34A02B218A6CA0AC6258AD5A8D0AB38A528393DE4F7A822'
  checksumType  = 'sha256'
