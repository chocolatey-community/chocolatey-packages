...
$version = '133.0.6910.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1399512/mini_installer.exe'
  checksum      = '6233C5A77E3E95BA82AA9693769C58EDD245E135B962832223A3D5E0C493CF7C'
  checksumType  = 'sha256'
