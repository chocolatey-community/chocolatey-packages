...
$version = '140.0.7316.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1491360/mini_installer.exe'
  checksum      = '3858058C104B432A4C0F6C37A38758D9B7AF5474E7D0D577300BEEC1766C0334'
  checksumType  = 'sha256'
