...
$version = '130.0.6695.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1349883/mini_installer.exe'
  checksum      = '55C9EC05F040154A347C38638D2F201DE0FD37FB8D49C208024FA6F717476E32'
  checksumType  = 'sha256'
