...
$version = '135.0.7047.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1426842/mini_installer.exe'
  checksum      = 'C72A87189EC10A8309D8D1B44010F8D8502DD135E2584725E3460DEE73B4C4FD'
  checksumType  = 'sha256'
