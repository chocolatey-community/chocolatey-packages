...
$version = '145.0.7598.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1562529/mini_installer.exe'
  checksum      = 'F4FA63927955DC06323BC099BC00869EC265BEA0BB6FF35B4DE495EEDEE94572'
  checksumType  = 'sha256'
