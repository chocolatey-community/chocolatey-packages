...
$version = '153.0.8004.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1677735/mini_installer.exe'
  checksum      = '335B2DA85C8575C75E3203942F3A739EEF47139ABF52D4D407EE813E87807B18'
  checksumType  = 'sha256'
