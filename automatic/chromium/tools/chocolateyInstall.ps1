...
$version = '146.0.7678.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1581450/mini_installer.exe'
  checksum      = 'D1092D97A85A0A1600C4FB1C5EC556A845444B55C4E9CEA1067D495CAB3171E3'
  checksumType  = 'sha256'
