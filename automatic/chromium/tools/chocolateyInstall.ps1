...
$version = '135.0.7019.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1420706/mini_installer.exe'
  checksum      = 'A11AA89B7EE6DFC249D330C60AAC5AECCBF691F705507372241A4F6EEF227690'
  checksumType  = 'sha256'
