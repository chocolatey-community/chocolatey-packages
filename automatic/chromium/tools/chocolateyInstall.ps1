...
$version = '146.0.7668.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1578657/mini_installer.exe'
  checksum      = '607821DFCECE75D769EDA2CDE5CC984C223CF90058A939B4DC80314C9F3B182E'
  checksumType  = 'sha256'
