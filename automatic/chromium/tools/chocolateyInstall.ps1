...
$version = '127.0.6522.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1310486/mini_installer.exe'
  checksum      = '5F827198AD323033B612C71F743FA31507ED89720C313A4CFC21617E4BEACD0A'
  checksumType  = 'sha256'
