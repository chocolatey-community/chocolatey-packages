...
$version = '146.0.7656.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1575790/mini_installer.exe'
  checksum      = '9DE056795A1788463F445906A352D25CF1A8E45EBA61A03E37BC03D6C225C53C'
  checksumType  = 'sha256'
