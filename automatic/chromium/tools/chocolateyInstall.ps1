...
$version = '130.0.6687.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1348855/mini_installer.exe'
  checksum      = '2CB34DBDF3A913000F18C275F521F326068DA16448DDDAADC17ACDCA6151ABE8'
  checksumType  = 'sha256'
