...
$version = '141.0.7345.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1498591/mini_installer.exe'
  checksum      = 'D711A6AD96677B9961CE22ECD3F56397FBACAA4B8F0C6DBE7428076DA1BC25E3'
  checksumType  = 'sha256'
