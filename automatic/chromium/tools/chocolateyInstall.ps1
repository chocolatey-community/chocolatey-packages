...
$version = '147.0.7686.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1584500/mini_installer.exe'
  checksum      = '7BB7D3EE57E755CFA7DACE32638505EA218323D57289D2F79C4BBBB85615A90B'
  checksumType  = 'sha256'
