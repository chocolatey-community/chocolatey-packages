...
$version = '130.0.6678.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1346430/mini_installer.exe'
  checksum      = '7E7BBECEFD24816497B82C4AB200717883CA70409262464CF306AFCD11F8238A'
  checksumType  = 'sha256'
