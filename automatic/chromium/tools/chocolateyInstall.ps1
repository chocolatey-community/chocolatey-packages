...
$version = '131.0.6734.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1358659/mini_installer.exe'
  checksum      = 'C72ABDFA756178CCC1298D3965D7B58AA09F0690E1DC918F35DDF1EAFDDCD508'
  checksumType  = 'sha256'
