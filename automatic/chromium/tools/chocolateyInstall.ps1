...
$version = '128.0.6595.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1327197/mini_installer.exe'
  checksum      = 'A67F860B676CA41827B4CFBFB62EDB61CD36AF283FFB3CCBFC10427219482AC5'
  checksumType  = 'sha256'
