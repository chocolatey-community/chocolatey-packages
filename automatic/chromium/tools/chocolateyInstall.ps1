...
$version = '154.0.8031.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1688081/mini_installer.exe'
  checksum      = 'FF6362AC14BA928820586B4FFE978117CF6C8F891549094524F56E0EC0C4E572'
  checksumType  = 'sha256'
