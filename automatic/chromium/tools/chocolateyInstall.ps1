...
$version = '144.0.7549.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1550734/mini_installer.exe'
  checksum      = 'D45C8809715B659AA2D32639C6B19CDF088E30F2AB0979CAD4212FA75569F4C2'
  checksumType  = 'sha256'
