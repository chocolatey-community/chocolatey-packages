...
$version = '137.0.7150.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1452376/mini_installer.exe'
  checksum      = '3CF3F03AFFBB6B535AAFA7C7636432E3B4F431AF484845C20CC129EEC081D439'
  checksumType  = 'sha256'
