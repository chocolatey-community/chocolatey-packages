...
$version = '133.0.6935.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1401553/mini_installer.exe'
  checksum      = 'FFCCC5371B6B204820352C8AE254A57F04B37F2B740346ABBA5F90EEACDF7819'
  checksumType  = 'sha256'
