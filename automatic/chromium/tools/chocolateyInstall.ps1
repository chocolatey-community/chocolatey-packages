...
$version = '132.0.6814.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1377204/mini_installer.exe'
  checksum      = 'D0BAD400EEB31C73C8F87AA10295AE05904D97A8E861F861291B04301FA7082B'
  checksumType  = 'sha256'
