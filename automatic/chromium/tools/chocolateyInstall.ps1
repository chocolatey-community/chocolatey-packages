...
$version = '150.0.7843.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1631597/mini_installer.exe'
  checksum      = '02C85B57E67B5CC0E7D26F3F5B460C6018BFD011C2464EEFCB1B5A4963263D53'
  checksumType  = 'sha256'
