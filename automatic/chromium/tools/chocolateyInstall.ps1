...
$version = '127.0.6498.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1305283/mini_installer.exe'
  checksum      = '86362D5ADD93532F2BACAD03BD2A554786E49F322305F0A4E605A18A54916C93'
  checksumType  = 'sha256'
