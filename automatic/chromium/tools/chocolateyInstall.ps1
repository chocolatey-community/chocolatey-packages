...
$version = '139.0.7245.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1474718/mini_installer.exe'
  checksum      = 'FAF2DC48FAA80F83AF5601C7752A54F6DB78AC6E46CF9BBCD5FE12AE45EC147F'
  checksumType  = 'sha256'
