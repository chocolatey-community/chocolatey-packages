...
$version = '126.0.6478.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1300295/mini_installer.exe'
  checksum      = 'E9252BA7C7157E3E9B500DFBE6B267730E3098AF35949478662A626F32D2081E'
  checksumType  = 'sha256'
