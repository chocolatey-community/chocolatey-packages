...
$version = '150.0.7866.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1638223/mini_installer.exe'
  checksum      = '3840AF33C45C1AC2E336C30B29E0B2176C4DD1877634FE3F4E21B79219CE760E'
  checksumType  = 'sha256'
