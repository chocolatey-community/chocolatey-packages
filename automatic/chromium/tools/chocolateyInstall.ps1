...
$version = '143.0.7458.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1526020/mini_installer.exe'
  checksum      = '5F3D360B5C35895ECBA376901A0691138A2DE323E8A33192FFBB0FF186ADE9EF'
  checksumType  = 'sha256'
