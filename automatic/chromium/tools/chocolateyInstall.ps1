...
$version = '138.0.7191.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1462551/mini_installer.exe'
  checksum      = '0FB6BEE922829147C5D8915CF0D6183CAA00ED14CC4F51558FD5D439C6D03C96'
  checksumType  = 'sha256'
