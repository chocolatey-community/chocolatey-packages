...
$version = '146.0.7634.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1568884/mini_installer.exe'
  checksum      = '6DB03AF84C05B8A3C173E555AFDCFF734DFDC80D7BF2C667CF4D30F7183C5275'
  checksumType  = 'sha256'
