...
$version = '154.0.8018.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1684493/mini_installer.exe'
  checksum      = '2A254805EFEE257966E792BE752BD193DDE5A058EFCC6C91AD0D4F79F24DFC87'
  checksumType  = 'sha256'
