...
$version = '132.0.6821.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1378182/mini_installer.exe'
  checksum      = 'B23F7F2E27B041504116F3AC46F98C255B94CBA938D3FFF5D5A7E19B1C932B1D'
  checksumType  = 'sha256'
