...
$version = '139.0.7209.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1467006/mini_installer.exe'
  checksum      = 'CC7F31F26511BE4043F05D970313086F00178A8C749A032E701F2EF78B57F125'
  checksumType  = 'sha256'
