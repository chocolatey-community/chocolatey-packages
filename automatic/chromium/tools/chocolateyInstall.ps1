...
$version = '142.0.7391.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1509348/mini_installer.exe'
  checksum      = '0AF7BA925CBA8492118C782F81453C0F1341F1DEFC2C81B502AA8F6CDFCDC5C2'
  checksumType  = 'sha256'
