...
$version = '142.0.7434.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1520052/mini_installer.exe'
  checksum      = 'DB2B5073013890B380C60A40A792058BE8B0F9128B9C00B7EDA147654DA636B1'
  checksumType  = 'sha256'
