...
$version = '152.0.7936.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1657447/mini_installer.exe'
  checksum      = '9397D58D71349084607442950368A21808843F6A495B53E21CD774DCF917CB34'
  checksumType  = 'sha256'
