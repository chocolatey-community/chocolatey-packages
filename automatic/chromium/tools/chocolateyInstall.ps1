...
$version = '138.0.7171.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1458031/mini_installer.exe'
  checksum      = '9764755EEB8D1CEB8BE60566826DCF7AECBAE49C34339BD9EA9F369406ECAD6F'
  checksumType  = 'sha256'
