...
$version = '154.0.8011.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1681184/mini_installer.exe'
  checksum      = '4CC7DB00B813D462C1C3CA008BA3240DBB8DDF634799307E724E118FDDC31C25'
  checksumType  = 'sha256'
