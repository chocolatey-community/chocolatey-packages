...
$version = '144.0.7519.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1542260/mini_installer.exe'
  checksum      = 'E79E1F1DE2C70E0F84A78C9EBFD3E9A084CE5161A2F5584DC8991841C8B15917'
  checksumType  = 'sha256'
