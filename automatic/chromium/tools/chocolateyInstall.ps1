...
$version = '141.0.7358.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1501590/mini_installer.exe'
  checksum      = '0A122BCC65E06CE70AE98F1F21FC697AF63E107F4E2F94DC4E47FDE40D301C3D'
  checksumType  = 'sha256'
