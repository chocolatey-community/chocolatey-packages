...
$version = '133.0.6841.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1383982/mini_installer.exe'
  checksum      = 'B124AFA346BCCEFC2633838A1420963DF13BAEF0BCE9F3640441606FDC116553'
  checksumType  = 'sha256'
