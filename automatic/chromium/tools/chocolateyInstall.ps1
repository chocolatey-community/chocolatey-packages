...
$version = '139.0.7254.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1476938/mini_installer.exe'
  checksum      = '6E90D22FC65D7C344698A54AF85DE3EB37DDD96FBB04672ABA36A0C4B17677DC'
  checksumType  = 'sha256'
