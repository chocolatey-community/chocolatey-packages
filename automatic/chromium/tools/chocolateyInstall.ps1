...
$version = '151.0.7907.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1650214/mini_installer.exe'
  checksum      = '8844F68120218E70E165FDACF417EF7A4038A41F8D64E8EE3F60D055DD9DE243'
  checksumType  = 'sha256'
