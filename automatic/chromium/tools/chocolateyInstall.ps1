...
$version = '133.0.6843.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1384079/mini_installer.exe'
  checksum      = 'FC39EEFB9AA3CC2B7E1280AD7A64518DF4CCC55B343F34953E7E6179323CC8A7'
  checksumType  = 'sha256'
