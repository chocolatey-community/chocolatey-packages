...
$version = '136.0.7074.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1433338/mini_installer.exe'
  checksum      = '88AF3EAE26A9FBEE3AA549F7E5D27B8E1244C6A6143B8B816C0DB398BA1B0B8A'
  checksumType  = 'sha256'
