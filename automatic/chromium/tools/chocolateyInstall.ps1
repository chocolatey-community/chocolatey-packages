...
$version = '142.0.7417.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1515745/mini_installer.exe'
  checksum      = '41D6074C3A4E71861A6E365F92F70223E534D48FE509981085A0B4F7FC2654FC'
  checksumType  = 'sha256'
