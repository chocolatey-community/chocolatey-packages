...
$version = '142.0.7412.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1515182/mini_installer.exe'
  checksum      = '0E1FC1BF360222BAA75C54E0873F021167D21B2BED4826A52915D6998E4AD2C8'
  checksumType  = 'sha256'
