...
$version = '145.0.7594.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1561807/mini_installer.exe'
  checksum      = '399DAF720AC66FEE9A8D082ACED6D40057E96190230650A99E1B230171008007'
  checksumType  = 'sha256'
