...
$version = '150.0.7868.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1638967/mini_installer.exe'
  checksum      = '5D4694506A03BE89C3C1213DA01AEA19ADA9D1AF4189086DE0F034ACC77F5995'
  checksumType  = 'sha256'
