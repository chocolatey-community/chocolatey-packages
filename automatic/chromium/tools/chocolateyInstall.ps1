...
$version = '133.0.6877.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1391548/mini_installer.exe'
  checksum      = 'DFE5B968AF36B5585475AA29766F01472FA75DA9C1EAA35B34C93BEDED63B378'
  checksumType  = 'sha256'
