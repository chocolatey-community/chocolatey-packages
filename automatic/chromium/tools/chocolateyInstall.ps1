...
$version = '136.0.7076.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1433957/mini_installer.exe'
  checksum      = 'ED67BF3EA444DADF2ACA289EF3305934B4B8F1CC670178BA02EE87D5F8BDD798'
  checksumType  = 'sha256'
