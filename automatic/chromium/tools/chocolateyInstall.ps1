...
$version = '129.0.6624.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1334042/mini_installer.exe'
  checksum      = 'F88DADD73CAA7C986D39CD8718E5F54CD13ECFDC8602E52EB5B2AE51CDF7925B'
  checksumType  = 'sha256'
