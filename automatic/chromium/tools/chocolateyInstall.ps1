...
$version = '137.0.7108.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1442379/mini_installer.exe'
  checksum      = 'DA09E4FE69A402DB48FCB7F533899637E989EE4F229A932679A2E8389AB5D476'
  checksumType  = 'sha256'
