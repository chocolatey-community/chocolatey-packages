...
$version = '137.0.7137.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1449304/mini_installer.exe'
  checksum      = 'FBF442944B1AD8E3A70DAF8D22713D2C73A177FC036DC725417602FFC8D56229'
  checksumType  = 'sha256'
