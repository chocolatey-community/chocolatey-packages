...
$version = '136.0.7082.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1435850/mini_installer.exe'
  checksum      = 'C95B24136035BBCAA82497ED6696127F96D5644FD7BF0C869379757947BC8099'
  checksumType  = 'sha256'
