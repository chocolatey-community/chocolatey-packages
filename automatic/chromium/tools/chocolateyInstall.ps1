...
$version = '126.0.6477.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1299932/mini_installer.exe'
  checksum      = 'A12F8FE20F5223E80C324F60D88976CD5460FC69FBEA1273B0162C7538885680'
  checksumType  = 'sha256'
