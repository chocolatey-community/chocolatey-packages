...
$version = '134.0.6961.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1407187/mini_installer.exe'
  checksum      = 'A8B2F3D0126AA0D90601CC11147727D07C3B64DCCF436195BC72B50CF769DD99'
  checksumType  = 'sha256'
