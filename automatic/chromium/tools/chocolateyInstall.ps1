...
$version = '132.0.6815.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1377307/mini_installer.exe'
  checksum      = '70E9A8F158BDD65745BCEB1B118FB3852066D9E78D7431845E86E969CC80A68C'
  checksumType  = 'sha256'
