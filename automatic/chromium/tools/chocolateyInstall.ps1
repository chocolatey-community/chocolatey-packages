...
$version = '137.0.7151.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1452624/mini_installer.exe'
  checksum      = '5C49EBB11B40A106852DACCD5FCB14C476B3A3BFE496CE66C0080F460B77112C'
  checksumType  = 'sha256'
