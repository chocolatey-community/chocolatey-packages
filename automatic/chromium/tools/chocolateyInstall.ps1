...
$version = '132.0.6811.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1376329/mini_installer.exe'
  checksum      = 'F551623A64CD1F152ED45C069BA7426ED0E3A2875FD8E78B8F03094714136E46'
  checksumType  = 'sha256'
