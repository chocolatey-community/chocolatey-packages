...
$version = '143.0.7467.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1528577/mini_installer.exe'
  checksum      = '27BC3F5384BD6437718AD697E033820044C50E5F2D61B0A50F932BCE009A4ED2'
  checksumType  = 'sha256'
