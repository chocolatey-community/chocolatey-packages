...
$version = '131.0.6742.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1360693/mini_installer.exe'
  checksum      = '4BE4E97209AFEABDDE9FA9686F5E5CCBE38BA594461976A1E5903D616A9CB322'
  checksumType  = 'sha256'
