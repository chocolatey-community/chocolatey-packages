...
$version = '145.0.7568.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1555181/mini_installer.exe'
  checksum      = 'B5F31873ED5B0667DDF6ED678751359B03842BD6564F6B06B519D251975905EC'
  checksumType  = 'sha256'
