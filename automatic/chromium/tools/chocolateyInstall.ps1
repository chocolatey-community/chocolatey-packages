...
$version = '135.0.7029.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1423412/mini_installer.exe'
  checksum      = 'C7CC30CCCA14120B501C8CC8D7B1ECFC7035B29D920F9FC186F3D09ED9AFDDDC'
  checksumType  = 'sha256'
