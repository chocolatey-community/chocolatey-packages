...
$version = '136.0.7067.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1431995/mini_installer.exe'
  checksum      = 'DA3688DAC6C77C3886595C3406FD0035859FD6DAF7B9932EFAB5893C1383FA15'
  checksumType  = 'sha256'
