...
$version = '152.0.7930.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1656771/mini_installer.exe'
  checksum      = '6EFB7EAB2DB7E279C76C0F8460EA3B2D863C2F8A3DF7B9A87011FFAD05F67DB1'
  checksumType  = 'sha256'
