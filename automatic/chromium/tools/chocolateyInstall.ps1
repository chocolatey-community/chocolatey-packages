...
$version = '139.0.7253.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1476864/mini_installer.exe'
  checksum      = '140C7F02F2785D8BCE66651F3C0D58C0311BC36D2EF3C4E5FEAFB7BFE219BBEB'
  checksumType  = 'sha256'
