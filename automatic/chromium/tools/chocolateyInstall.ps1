...
$version = '150.0.7836.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1628534/mini_installer.exe'
  checksum      = '610FAC6192325938C40FB86F837CD0A6A54A04A9C19A6FE9BEBAB8F0D840BB34'
  checksumType  = 'sha256'
