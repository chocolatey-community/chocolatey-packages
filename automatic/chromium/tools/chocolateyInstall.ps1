...
$version = '147.0.7720.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1594446/mini_installer.exe'
  checksum      = '843BFBAC9B773AC908DFC85BD6FED2FD60090687DD085A0A41D5447C143FC2F2'
  checksumType  = 'sha256'
