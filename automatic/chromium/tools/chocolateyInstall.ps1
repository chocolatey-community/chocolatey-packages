...
$version = '128.0.6545.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1316684/mini_installer.exe'
  checksum      = '04C2E58155B7E478C4ABBC7E38A6F652236D011AE5FFB38E6BAE1A882452DB1A'
  checksumType  = 'sha256'
