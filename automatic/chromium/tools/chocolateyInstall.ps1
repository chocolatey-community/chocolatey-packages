...
$version = '134.0.6972.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1409266/mini_installer.exe'
  checksum      = 'F6EA6CB39E3AA07D6741E47CEFDE48A5ED7DDC48ACBDE5374F3DFCCABDCC5654'
  checksumType  = 'sha256'
