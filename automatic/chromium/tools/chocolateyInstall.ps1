...
$version = '153.0.7989.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1672504/mini_installer.exe'
  checksum      = '93DF6611A14BEBA6F77E38D010B07C677F43E599AA3EDF895ED44A0291E764A3'
  checksumType  = 'sha256'
