...
$version = '133.0.6838.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1383262/mini_installer.exe'
  checksum      = 'FCB7A018F6D03DF2CFAD7AF46AB482A90F96761C26B74955DF16A5B8CC45E5AB'
  checksumType  = 'sha256'
