...
$version = '133.0.6917.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1400091/mini_installer.exe'
  checksum      = 'FC82E34EB93050BBFB6FA8640F6BAF84AC937F3DE274465F255F3FEC3354AF3D'
  checksumType  = 'sha256'
