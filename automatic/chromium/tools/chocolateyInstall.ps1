...
$version = '127.0.6529.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1312478/mini_installer.exe'
  checksum      = '434D7D80C4DF264979662441DAC32FC8A656D68191D139F91FE89271B9D08B30'
  checksumType  = 'sha256'
