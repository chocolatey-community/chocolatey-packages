...
$version = '138.0.7165.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1456144/mini_installer.exe'
  checksum      = '075953CBB36ED7881CCA89BFA3FCB73CFB97D09F80C143AB1B0D0464A6244666'
  checksumType  = 'sha256'
