...
$version = '127.0.6491.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1303244/mini_installer.exe'
  checksum      = '1681F06FE65BA25A57F1EB686C835258DB55328542CA645EF4DA7F67D3FD9619'
  checksumType  = 'sha256'
