...
$version = '143.0.7454.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1525290/mini_installer.exe'
  checksum      = '90B545215577D0FDE91A678681E488796D233289FA91743018BDA17F78E826A5'
  checksumType  = 'sha256'
