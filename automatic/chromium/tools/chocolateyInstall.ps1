...
$version = '154.0.8020.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1684548/mini_installer.exe'
  checksum      = '68C340BB39AC98447D6EC457BF2FEDB4F44B06073B52442B28D536DFEA60FB35'
  checksumType  = 'sha256'
