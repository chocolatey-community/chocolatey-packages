...
$version = '139.0.7244.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1474371/mini_installer.exe'
  checksum      = '841E2777D9B44ADD8756B929BF1298322B2A25684221A334CFD392C8A961F9FA'
  checksumType  = 'sha256'
