...
$version = '132.0.6810.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1376125/mini_installer.exe'
  checksum      = '0593A20B958375D566B27BC0C0D4CF959D59E84F1B897631A19E07AD22DEBEC5'
  checksumType  = 'sha256'
