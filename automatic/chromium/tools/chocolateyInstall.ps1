...
$version = '151.0.7879.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1642812/mini_installer.exe'
  checksum      = '067D42BDC08CE7C5A8B29D2A63E3DC4EE7F0E25D99410AB9DF0BC1477522B192'
  checksumType  = 'sha256'
