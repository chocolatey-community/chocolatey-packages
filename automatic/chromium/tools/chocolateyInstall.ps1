...
$version = '140.0.7281.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1482908/mini_installer.exe'
  checksum      = '5E8021BC7BA1902D4FD19B93BBB969370BBF9EEE0482198939D12C155FD99F8E'
  checksumType  = 'sha256'
