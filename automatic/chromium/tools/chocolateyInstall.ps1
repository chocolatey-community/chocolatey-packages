...
$version = '153.0.8003.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1677529/mini_installer.exe'
  checksum      = 'C0DB91206FAFCD58E22F18C54FB565D855B00E1CFF2D1AE75480A2B9C0E2AECC'
  checksumType  = 'sha256'
