...
$version = '142.0.7413.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1515247/mini_installer.exe'
  checksum      = '23636E11D55EF74CE090808709D7B2DC9FFA05F547B76ED3ADECC4CE20471729'
  checksumType  = 'sha256'
