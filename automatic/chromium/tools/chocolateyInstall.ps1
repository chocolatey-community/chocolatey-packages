...
$version = '144.0.7518.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1542209/mini_installer.exe'
  checksum      = '6D80A04EDEDA52C289FD5EA5F569BEB1D6905155B6C6C3D874BFE61C5F204AB3'
  checksumType  = 'sha256'
