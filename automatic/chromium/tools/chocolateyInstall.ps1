...
$version = '129.0.6618.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1333147/mini_installer.exe'
  checksum      = '68A8A2A9B88F515048BDCB00ACBB6E33606BC49C5204FCA4D91D49C0C08B0385'
  checksumType  = 'sha256'
