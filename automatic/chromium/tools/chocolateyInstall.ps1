...
$version = '150.0.7832.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1626968/mini_installer.exe'
  checksum      = '151D381DF316874C8BB255913B1CB0DB851CDA02DB204DBCBEDB9F90E6B8C0AB'
  checksumType  = 'sha256'
