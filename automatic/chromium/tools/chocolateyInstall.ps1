...
$version = '137.0.7104.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1440772/mini_installer.exe'
  checksum      = '4E4F6262F9256EB74EE99F6AFA1C74FFA95CF2B2C7E7755B1814059D5FADA65C'
  checksumType  = 'sha256'
