...
$version = '128.0.6608.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1330690/mini_installer.exe'
  checksum      = 'C5C5EC030B1B52E23E7BA0BA719012DC6F6685A42CC7E9590F7A31B028B2EA47'
  checksumType  = 'sha256'
