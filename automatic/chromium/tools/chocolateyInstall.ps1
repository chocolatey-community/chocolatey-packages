...
$version = '145.0.7600.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1562622/mini_installer.exe'
  checksum      = '782DA24B2CEFE64B166666A953C2B5D7D1A31AA5E075F244026CEE570A25799C'
  checksumType  = 'sha256'
