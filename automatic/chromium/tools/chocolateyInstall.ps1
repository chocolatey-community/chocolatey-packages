...
$version = '146.0.7672.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1580391/mini_installer.exe'
  checksum      = '0FF76E72A566FDAE6AC018BECC23F8A2DE49470AE3EC5A1074E12CE5958B4E26'
  checksumType  = 'sha256'
