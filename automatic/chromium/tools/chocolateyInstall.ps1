...
$version = '131.0.6743.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1360984/mini_installer.exe'
  checksum      = 'F9CAF1DE102BD02C520A1E68E2EEBA70FCE9C9F9A958FD84442A1428525D62FF'
  checksumType  = 'sha256'
