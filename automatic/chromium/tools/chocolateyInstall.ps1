...
$version = '143.0.7491.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1534387/mini_installer.exe'
  checksum      = '30417A358C57FB7C9D6EFC3D4D7EC5B756D494919363862033A00BA8BDF32A0C'
  checksumType  = 'sha256'
