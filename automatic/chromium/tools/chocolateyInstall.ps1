...
$version = '152.0.7965.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1665522/mini_installer.exe'
  checksum      = '19C80C96B294D361D1ECFE4A9F186CCE93A6C37B239E1645DAC250CF2B4625AC'
  checksumType  = 'sha256'
