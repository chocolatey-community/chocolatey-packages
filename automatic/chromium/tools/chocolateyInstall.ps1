...
$version = '154.0.8032.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1688568/mini_installer.exe'
  checksum      = 'A9340ACD4D36F26BD97E4CC660E0F4C9716C5CE843909F3C3D841F304342CB29'
  checksumType  = 'sha256'
