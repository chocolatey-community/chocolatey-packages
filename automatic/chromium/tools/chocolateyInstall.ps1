...
$version = '142.0.7426.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1518369/mini_installer.exe'
  checksum      = '8468EE1D10EFDC6C929E2DD9A568A1039658ABDF86AC2A43E44B1FA85AC0ECAF'
  checksumType  = 'sha256'
