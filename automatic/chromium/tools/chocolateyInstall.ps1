...
$version = '144.0.7556.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1551816/mini_installer.exe'
  checksum      = '8420728CFF25EB849166A2418D11A735C89FE4321EF98419FB58B3E3C7136B3C'
  checksumType  = 'sha256'
