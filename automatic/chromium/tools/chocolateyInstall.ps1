...
$version = '133.0.6920.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1400225/mini_installer.exe'
  checksum      = '292FD658C985A6B2519EC117BEF310BF329A65B0A4B6000B4684F60587A7BA8B'
  checksumType  = 'sha256'
