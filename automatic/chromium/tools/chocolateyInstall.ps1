...
$version = '137.0.7115.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1443455/mini_installer.exe'
  checksum      = '883D86BA940D481F64A294743C40600148C00912CCAF32CD97154D52C6B7833B'
  checksumType  = 'sha256'
