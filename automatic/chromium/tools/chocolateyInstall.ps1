...
$version = '133.0.6909.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1399365/mini_installer.exe'
  checksum      = '8900F88CF98FCF27153AB6F3B2113168370FADC89B79E45C8037F72F3E9292EE'
  checksumType  = 'sha256'
