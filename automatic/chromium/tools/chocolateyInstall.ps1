...
$version = '144.0.7557.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1551863/mini_installer.exe'
  checksum      = '710C2D56C0898CEF28AC5E7CE96FB59CB6A22A2C7F1E03FC0FF1668A6B54F295'
  checksumType  = 'sha256'
