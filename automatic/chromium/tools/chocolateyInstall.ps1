...
$version = '138.0.7195.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1463848/mini_installer.exe'
  checksum      = 'C9F6958BFBCAC92BF273E35EB50B6CF6DF3E3F766F59D067C69FD4BFCB39850F'
  checksumType  = 'sha256'
