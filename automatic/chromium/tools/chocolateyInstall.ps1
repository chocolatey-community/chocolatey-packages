...
$version = '140.0.7335.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1495949/mini_installer.exe'
  checksum      = '4452A03C2752AA8E52E0CF0489160F6A41DE88704916DADFB4F063F585BD7C88'
  checksumType  = 'sha256'
