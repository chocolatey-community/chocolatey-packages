...
$version = '142.0.7428.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1518445/mini_installer.exe'
  checksum      = 'F7DCFEC793129068AE50E04E2FD4537F3CC63E5B650126ED9E5AB2A9D41BEE10'
  checksumType  = 'sha256'
