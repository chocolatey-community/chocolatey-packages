...
$version = '140.0.7290.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1485469/mini_installer.exe'
  checksum      = '362B0A5DC5C211C71CCA18608140E39F1221F9054A60EEA490376E0DF24151E5'
  checksumType  = 'sha256'
