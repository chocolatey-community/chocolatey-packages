...
$version = '151.0.7896.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1647542/mini_installer.exe'
  checksum      = '7345AD6C7281A34B9B71C1512645EE98465168FE08078E96CA3AFBB4123CBE10'
  checksumType  = 'sha256'
