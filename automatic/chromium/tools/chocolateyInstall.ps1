...
$version = '136.0.7075.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1433572/mini_installer.exe'
  checksum      = '96A14E94B2FDB1BC93C545896BE516C87B15E298DE426AE9CE57658C5DCE60F4'
  checksumType  = 'sha256'
