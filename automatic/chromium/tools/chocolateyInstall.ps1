...
$version = '136.0.7096.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1439205/mini_installer.exe'
  checksum      = 'A588B32C251052DEAD13083265FB07420C800489582A16F3A3A2EFBA7521A266'
  checksumType  = 'sha256'
