...
$version = '143.0.7445.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1522660/mini_installer.exe'
  checksum      = '87DFA5FAA60D34D496471BCB34B88256F3F719DF15C730DFF63C41EE52E69192'
  checksumType  = 'sha256'
