...
$version = '132.0.6818.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1377456/mini_installer.exe'
  checksum      = '9F411B354F385A80DF545396BC09FC1B9D453BAAE215921527FCFA7FED80CBD0'
  checksumType  = 'sha256'
