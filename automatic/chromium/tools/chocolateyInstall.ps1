...
$version = '127.0.6488.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1303066/mini_installer.exe'
  checksum      = 'E93964F76FB85FA7C91A6279D1505B0C06166D8B0ECD88FAC84A07C6F0C564BE'
  checksumType  = 'sha256'
