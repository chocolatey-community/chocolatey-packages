...
$version = '144.0.7558.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1551915/mini_installer.exe'
  checksum      = 'C20D2FD5D50C6345476A8560A614BDCA0749D50A5475FBA167C1EA4EF894641F'
  checksumType  = 'sha256'
