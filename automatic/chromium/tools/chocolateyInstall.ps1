...
$version = '141.0.7360.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1502250/mini_installer.exe'
  checksum      = '72EF4E78B04D0A90080BD5B6670DB9B8F37D9ACF04821D90C2A52CEF46A5934F'
  checksumType  = 'sha256'
