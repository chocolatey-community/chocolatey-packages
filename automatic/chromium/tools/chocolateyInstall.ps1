...
$version = '145.0.7576.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1557404/mini_installer.exe'
  checksum      = 'A6D2B7FD110D6BB2905C7AB3FB1ACB5AF7585E5CE11DA6BC810703C65E46F9FD'
  checksumType  = 'sha256'
