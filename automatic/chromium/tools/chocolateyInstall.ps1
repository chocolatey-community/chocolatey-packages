...
$version = '132.0.6816.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1377350/mini_installer.exe'
  checksum      = 'E0FBE20AD2D04629C379AF423EA447E43B376781C93B2084912E823CCC3537A6'
  checksumType  = 'sha256'
