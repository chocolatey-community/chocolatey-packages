...
$version = '139.0.7240.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1473952/mini_installer.exe'
  checksum      = 'C24D2C2E108E748CB6AEFBF0D702FFEC2E5DDE2F27D16D4C9E72C56F3909AAE2'
  checksumType  = 'sha256'
