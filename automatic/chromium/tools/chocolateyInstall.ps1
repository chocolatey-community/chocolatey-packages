...
$version = '146.0.7665.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1577865/mini_installer.exe'
  checksum      = '18D84AF7BB48636C973A27D0C9C2B7AA44643A48FEA8F4AA00D821E54340E6AA'
  checksumType  = 'sha256'
