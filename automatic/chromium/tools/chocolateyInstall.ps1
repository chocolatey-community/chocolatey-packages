...
$version = '153.0.7978.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1669320/mini_installer.exe'
  checksum      = '263C1DA2659DC2AD2E938287730BE6CC172D56FCDFADAAA859A3BFCE007BB687'
  checksumType  = 'sha256'
