...
$version = '139.0.7206.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1466303/mini_installer.exe'
  checksum      = '2965CC440B0CBBFC26018863CD4DFCAC2CE7DE012A3C029DEFB4BE12D94EC1BD'
  checksumType  = 'sha256'
