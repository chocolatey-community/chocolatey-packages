...
$version = '139.0.7218.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1468619/mini_installer.exe'
  checksum      = 'C4FF73D9E2F0E30DC616923D1E0D171671AB9388EF05F23ADCAA74E384624F83'
  checksumType  = 'sha256'
