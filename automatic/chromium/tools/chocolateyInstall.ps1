...
$version = '145.0.7562.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1553802/mini_installer.exe'
  checksum      = '32CAE8898B10E6E389981047E725609C3CB185F7C9928AC4CD7FF2199B891BB2'
  checksumType  = 'sha256'
