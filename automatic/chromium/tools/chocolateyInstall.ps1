...
$version = '144.0.7524.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1543263/mini_installer.exe'
  checksum      = '18F9AB1F2AFE6F1C845F9713D2F6DF0F644242501E298B48234B57AA642EBF0F'
  checksumType  = 'sha256'
