...
$version = '135.0.6999.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1415451/mini_installer.exe'
  checksum      = '59A44543347FFD6C6C2A0B1009E0DE42790C19A9809C8D0C301B3861A855DCDE'
  checksumType  = 'sha256'
