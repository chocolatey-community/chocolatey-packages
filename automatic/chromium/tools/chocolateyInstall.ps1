...
$version = '131.0.6771.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1367412/mini_installer.exe'
  checksum      = '3332DBE686A156AF02C84DA87DFEA842CAF19FC770CC25FE5AE3D55AA2E077C2'
  checksumType  = 'sha256'
