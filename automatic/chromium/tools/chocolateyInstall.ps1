...
$version = '142.0.7429.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1518521/mini_installer.exe'
  checksum      = '5E9CE2D60C13D21AFBD4D49D1C910A306F27DABF0D6B1488492C576AEC72020F'
  checksumType  = 'sha256'
