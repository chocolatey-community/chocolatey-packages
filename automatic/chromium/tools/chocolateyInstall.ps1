...
$version = '129.0.6668.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1343458/mini_installer.exe'
  checksum      = '75C7821C780EE83275F673EEDC3632EED43D50B3E2AE26334C4B1FF4973534F8'
  checksumType  = 'sha256'
