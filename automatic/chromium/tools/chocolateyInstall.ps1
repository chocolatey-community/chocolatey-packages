...
$version = '147.0.7726.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1596146/mini_installer.exe'
  checksum      = '5A787458CF92460C5E03F4F51D4BB49A0FD3AA53A1E521BF279DD418E5F29CB0'
  checksumType  = 'sha256'
