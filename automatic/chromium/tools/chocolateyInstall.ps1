...
$version = '133.0.6939.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1402093/mini_installer.exe'
  checksum      = 'E6505CD0C64A0417BAB20A81E6756CF1FB10B45202986F4D417879554481B6B8'
  checksumType  = 'sha256'
