...
$version = '152.0.7952.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1662462/mini_installer.exe'
  checksum      = '42A664D8CF72588D4AD3C85BD3E2C335ED785962663CEC38ECD14ABD4D3D7642'
  checksumType  = 'sha256'
