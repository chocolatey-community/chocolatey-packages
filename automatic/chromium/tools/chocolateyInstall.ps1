...
$version = '136.0.7062.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1430500/mini_installer.exe'
  checksum      = '7E6297B05371EB2C351B04B564992E1911596416587424F6AE4444BDFEB13EB9'
  checksumType  = 'sha256'
