...
$version = '129.0.6646.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1339116/mini_installer.exe'
  checksum      = 'B187C1EEF3DF51B5799F089F91042903F5FBB10423C58713EA20977ED7AE5E7B'
  checksumType  = 'sha256'
