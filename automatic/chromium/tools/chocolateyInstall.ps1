...
$version = '128.0.6592.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1326664/mini_installer.exe'
  checksum      = 'D195EFB2659861A76813B42DAC3B3474B9DAB5B4A26C6346402DB43865EB272D'
  checksumType  = 'sha256'
