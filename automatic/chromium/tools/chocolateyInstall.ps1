...
$version = '141.0.7362.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1502389/mini_installer.exe'
  checksum      = '8A3FBE3FCCC53410BEE01360DF2E2FA0AEDBA1E9113E7755DE504C045E7DC633'
  checksumType  = 'sha256'
