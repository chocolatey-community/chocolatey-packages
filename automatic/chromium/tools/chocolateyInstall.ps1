...
$version = '152.0.7963.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1664726/mini_installer.exe'
  checksum      = 'D3FED47773F1F891F6441713C8358D49C6B16848A878EB70DD4AD9C656197221'
  checksumType  = 'sha256'
