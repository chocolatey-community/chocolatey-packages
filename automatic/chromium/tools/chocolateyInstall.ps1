...
$version = '146.0.7664.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1577782/mini_installer.exe'
  checksum      = '7BF3A33D0C2465E65445039FFEA89A37DC0CAC6994AD05576EFAE0FA537D33DB'
  checksumType  = 'sha256'
