...
$version = '143.0.7451.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1524850/mini_installer.exe'
  checksum      = 'FB04570900B06C2216FE9714B3B73C0CC5628F2F386374E668662890D4A8A7C8'
  checksumType  = 'sha256'
