...
$version = '136.0.7071.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1433144/mini_installer.exe'
  checksum      = 'D50A7BE28B73965C39D81160E80AD9E1AEB3B4A45E33ED25C949531091D98872'
  checksumType  = 'sha256'
