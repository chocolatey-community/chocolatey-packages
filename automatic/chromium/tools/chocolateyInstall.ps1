...
$version = '140.0.7330.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1494718/mini_installer.exe'
  checksum      = '530E0725E342C558B4D9B9236992FF30B9BD2FF6CFC9FF5116798BF98D87538D'
  checksumType  = 'sha256'
