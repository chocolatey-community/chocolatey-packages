...
$version = '133.0.6848.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1385228/mini_installer.exe'
  checksum      = '6E9F5FAD9FCA37B199055D1578E4ADA09279E112AFB20663129E34C6110ABD37'
  checksumType  = 'sha256'
