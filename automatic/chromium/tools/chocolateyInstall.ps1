...
$version = '138.0.7159.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1455309/mini_installer.exe'
  checksum      = '687FD8D48CA9228A9E20100D7A4208848AF4C40E5506DFDE831C6925EDE89CFF'
  checksumType  = 'sha256'
