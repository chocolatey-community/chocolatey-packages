...
$version = '128.0.6538.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1314546/mini_installer.exe'
  checksum      = '72FC4B71CE7A0C64AF000655CDFD5053749027E009FF787B6E0CC4D920BE749C'
  checksumType  = 'sha256'
