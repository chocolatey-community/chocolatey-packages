...
$version = '129.0.6654.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1340420/mini_installer.exe'
  checksum      = 'ACD056341B3006929CAF4DC566D7D2FB809892BE28BE11303F1874DD041957A3'
  checksumType  = 'sha256'
