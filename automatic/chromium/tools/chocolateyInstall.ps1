...
$version = '139.0.7241.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1474015/mini_installer.exe'
  checksum      = 'F835CB3E6AAAA205F4BBFA712D65ACB4A6407333BCF29D023CA3B5A96DF1E12C'
  checksumType  = 'sha256'
