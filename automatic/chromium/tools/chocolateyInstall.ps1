...
$version = '143.0.7470.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1528752/mini_installer.exe'
  checksum      = '183FE1122C65F266C85EE4195687ED38038597509616DCFB1FDA35524E1DBF65'
  checksumType  = 'sha256'
