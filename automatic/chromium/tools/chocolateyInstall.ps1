...
$version = '152.0.7937.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1657835/mini_installer.exe'
  checksum      = 'E7FE8F4008CC734E9D11B2FE363631BD5E2BB5B7730A2927BCD08316E7483EAD'
  checksumType  = 'sha256'
