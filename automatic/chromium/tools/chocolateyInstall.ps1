...
$version = '152.0.7931.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1656787/mini_installer.exe'
  checksum      = '04B587F6120B1E30EF9FA84C4C4BEDA5652243029459640E8B5DC80E386F18AB'
  checksumType  = 'sha256'
