...
$version = '130.0.6718.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1355560/mini_installer.exe'
  checksum      = '31FC1C5C0923054551F0F0FCD153060735C8C412C756AA49B484846EA9F43BDA'
  checksumType  = 'sha256'
