...
$version = '146.0.7671.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1579957/mini_installer.exe'
  checksum      = 'AEB081D1D9904D8F38E81F7522F79E591B988FD75E257051EE25EB302CD3E2D7'
  checksumType  = 'sha256'
