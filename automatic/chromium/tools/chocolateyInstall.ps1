...
$version = '135.0.7023.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1421637/mini_installer.exe'
  checksum      = '155A379ECC75883DFD67D6B6A5D1393DBC42EF62D1AAB8D9DA464C0F1A2E58A7'
  checksumType  = 'sha256'
