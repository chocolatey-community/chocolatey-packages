...
$version = '139.0.7232.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1471848/mini_installer.exe'
  checksum      = '42E33A39663EA1E20AC97C17FABD8E79E19E61F0BA7028521CE14D13BB63A68D'
  checksumType  = 'sha256'
