...
$version = '141.0.7351.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1499439/mini_installer.exe'
  checksum      = '52CDF8F804B94869F4F62A6689C4E588116D8BFC2701A684662CDDB2AC117959'
  checksumType  = 'sha256'
