...
$version = '151.0.7882.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1643055/mini_installer.exe'
  checksum      = 'B3116C5E48E9701E49A011E3E235807B88CBE28D2DCD38957F132B3B5C1236C9'
  checksumType  = 'sha256'
