...
$version = '137.0.7131.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1448379/mini_installer.exe'
  checksum      = 'B198AFC8A75BE798A994115A1BB979EF1FEBC18C05DA14598BA9F7A900846C70'
  checksumType  = 'sha256'
