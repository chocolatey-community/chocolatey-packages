...
$version = '128.0.6580.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1323849/mini_installer.exe'
  checksum      = '04CFC40AF0DE867ED7914F54443A9684B0D39415EDD6A139111899E125A2B709'
  checksumType  = 'sha256'
