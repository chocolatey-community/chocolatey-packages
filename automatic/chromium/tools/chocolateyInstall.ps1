...
$version = '146.0.7646.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1571508/mini_installer.exe'
  checksum      = '6A6708BFE4E741BA49918419390C12BF734945AF029446F84E0D2B02C7807C3F'
  checksumType  = 'sha256'
