...
$version = '135.0.7011.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1418304/mini_installer.exe'
  checksum      = '517DF0A3A69BCE4F9EF5D4AF3D76BDD5B7FB052301BBB42F40D0AA21E68E4772'
  checksumType  = 'sha256'
