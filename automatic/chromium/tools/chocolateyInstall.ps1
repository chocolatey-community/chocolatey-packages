...
$version = '145.0.7575.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1557216/mini_installer.exe'
  checksum      = 'D29C9670032B751FBBBBE8A7D1BEF2A7EE33F06AEF42774DFFEA42AB1787C3AB'
  checksumType  = 'sha256'
