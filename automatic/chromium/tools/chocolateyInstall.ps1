...
$version = '150.0.7855.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1635450/mini_installer.exe'
  checksum      = '975353DB6F6E098B42F2D13E35119E167E008440133C3688D336B413CDD377A9'
  checksumType  = 'sha256'
