...
$version = '144.0.7559.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1552410/mini_installer.exe'
  checksum      = 'AC67CE06D8DEE5F7A209743394C7CE709DBFE7E7B590124F2E5824B443D47EE5'
  checksumType  = 'sha256'
