...
$version = '144.0.7538.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1548303/mini_installer.exe'
  checksum      = 'E55D3C5D6C67C6147CDEAD6ED982DF8B3EB8546B68602632BA98CEE71FE29B16'
  checksumType  = 'sha256'
