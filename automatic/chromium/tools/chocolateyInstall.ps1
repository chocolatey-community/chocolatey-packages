...
$version = '154.0.8019.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1684520/mini_installer.exe'
  checksum      = 'F7BF0327E391FA5648F63FDEB9B6E714855BE0B7CC1D86A5F38AB6094CB1428B'
  checksumType  = 'sha256'
