...
$version = '152.0.7972.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1668242/mini_installer.exe'
  checksum      = 'A1E05C8240ACCF308EF94ED8897B926FC90C260235C4AE6F37F99EFE5DADE13F'
  checksumType  = 'sha256'
