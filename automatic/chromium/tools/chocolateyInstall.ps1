...
$version = '139.0.7224.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1470621/mini_installer.exe'
  checksum      = 'A52AC4ED41324B98B8C720E2668249DF2FB02A24C4E1A772DF11BD94889AA874'
  checksumType  = 'sha256'
