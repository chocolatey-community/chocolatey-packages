...
$version = '139.0.7227.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1470988/mini_installer.exe'
  checksum      = '7147A360D2F9FF384B96DE661C2D10687A9A9C44F978F6960B208C9A4466882F'
  checksumType  = 'sha256'
