...
$version = '144.0.7531.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1545929/mini_installer.exe'
  checksum      = '37E6AE217F23FB730741D0949BD2D8D303135E1B7A4C036559EE67459664A522'
  checksumType  = 'sha256'
