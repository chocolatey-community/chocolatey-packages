...
$version = '140.0.7303.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1488520/mini_installer.exe'
  checksum      = '2BC47A3CA243A0E39DF452317BE8EE2655C19B8BC306B9AF97F7E93FF4668486'
  checksumType  = 'sha256'
