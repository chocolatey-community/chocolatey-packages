...
$version = '129.0.6621.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1333913/mini_installer.exe'
  checksum      = '030E81FC95C25CD96A80AC902330387E53AAA158539BF53B06E1D628A7D64E43'
  checksumType  = 'sha256'
