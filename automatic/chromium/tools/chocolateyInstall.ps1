...
$version = '142.0.7443.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1521959/mini_installer.exe'
  checksum      = '6018A818C45493C7CBF54E912DE299FD1E6E6FCA53D35AA27B465C7DC48F5922'
  checksumType  = 'sha256'
