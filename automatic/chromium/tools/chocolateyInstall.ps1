...
$version = '150.0.7842.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1630772/mini_installer.exe'
  checksum      = 'B486C2FB83989F1523E0ECA7D0B558C490176EED5D2D57675B73F3891B08EBD3'
  checksumType  = 'sha256'
