...
$version = '129.0.6656.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1341202/mini_installer.exe'
  checksum      = '36D6EF20FD1F753A1ADD75A632190D41D5C639F215FA5A4A5461B4E83E28DFD9'
  checksumType  = 'sha256'
