...
$version = '134.0.6993.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1414561/mini_installer.exe'
  checksum      = '35B1B88ADE30844C993C34DE4B1F2AC19D8CB3B650BD1A37D7AD9055635203D8'
  checksumType  = 'sha256'
