...
$version = '141.0.7386.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1508791/mini_installer.exe'
  checksum      = '4E0B06AE4F0BC1E940610CEB511B4150867AB1056161D25BD07EAED0C3EDB03C'
  checksumType  = 'sha256'
