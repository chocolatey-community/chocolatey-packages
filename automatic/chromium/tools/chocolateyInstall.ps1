...
$version = '144.0.7552.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1551367/mini_installer.exe'
  checksum      = '40B8BD1C21FD816974827DE28F779B76C75E6F92A9B4A1063CFBBBC83D69E0A7'
  checksumType  = 'sha256'
