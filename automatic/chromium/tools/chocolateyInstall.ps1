...
$version = '151.0.7906.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1650085/mini_installer.exe'
  checksum      = '4DB8674B599CB25C512CFD3CF282A3E6BFEC16ECC6958BA963F8B09D0A643994'
  checksumType  = 'sha256'
