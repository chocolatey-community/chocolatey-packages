...
$version = '133.0.6849.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1385407/mini_installer.exe'
  checksum      = 'FE14274C67B939D836EBACC0B3732B8DA14CC0E194A80485ECBAB833C8209511'
  checksumType  = 'sha256'
