...
$version = '128.0.6589.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1325724/mini_installer.exe'
  checksum      = '7E57C300BCC48CDFF402AB0368E85EC8E7575B8B584483F1BEC038CC334C3DE1'
  checksumType  = 'sha256'
