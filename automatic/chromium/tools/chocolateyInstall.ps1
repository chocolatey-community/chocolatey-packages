...
$version = '136.0.7094.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1438560/mini_installer.exe'
  checksum      = '8FF0CB888ACA03B1F30CDA0C5964B526C055AC68B96E698304FEE9D694A134AB'
  checksumType  = 'sha256'
