...
$version = '140.0.7319.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1492333/mini_installer.exe'
  checksum      = '80CCFA35852DB96BB64AC42ECB0EEB989D1726642DEB79BD03FF1D0DA0CDA790'
  checksumType  = 'sha256'
