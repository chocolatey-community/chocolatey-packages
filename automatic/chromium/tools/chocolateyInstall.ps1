...
$version = '151.0.7876.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1642135/mini_installer.exe'
  checksum      = '73AF3F57FE8934EA5D04857222DF966649C0D4F48125A2A4B01F2BEAA63B0F02'
  checksumType  = 'sha256'
