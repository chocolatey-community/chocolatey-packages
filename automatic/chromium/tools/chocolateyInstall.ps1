...
$version = '136.0.7083.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1436273/mini_installer.exe'
  checksum      = '63F18488CFB87767710620C00275B212EA6E59DBFB627BA4B8DDCDD429521598'
  checksumType  = 'sha256'
