...
$version = '128.0.6593.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1326972/mini_installer.exe'
  checksum      = '74E53C09F98505F55069AD2314777CF8F812890AA8ECEC4A14764F002978D3B5'
  checksumType  = 'sha256'
