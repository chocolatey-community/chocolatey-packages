...
$version = '144.0.7512.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1540876/mini_installer.exe'
  checksum      = 'E0D67F245457720E9A9A9ABD1DA30CE881ADA5DD5CF77F8AA0403C99ED046473'
  checksumType  = 'sha256'
