...
$version = '154.0.8030.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1687876/mini_installer.exe'
  checksum      = '50709A2BEEFBB2B336AFB2FDBC2D35CC111F7D3653977BC823075DD2F63FEF9D'
  checksumType  = 'sha256'
