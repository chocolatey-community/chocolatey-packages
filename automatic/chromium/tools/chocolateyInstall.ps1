...
$version = '138.0.7183.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1461145/mini_installer.exe'
  checksum      = '90A13C88D0DE2E38F211652D3BE9D2A67C81D600E6316A2FAA79677DEF543047'
  checksumType  = 'sha256'
