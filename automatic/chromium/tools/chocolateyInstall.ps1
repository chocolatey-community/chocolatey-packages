...
$version = '130.0.6720.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1355643/mini_installer.exe'
  checksum      = '00B796FA6BBB278C10E9C82354CC5BA1D09AAF041A6E2F4A89C4C52BDD768D63'
  checksumType  = 'sha256'
