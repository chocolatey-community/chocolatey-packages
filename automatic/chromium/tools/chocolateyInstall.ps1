...
$version = '133.0.6879.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1392062/mini_installer.exe'
  checksum      = '6285797352DC795C791F40DA38DB183C43ABA5D19AC297939E105F7B49EBAFA6'
  checksumType  = 'sha256'
