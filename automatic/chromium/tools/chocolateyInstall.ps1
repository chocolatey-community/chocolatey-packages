...
$version = '134.0.6955.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1405357/mini_installer.exe'
  checksum      = 'ABED1C25C0F89948F6E2AE601FDE48B37908F41D7C19F770BA6E395183A5EB67'
  checksumType  = 'sha256'
