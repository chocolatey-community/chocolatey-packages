...
$version = '152.0.7933.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1656876/mini_installer.exe'
  checksum      = 'F557286EA22B769CD3813951C7DDB1EE4F46923AC59C1AE42E33F2FD2AA5C0E3'
  checksumType  = 'sha256'
