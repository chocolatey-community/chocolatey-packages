...
$version = '143.0.7471.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1528962/mini_installer.exe'
  checksum      = 'FF0A225B59C9EFCA99C26530A6392972A91F86CB25937055411AB1F46E7F5B48'
  checksumType  = 'sha256'
