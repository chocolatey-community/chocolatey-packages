...
$version = '145.0.7565.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1554922/mini_installer.exe'
  checksum      = 'B5632AC80CF1DD383E30EE6C0497929C513CF482D40B21E99F821C30B1CCDE9E'
  checksumType  = 'sha256'
