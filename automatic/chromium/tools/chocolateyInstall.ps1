...
$version = '132.0.6804.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1374523/mini_installer.exe'
  checksum      = 'C1AD6103AE9A444C291C040706A0B933046A3D991F03569DB842552326819E8C'
  checksumType  = 'sha256'
