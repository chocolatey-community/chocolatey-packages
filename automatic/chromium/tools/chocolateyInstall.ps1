...
$version = '150.0.7839.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1629871/mini_installer.exe'
  checksum      = '871123FC0B3D9726FCBD7735DB67B5C50388BE3894FB2154E40C72A0BDDA1C7E'
  checksumType  = 'sha256'
