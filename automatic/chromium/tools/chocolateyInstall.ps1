...
$version = '144.0.7516.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1542009/mini_installer.exe'
  checksum      = '606CB27530665EE87FD2F3518E97680EEE5AEFD207861154BE0F830192778813'
  checksumType  = 'sha256'
