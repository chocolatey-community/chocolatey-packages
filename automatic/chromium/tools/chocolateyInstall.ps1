...
$version = '141.0.7341.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1497356/mini_installer.exe'
  checksum      = '0ECD6F05147F0C72B71AF7E2D279EAE01CB3F5F7097C862129E6060B8A54703B'
  checksumType  = 'sha256'
