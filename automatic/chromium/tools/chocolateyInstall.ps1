...
$version = '145.0.7577.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1557885/mini_installer.exe'
  checksum      = 'A247A0D9B4C82CB75B6A9114AC1182C0ACA045AFE6AB641334BF5F69CF2F82DB'
  checksumType  = 'sha256'
