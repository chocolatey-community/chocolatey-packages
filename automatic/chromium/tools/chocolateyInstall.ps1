...
$version = '144.0.7532.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1546390/mini_installer.exe'
  checksum      = 'E504AA43D42B18BA1665D7541B120E1EC3F77D60651B68C9391E4CB301388054'
  checksumType  = 'sha256'
