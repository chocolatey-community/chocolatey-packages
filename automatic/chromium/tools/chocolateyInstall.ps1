...
$version = '139.0.7256.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1477051/mini_installer.exe'
  checksum      = '18355D3FBB2713B837F958BD475F8A13A63408EAF9C3BFF8919270FD02AE56CD'
  checksumType  = 'sha256'
