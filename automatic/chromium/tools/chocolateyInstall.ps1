...
$version = '135.0.7034.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1423756/mini_installer.exe'
  checksum      = '1724B2DB9731413A4299E697444AC41D2A04170DF34218C6C20F6CDC40F1DEAC'
  checksumType  = 'sha256'
