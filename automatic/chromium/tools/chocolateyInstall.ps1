...
$version = '142.0.7437.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1521024/mini_installer.exe'
  checksum      = '3E9FC1B298A3A6C5861AFDC13584A38DD7A077142C9E3759D2DB5E659DAB9C35'
  checksumType  = 'sha256'
