...
$version = '144.0.7551.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1551239/mini_installer.exe'
  checksum      = '9F0C4E9BD8141B184D4BCBBA9F6B2ED4B9743CB026E7E590F925141804631841'
  checksumType  = 'sha256'
