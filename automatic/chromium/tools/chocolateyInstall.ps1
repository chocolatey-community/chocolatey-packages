...
$version = '153.0.7988.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1672397/mini_installer.exe'
  checksum      = '0F935C44E5CE47541159C46D3E9CBB58A0AE276B2701DE1ECABB0B202522DDB7'
  checksumType  = 'sha256'
