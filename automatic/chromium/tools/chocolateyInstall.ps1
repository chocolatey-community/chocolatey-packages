...
$version = '144.0.7520.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1542339/mini_installer.exe'
  checksum      = '55D88EE37DD16F0EAC919FCD89AB5BE305D81E17FB9F7E53A6D3105B19ED3BC8'
  checksumType  = 'sha256'
