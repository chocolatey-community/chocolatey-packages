...
$version = '144.0.7540.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1548852/mini_installer.exe'
  checksum      = 'BDBB44A43D2057C14C59D239C4C6555B5474B3DA9428B3AC849042CDEBF629FB'
  checksumType  = 'sha256'
