...
$version = '134.0.6953.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1405260/mini_installer.exe'
  checksum      = '35DDF5FE420DD222632C12D61CBCB2FBCDB914F75D27C4108DD6C383222E6E1A'
  checksumType  = 'sha256'
