...
$version = '138.0.7172.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1458103/mini_installer.exe'
  checksum      = '5CB5C00F3D1701FC5B23432D94E07123BBABC36D7354572AFE173AD796A27D9A'
  checksumType  = 'sha256'
