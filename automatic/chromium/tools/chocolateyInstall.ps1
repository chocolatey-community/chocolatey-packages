...
$version = '136.0.7090.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1437291/mini_installer.exe'
  checksum      = '83CE09497FB5202AC25FBCA52B9361C0C1E8EB90B31DB7F6FE082A770341B346'
  checksumType  = 'sha256'
