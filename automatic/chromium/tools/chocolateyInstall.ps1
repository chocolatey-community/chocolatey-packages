...
$version = '151.0.7919.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1653736/mini_installer.exe'
  checksum      = '5388B373FEB3B4CB258B21AD0A595151A8F4A1853EF5F6377491147E649D7376'
  checksumType  = 'sha256'
