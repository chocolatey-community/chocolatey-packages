...
$version = '145.0.7566.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1555098/mini_installer.exe'
  checksum      = 'B784F8389AB15937C997DDF2A210898E354740F3A81E0B943BC233AA6B7E142A'
  checksumType  = 'sha256'
