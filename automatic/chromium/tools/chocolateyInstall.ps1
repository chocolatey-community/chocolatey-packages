...
$version = '135.0.7012.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1418525/mini_installer.exe'
  checksum      = '16D4A65D18D7573EAF2409135DBB7EB92C130D02009D706FE594E44AF408BEDE'
  checksumType  = 'sha256'
