...
$version = '145.0.7631.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1567649/mini_installer.exe'
  checksum      = 'E621B33402CB8E61D8F9EA591F07C73DD4A13FBA25DEE3D88EE0469C11961F18'
  checksumType  = 'sha256'
