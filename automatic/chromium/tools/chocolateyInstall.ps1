...
$version = '130.0.6694.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1349781/mini_installer.exe'
  checksum      = '76F96882FEDC0EF3E49E8C06C02A1A9E97D0C64E08E579A6160CD3D05108268D'
  checksumType  = 'sha256'
