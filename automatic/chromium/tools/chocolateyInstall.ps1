...
$version = '131.0.6744.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1361393/mini_installer.exe'
  checksum      = 'EE8F4AF68037FBB705664D3588C464932380DCF58BB8A89E4B49A4859846C890'
  checksumType  = 'sha256'
