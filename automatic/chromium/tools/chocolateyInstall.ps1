...
$version = '136.0.7072.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1433203/mini_installer.exe'
  checksum      = '04FE9234022055E8F0FBB4D8DEAA09B01C73B8C3EFCC80416A93BDA1367A28A5'
  checksumType  = 'sha256'
