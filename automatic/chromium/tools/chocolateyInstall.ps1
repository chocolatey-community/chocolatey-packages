...
$version = '141.0.7376.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1505940/mini_installer.exe'
  checksum      = 'A07F9ED71C815E40AFFD241C265EEA9D701DBDAF5DC84CCEB00550A1993C1C5F'
  checksumType  = 'sha256'
