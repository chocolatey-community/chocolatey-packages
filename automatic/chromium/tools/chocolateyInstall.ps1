...
$version = '143.0.7456.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1525424/mini_installer.exe'
  checksum      = '5AF2D86413F042FB3A4BF676CC4A763FD06644B94701E8481A9882AFD741320C'
  checksumType  = 'sha256'
