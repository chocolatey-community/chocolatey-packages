...
$version = '154.0.8035.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1688734/mini_installer.exe'
  checksum      = 'C328E5065546BD07653C15585CA0D8240CA651FEF28E3CDAB3E7970C72091F9D'
  checksumType  = 'sha256'
