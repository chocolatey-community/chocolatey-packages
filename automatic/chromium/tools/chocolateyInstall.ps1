...
$version = '137.0.7140.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1449693/mini_installer.exe'
  checksum      = '9C55A74E717BCCD5DD6BA0ACA3B1C2AC68AC18151E8CD3F97D931DE072627696'
  checksumType  = 'sha256'
