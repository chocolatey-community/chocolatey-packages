...
$version = '135.0.7002.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1416680/mini_installer.exe'
  checksum      = '571602137CCBD1313F7ACB70174B2FD528EFEC1738CF39D74E7DFF09D29A03F5'
  checksumType  = 'sha256'
