...
$version = '142.0.7414.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1515264/mini_installer.exe'
  checksum      = '25D2DD7F8B2A1786216DA5A98EC1154B98E6D1BAF6FE7E8B2EA6E8F3C5D3DDEA'
  checksumType  = 'sha256'
