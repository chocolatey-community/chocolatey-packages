...
$version = '140.0.7269.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1480296/mini_installer.exe'
  checksum      = 'EAA74A0C60D9CB541FCE99AB4E791DBE346664D431404E6A38CF51F1EE0D51CC'
  checksumType  = 'sha256'
