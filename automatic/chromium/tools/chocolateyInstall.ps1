...
$version = '133.0.6884.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1393341/mini_installer.exe'
  checksum      = 'D5400F8CC5FBAB67E2CD199ED28008DA4E175194109DE9F1AFEB10ABE13AC23C'
  checksumType  = 'sha256'
