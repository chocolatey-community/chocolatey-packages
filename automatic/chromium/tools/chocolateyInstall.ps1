...
$version = '139.0.7217.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1468178/mini_installer.exe'
  checksum      = 'DD3309CD7B8C64B61172EE2BF47A2F06252E6879F3829CEAC9430F8A4FE27A54'
  checksumType  = 'sha256'
