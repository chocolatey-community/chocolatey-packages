...
$version = '138.0.7156.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1454653/mini_installer.exe'
  checksum      = '03458C123833667C1160AC992F0F87A1762B3EF4BD76BD456736762ADC152E4D'
  checksumType  = 'sha256'
