...
$version = '145.0.7596.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1562336/mini_installer.exe'
  checksum      = 'E71CEAEECF42138D3A0B469237603E8BB7643FEB8EF093C347889C67A741B4C3'
  checksumType  = 'sha256'
