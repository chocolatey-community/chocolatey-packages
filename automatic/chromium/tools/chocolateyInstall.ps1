...
$version = '152.0.7947.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1660823/mini_installer.exe'
  checksum      = '49FEEDD64C79A0AE1607E74D4C0BA23E0867CA0627782749927C86E314636982'
  checksumType  = 'sha256'
