...
$version = '154.0.8016.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1683731/mini_installer.exe'
  checksum      = '2293197974A8856EA2E7ED3EF5F1399AC3BE99A475FF2429A7A3EFB1AC3AB2F5'
  checksumType  = 'sha256'
