...
$version = '145.0.7561.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1553692/mini_installer.exe'
  checksum      = '3B76C18937A87CDD5E8DD6BB2D81EF4B6AC8D4D5657F11D4CB59E52526400258'
  checksumType  = 'sha256'
