...
$version = '140.0.7270.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1480324/mini_installer.exe'
  checksum      = 'E01165E42E209D6162B86630C286C1E40FAA2C9C947939EAB835B78C4D057EDE'
  checksumType  = 'sha256'
