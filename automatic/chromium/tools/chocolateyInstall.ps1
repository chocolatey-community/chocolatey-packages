...
$version = '133.0.6890.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1394667/mini_installer.exe'
  checksum      = '0325EED0C4093734EA3F3E7789B9B39982380DAB6D711CF5B0A4E9FC7CE3A794'
  checksumType  = 'sha256'
