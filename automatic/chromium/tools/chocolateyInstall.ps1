...
$version = '132.0.6825.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1379521/mini_installer.exe'
  checksum      = '016B26510A39594F1852EFDD0BEE5263D515688C3B2957A834FF2CD5941C75A8'
  checksumType  = 'sha256'
