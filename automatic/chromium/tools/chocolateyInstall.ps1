...
$version = '153.0.8008.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1679416/mini_installer.exe'
  checksum      = '2A186FD23EBEFC6F5D787CD6A21EB1DECEF2A52A26BFC3545CA9443466529768'
  checksumType  = 'sha256'
