...
$version = '144.0.7511.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1540449/mini_installer.exe'
  checksum      = '21575F5BE6A87A5CD7C897DDACEC7C01AC6A29D2426B07266FA3AF09FAEA3E92'
  checksumType  = 'sha256'
