...
$version = '150.0.7861.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1636160/mini_installer.exe'
  checksum      = '479F7C1FFA0901840E51E15ECBB008AEEF644A16CBB36B2E577AA2E3AE73A477'
  checksumType  = 'sha256'
