...
$version = '145.0.7630.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1567563/mini_installer.exe'
  checksum      = '6E3B4F4BB06B12440F3EBC404E473FCC706AAD7955AB80F559A3D557E2104AD1'
  checksumType  = 'sha256'
