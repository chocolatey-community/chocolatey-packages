...
$version = '130.0.6691.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1349589/mini_installer.exe'
  checksum      = '4FF20ECCF9144DF7780EB6FD3475A9CF2569ED9084DEBA1AD8BE877E187DDA36'
  checksumType  = 'sha256'
