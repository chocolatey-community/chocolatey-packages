...
$version = '139.0.7239.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1473917/mini_installer.exe'
  checksum      = 'E63A19E303DF83032D8FD62310CD52912CB311C77F5FA9D6C880C8F43B5F3ABA'
  checksumType  = 'sha256'
