...
$version = '145.0.7571.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1555886/mini_installer.exe'
  checksum      = '6C3AE58A7C5DBF6B32240C03952E8BDDAB924DB5CB52AEBB7FAF080FC2B62971'
  checksumType  = 'sha256'
