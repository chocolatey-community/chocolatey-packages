...
$version = '144.0.7555.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1551766/mini_installer.exe'
  checksum      = 'EF1560ADB5A6C8A856B7EFA9925705BD369359FD703C2F5A779AFB9C7931572E'
  checksumType  = 'sha256'
