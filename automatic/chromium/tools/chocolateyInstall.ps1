...
$version = '134.0.6987.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1412782/mini_installer.exe'
  checksum      = '3D11DDB13C548F3DC6C6DF70D31A968A621385F200CA8F1F5CAEF52C255CABE7'
  checksumType  = 'sha256'
