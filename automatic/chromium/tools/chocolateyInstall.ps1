...
$version = '135.0.7014.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1419164/mini_installer.exe'
  checksum      = 'A79457EDF4620986741581FF2534E2CEE32C8063AF71E989E3657EE9825D0A9C'
  checksumType  = 'sha256'
