...
$version = '151.0.7903.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1649895/mini_installer.exe'
  checksum      = '5BB4AE938263C363F8CEEF277251DEF85EE0002A7D056EDCD7AFD2208A12A537'
  checksumType  = 'sha256'
