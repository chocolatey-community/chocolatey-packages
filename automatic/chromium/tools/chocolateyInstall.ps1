...
$version = '147.0.7717.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1593460/mini_installer.exe'
  checksum      = '2C99FFBB1B2E82339BA64238FCD5F7E066EEEAB7FC2049F3070C06DDD1C4B56F'
  checksumType  = 'sha256'
