...
$version = '145.0.7582.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1559529/mini_installer.exe'
  checksum      = 'B29FE4B6EA2967FFC5FB79D40CBACAD8322DDF519269C07E5C46375F9A5DCB14'
  checksumType  = 'sha256'
