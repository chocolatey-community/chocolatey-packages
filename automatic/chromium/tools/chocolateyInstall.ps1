...
$version = '140.0.7322.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1492488/mini_installer.exe'
  checksum      = '4B65DE2BF689DBA48F1A4113B0BAFF450444844D0CF1F93723A36379887D62C5'
  checksumType  = 'sha256'
