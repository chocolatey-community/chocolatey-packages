...
$version = '139.0.7222.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1470004/mini_installer.exe'
  checksum      = '7F660CCBD32B332AEF8AEDB450050883DA81C9838EF9F1EBD8DEE06626103DE9'
  checksumType  = 'sha256'
