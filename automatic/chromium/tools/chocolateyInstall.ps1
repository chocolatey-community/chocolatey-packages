...
$version = '128.0.6609.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1330716/mini_installer.exe'
  checksum      = 'BB47BDDDD6E8C673220813BD62E9E71D9E2A8EDE9F5E8985005D97239353005F'
  checksumType  = 'sha256'
