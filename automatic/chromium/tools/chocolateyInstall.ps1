...
$version = '129.0.6623.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1333993/mini_installer.exe'
  checksum      = '56884B1B7DCB1F3989C229EF237A888E9C8120350F12F80CD48F37D65EEC8FAF'
  checksumType  = 'sha256'
