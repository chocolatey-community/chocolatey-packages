...
$version = '136.0.7087.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1436586/mini_installer.exe'
  checksum      = 'DAD8A830CBC597AFC9196B5BF520BFDF244A0DA77328FA6426BB003286A2466B'
  checksumType  = 'sha256'
