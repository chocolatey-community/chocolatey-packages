...
$version = '142.0.7430.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1518934/mini_installer.exe'
  checksum      = 'ADDD39389251C880407047175580595E1D1CF5CA0D004BA5BFC93B44A0033EED'
  checksumType  = 'sha256'
