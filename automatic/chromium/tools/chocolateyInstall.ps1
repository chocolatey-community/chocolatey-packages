...
$version = '133.0.6897.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1396407/mini_installer.exe'
  checksum      = '23E4D2EC5932EA427968BC6BB7A9271B8283AA2FE72F482C9791C68A293DCE3B'
  checksumType  = 'sha256'
