...
$version = '144.0.7510.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1540322/mini_installer.exe'
  checksum      = 'DEEA4A9D20FD8C31B50C159DB7EC8958B5997B134AAFB1DB481E7BDB2866954B'
  checksumType  = 'sha256'
