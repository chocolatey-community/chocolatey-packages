...
$version = '131.0.6732.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1358586/mini_installer.exe'
  checksum      = '6457B758B80711331066ABD537C21392359C4F358C4FF2FD934BC8F372142270'
  checksumType  = 'sha256'
