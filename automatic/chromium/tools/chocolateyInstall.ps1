...
$version = '129.0.6619.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1333408/mini_installer.exe'
  checksum      = '3C0CC7E6887A4F1A591454D9DD5159E7E64A8113654AC79CCCB7632D7D546C26'
  checksumType  = 'sha256'
