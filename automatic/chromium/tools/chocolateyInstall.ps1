...
$version = '128.0.6607.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1330546/mini_installer.exe'
  checksum      = 'E8187E643310DFFB827C3E17122149D187CC6A65577886B8CA0067D413DA68C7'
  checksumType  = 'sha256'
