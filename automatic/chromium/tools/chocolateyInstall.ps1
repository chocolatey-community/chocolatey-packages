...
$version = '151.0.7884.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1643772/mini_installer.exe'
  checksum      = '7A8C1B3A993BB264A7247EF761F7722B19EFC82270E6830BA8908CFD4CE9A1D1'
  checksumType  = 'sha256'
