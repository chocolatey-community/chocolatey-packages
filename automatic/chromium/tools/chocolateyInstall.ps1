...
$version = '133.0.6908.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1399072/mini_installer.exe'
  checksum      = '143E738DF40293AF74B5C1E7E26B53F08C7834F6215246242C699C6E417FC347'
  checksumType  = 'sha256'
