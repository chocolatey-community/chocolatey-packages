...
$version = '142.0.7435.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1520274/mini_installer.exe'
  checksum      = '1C0BF4ECC65605FEB124D4317015B308DCD137154EDAEF1D03A1A49CB6A5E716'
  checksumType  = 'sha256'
