...
$version = '130.0.6707.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1352517/mini_installer.exe'
  checksum      = 'DBC014AFCE3D5A72914E9860699E0F1EF3BCF04E417373CD282CCB1DD5B2FED5'
  checksumType  = 'sha256'
