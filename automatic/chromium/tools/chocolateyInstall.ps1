...
$version = '138.0.7184.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1461596/mini_installer.exe'
  checksum      = '47CE5F6726B349138788A77FD18C07FF5B2E82DFF17C4424DB8FFF22EB512044'
  checksumType  = 'sha256'
