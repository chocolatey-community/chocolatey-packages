...
$version = '144.0.7542.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1548933/mini_installer.exe'
  checksum      = 'D7CE7206C5B87284911DCEB70CD924ECD7C807B8B09C5B15BBEDAAAB539AEDED'
  checksumType  = 'sha256'
