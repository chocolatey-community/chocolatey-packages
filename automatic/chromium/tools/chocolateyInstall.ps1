...
$version = '132.0.6798.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1373790/mini_installer.exe'
  checksum      = 'DD8A3F7465A9580F911CEF070F6C7665CDF88A6A93AD722E146BEA576607A1A5'
  checksumType  = 'sha256'
