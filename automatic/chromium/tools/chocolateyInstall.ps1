...
$version = '144.0.7550.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1550941/mini_installer.exe'
  checksum      = 'B611FD02B4F6DAD0A752945F0C300C6F77A8DAD2560F695BC09BDFAD684C0225'
  checksumType  = 'sha256'
