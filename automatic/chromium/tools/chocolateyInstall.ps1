...
$version = '139.0.7250.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1476193/mini_installer.exe'
  checksum      = 'DCC53BC76D78574EC3526B5455C9BDAF14750738035E99116C61DE86ED0AFDD5'
  checksumType  = 'sha256'
