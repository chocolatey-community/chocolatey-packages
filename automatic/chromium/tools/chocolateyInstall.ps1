...
$version = '134.0.6949.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1404661/mini_installer.exe'
  checksum      = 'E3F2833AA8F902C9221F8ADF9D5C718EC44C0DC92C986C42DC68C7241ECBF9BE'
  checksumType  = 'sha256'
