...
$version = '126.0.6475.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1299803/mini_installer.exe'
  checksum      = '020CF4D6593E3885156668575C48A48F9CEC07E92F03234427FF4CD8D605343E'
  checksumType  = 'sha256'
