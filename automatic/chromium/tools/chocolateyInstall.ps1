...
$version = '133.0.6844.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1384117/mini_installer.exe'
  checksum      = '320840239BAF6DA7267609C75FDF67DC83B305620A55F57D4C686C6208EDF1E6'
  checksumType  = 'sha256'
