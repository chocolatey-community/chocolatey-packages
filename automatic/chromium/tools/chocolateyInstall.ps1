...
$version = '142.0.7415.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1515323/mini_installer.exe'
  checksum      = 'A85E017C7D8A52958740D4B0350E47CF11A86650FCBE2BE35E3A944767B02DC4'
  checksumType  = 'sha256'
