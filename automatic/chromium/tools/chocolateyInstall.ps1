...
$version = '143.0.7478.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1531341/mini_installer.exe'
  checksum      = 'F315792851047F0968DE83B2420D407FA214FD966BE43DC12859F47166DFCC14'
  checksumType  = 'sha256'
