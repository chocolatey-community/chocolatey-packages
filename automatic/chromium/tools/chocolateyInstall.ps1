...
$version = '143.0.7450.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1524546/mini_installer.exe'
  checksum      = '12C24FAA6ECBC6988F963F4E17CE222FCB321C726C985200FA8658F2023B3669'
  checksumType  = 'sha256'
