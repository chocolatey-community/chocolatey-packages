...
$version = '143.0.7482.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1531934/mini_installer.exe'
  checksum      = '861954268AE42119DFE7BA51BE986A3EE96BB1583F279B9FD4805494B2D338CB'
  checksumType  = 'sha256'
