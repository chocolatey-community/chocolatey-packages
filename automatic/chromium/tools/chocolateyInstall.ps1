...
$version = '143.0.7466.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1528489/mini_installer.exe'
  checksum      = '91E13D896E693DAEC3EC3BEE7EE5DAE4D11E8B57FFA04B3672924AA76ABE709C'
  checksumType  = 'sha256'
