...
$version = '137.0.7123.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1446127/mini_installer.exe'
  checksum      = 'D3F5C8B12C785324A18958CBE3E58667830B7E7D622FEDA24D30DEB437E1B0BA'
  checksumType  = 'sha256'
