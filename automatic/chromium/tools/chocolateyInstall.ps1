...
$version = '151.0.7883.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1643213/mini_installer.exe'
  checksum      = '3BAA77152C7831A847E16AC4F4688D277C4B3086DF416720E317DD7C125CF3B0'
  checksumType  = 'sha256'
