...
$version = '145.0.7615.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1564074/mini_installer.exe'
  checksum      = 'F9D04E9BF1EC5F62913220C7C6CB2BA0FA023237118D0B36EAF01E380A5F7297'
  checksumType  = 'sha256'
