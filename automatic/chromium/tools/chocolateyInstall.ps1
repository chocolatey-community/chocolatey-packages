...
$version = '152.0.7943.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1660120/mini_installer.exe'
  checksum      = '7614CFB41C3D99DCF6B37C0DEFCF3030D17ED1229B5E379C38C908AE26574655'
  checksumType  = 'sha256'
