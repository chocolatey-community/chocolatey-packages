...
$version = '139.0.7229.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1471097/mini_installer.exe'
  checksum      = 'E429BC1F48CD811CD41D3E1B4EC76FFF760FA931C11B96FBCAF5DD3E5463ED51'
  checksumType  = 'sha256'
