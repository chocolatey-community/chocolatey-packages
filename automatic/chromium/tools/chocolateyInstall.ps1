...
$version = '151.0.7922.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1654292/mini_installer.exe'
  checksum      = '98BE10ED40D639C221A8379E6B902C2A37F2F3C3E0881AF9B223D78FF5AD1D28'
  checksumType  = 'sha256'
