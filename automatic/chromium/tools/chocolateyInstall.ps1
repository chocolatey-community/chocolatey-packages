...
$version = '138.0.7202.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1465246/mini_installer.exe'
  checksum      = 'FCB494F8AC9D7E81CF2D16EE055A2E79143DB24E8255D6BBF76AE3F435650F82'
  checksumType  = 'sha256'
