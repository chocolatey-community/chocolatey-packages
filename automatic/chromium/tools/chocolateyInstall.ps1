...
$version = '136.0.7080.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1435217/mini_installer.exe'
  checksum      = '42B3F1C85D5FD8E1ED60FE2090D0EEEF74DAB2CB80146A2A2F341B9388643947'
  checksumType  = 'sha256'
