...
$version = '135.0.7033.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1423726/mini_installer.exe'
  checksum      = '1780484599D8B2FB265EEFFC7C9B5BD3787DB4FF5A40BBC0D4E7445033F7EFDD'
  checksumType  = 'sha256'
