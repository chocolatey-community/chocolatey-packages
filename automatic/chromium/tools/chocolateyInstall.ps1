...
$version = '137.0.7130.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1448197/mini_installer.exe'
  checksum      = 'CC339EAF8EA18E3F430119C776CAD21F7DBE05017D443946CE69CC3B89E7E81D'
  checksumType  = 'sha256'
