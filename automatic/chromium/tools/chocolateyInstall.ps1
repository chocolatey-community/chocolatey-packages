...
$version = '131.0.6750.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1361977/mini_installer.exe'
  checksum      = '96313897ACF6F563106ED0A024AF9988EE76CBAB8131DB33550E68278120C782'
  checksumType  = 'sha256'
