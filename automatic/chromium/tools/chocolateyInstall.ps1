...
$version = '130.0.6723.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1355984/mini_installer.exe'
  checksum      = 'F1813B6D257979C9CA7990349EAA146506C54FE0B4B2020DF581C39D77197CC4'
  checksumType  = 'sha256'
