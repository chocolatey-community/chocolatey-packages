...
$version = '153.0.7980.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1670484/mini_installer.exe'
  checksum      = 'DC3DE81B75863026933DD434B0CA8F5E686EF0708C65A42B15835E1EC5E97DC3'
  checksumType  = 'sha256'
