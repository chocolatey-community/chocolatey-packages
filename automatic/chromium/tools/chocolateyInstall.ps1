...
$version = '129.0.6662.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1343080/mini_installer.exe'
  checksum      = '0993D6A9F4F0A851F6573B7311A3954DEDF36978EA43625FBB408855F7C4080C'
  checksumType  = 'sha256'
