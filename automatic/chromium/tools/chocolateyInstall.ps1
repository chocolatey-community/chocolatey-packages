...
$version = '128.0.6553.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1318301/mini_installer.exe'
  checksum      = 'D338EB6E74107A37D2C279B84E2B28F6B477D237C69A3259D6A36D124AB56BAB'
  checksumType  = 'sha256'
