...
$version = '141.0.7354.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1500244/mini_installer.exe'
  checksum      = 'DEC5F89AFE15595047D0CFB65DB4CF50210C62CD94965CAF5262528DD3E6DCA7'
  checksumType  = 'sha256'
