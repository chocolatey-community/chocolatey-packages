...
$version = '146.0.7667.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1578381/mini_installer.exe'
  checksum      = '7F68DC733528E57CBDB125D555CA2EB4F8BC6555C70963C901A4B524220DA5F4'
  checksumType  = 'sha256'
