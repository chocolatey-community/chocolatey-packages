...
$version = '129.0.6636.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1336995/mini_installer.exe'
  checksum      = 'C5E8F20B2F0C90CFB9B94519EEA14CF7463E7B37C8DD8CA3EBDB3911C65589D2'
  checksumType  = 'sha256'
