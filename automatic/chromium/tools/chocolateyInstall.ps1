...
$version = '132.0.6780.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1369253/mini_installer.exe'
  checksum      = 'BAAAE774D6803BBBEA5996A891B1223D3E5FA9CFADB042EF1213E9E508EE3B75'
  checksumType  = 'sha256'
