...
$version = '133.0.6941.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1402200/mini_installer.exe'
  checksum      = '562DD918CA331FF5A6E2292A4560023EDD2067065E3B903B385CAFF5B6E2D2B6'
  checksumType  = 'sha256'
