...
$version = '139.0.7233.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1472187/mini_installer.exe'
  checksum      = 'F9A6D4496F39B25DE6F4665557FA3F46370D701A7761BE1709095DEDAADCEBD8'
  checksumType  = 'sha256'
