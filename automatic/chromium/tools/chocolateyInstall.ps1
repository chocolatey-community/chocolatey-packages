...
$version = '142.0.7442.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1521928/mini_installer.exe'
  checksum      = '09A4B044BBDA41173F95FA07757D289251453C15B95E123CAF543C522756AFD0'
  checksumType  = 'sha256'
