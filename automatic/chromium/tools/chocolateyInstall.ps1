...
$version = '153.0.7998.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1676132/mini_installer.exe'
  checksum      = '8B0E5FB596511223BBED3FE960F8760B0BCAB5E0A927DF91DD50F28323F6AC5E'
  checksumType  = 'sha256'
