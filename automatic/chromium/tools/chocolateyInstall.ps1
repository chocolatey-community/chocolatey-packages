...
$version = '144.0.7515.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1541670/mini_installer.exe'
  checksum      = 'A0E2F658F54602E1AE5A461BC22463F36E89C235B7C7F0E0D2533158D932BAEA'
  checksumType  = 'sha256'
