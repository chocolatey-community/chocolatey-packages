...
$version = '144.0.7541.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1548881/mini_installer.exe'
  checksum      = '129BE630E40067D4A3671B237681AAD21833C4284EAA70176ABD6F2EA026CB02'
  checksumType  = 'sha256'
