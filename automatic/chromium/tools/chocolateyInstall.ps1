...
$version = '134.0.6980.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1411351/mini_installer.exe'
  checksum      = '6E6B9094878F6BEB4EFEFF534C6AC1989947742A45A5720ABE66DA34548F0FEC'
  checksumType  = 'sha256'
