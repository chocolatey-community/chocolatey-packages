...
$version = '133.0.6921.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1400364/mini_installer.exe'
  checksum      = '4357A81D05B59D11C57E4D85EF1B59325C29C20F0254E5235B0AD4633764DECF'
  checksumType  = 'sha256'
