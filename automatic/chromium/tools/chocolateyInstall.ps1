...
$version = '151.0.7916.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1653413/mini_installer.exe'
  checksum      = '215EB30B5B468C19B32ECE9E4540E45410B3478FEDEBA65DE86831640477C2E0'
  checksumType  = 'sha256'
