...
$version = '128.0.6555.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1318378/mini_installer.exe'
  checksum      = '5D8CFE3D944460C6454F6A2111F6BB0FE2A99D80EB52C3559D0A736347FD35C9'
  checksumType  = 'sha256'
