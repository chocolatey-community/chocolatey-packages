...
$version = '150.0.7838.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1629336/mini_installer.exe'
  checksum      = '50BB833210E57971734E1DC34077BFE67B4F79516623D9EF6606E93BF8E4007C'
  checksumType  = 'sha256'
