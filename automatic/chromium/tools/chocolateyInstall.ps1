...
$version = '151.0.7875.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1641669/mini_installer.exe'
  checksum      = '6B4F5B43D54AE33CAB999F18C7D96198506EC9116E2085EB8940FD1E72E5CE20'
  checksumType  = 'sha256'
