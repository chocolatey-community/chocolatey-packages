...
$version = '145.0.7605.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1562964/mini_installer.exe'
  checksum      = 'FF6A3C1D391EDE5F4B09E2BBE5CB80E241ECEE22623772E3C49860505DACE7E9'
  checksumType  = 'sha256'
