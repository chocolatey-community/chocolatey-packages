...
$version = '140.0.7315.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1490863/mini_installer.exe'
  checksum      = '39EADB7A8878A4D15A10BCD9668BE5ABCCA4BE3FC69A369B8B56927D3514BDF4'
  checksumType  = 'sha256'
