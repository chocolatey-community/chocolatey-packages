...
$version = '142.0.7397.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1511916/mini_installer.exe'
  checksum      = 'C5F33F0D848FE8219123AD7077DDEB6F7004BAB11C13FE57DB3B668C5CCE87B3'
  checksumType  = 'sha256'
