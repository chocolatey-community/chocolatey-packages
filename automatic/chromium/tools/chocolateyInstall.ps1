...
$version = '151.0.7889.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1645539/mini_installer.exe'
  checksum      = 'EE79D1249326FE14E610F6A5D05E1E119F32240CB6AD934CCFF68F49EF062C31'
  checksumType  = 'sha256'
