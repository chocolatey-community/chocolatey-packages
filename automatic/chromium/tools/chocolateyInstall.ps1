...
$version = '152.0.7976.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1668404/mini_installer.exe'
  checksum      = 'D7515588F4C413FFABC996D7F85E1D84347A1F8708A15D932C2E765B4CB1BDE6'
  checksumType  = 'sha256'
