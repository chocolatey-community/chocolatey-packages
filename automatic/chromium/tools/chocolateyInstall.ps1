...
$version = '140.0.7280.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1482862/mini_installer.exe'
  checksum      = '1DE2599748FDBC96A568F3DC7D6FDBAEC2539F66D3CC539B1EC4C7909AD0A8D2'
  checksumType  = 'sha256'
