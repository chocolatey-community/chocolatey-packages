...
$version = '138.0.7177.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1459078/mini_installer.exe'
  checksum      = '6B3A8FC8EFC70E7B8C9968FF3DFE3B389FAADE982E9FDBA2F0F39CE1B27DF3EE'
  checksumType  = 'sha256'
