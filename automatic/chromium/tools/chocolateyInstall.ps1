...
$version = '127.0.6479.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1300505/mini_installer.exe'
  checksum      = '7ACEF05876ED3AF571C2036FE136E46935EFC3B619228AEB9891E19488693AAD'
  checksumType  = 'sha256'
