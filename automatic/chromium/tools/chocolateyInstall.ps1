...
$version = '135.0.7041.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1425967/mini_installer.exe'
  checksum      = 'D4499EAE4C7DD3FEEE9B387F4ED03E6A793D406ED688367D2093CCAE4FB6F2B6'
  checksumType  = 'sha256'
