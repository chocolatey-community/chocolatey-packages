...
$version = '137.0.7112.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1443177/mini_installer.exe'
  checksum      = '288E834401E7D9573E9BDCD76A5EDF6AD7AF963DD661DC322AC186A40D06F5C8'
  checksumType  = 'sha256'
