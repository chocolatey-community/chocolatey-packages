...
$version = '132.0.6781.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1369435/mini_installer.exe'
  checksum      = 'B31AB7D13157650E1FFB785B7C8A82824994EC463091558BFB2B98D0287D82FD'
  checksumType  = 'sha256'
