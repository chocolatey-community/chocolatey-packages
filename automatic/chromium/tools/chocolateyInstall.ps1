...
$version = '132.0.6803.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1374420/mini_installer.exe'
  checksum      = '98ED4BA4AB3FAD1D20BDB814D56805250C526A12145D9DD279BF44505B5F6EB6'
  checksumType  = 'sha256'
