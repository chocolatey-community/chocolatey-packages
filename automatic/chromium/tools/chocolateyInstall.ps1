...
$version = '130.0.6679.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1346473/mini_installer.exe'
  checksum      = '82093F5F3C1ED38C6B87155521E6CB6337F618C8DD3BA71909C8A137BB83A4E8'
  checksumType  = 'sha256'
