...
$version = '137.0.7122.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1445657/mini_installer.exe'
  checksum      = '3EDD9CCD6B21B7AB2E384BD93D01018CE3C29C84C0E2263C7AD0C0A375C4BEAC'
  checksumType  = 'sha256'
