...
$packageArgs = @{
  ...
  checksum       = 'af79f9d97329a5d7f5c06d15b4199407dc3b168c839dc02db72900baacc1c5ac'
  checksumType   = 'sha256'
...
if (Is-NanoServer) {
  ...
  $packageArgs.checksum = 'b8e8b3ff46896ed515cea0e8e4da0ffa44d2a81230aa35365ef7343c11f0a579'
 }
