...
$packageArgs = @{
  ...
  checksum       = 'e45ce0b3fd6d0457e253f132ef086c6c4715def16e59433de2cb5dfe2c16a76f'
  checksumType   = 'sha256'
...
if (Is-NanoServer) {
  ...
  $packageArgs.checksum = '9156608f9ba49ea14b8b7cdff8cf48449d225d162a2ce1f96645f1a8d66741be'
 }
