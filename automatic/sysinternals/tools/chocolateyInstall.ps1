...
$packageArgs = @{
  ...
  checksum       = 'cd1e4efbc269177824910129dd1445066547a7cac8f0e81d7bbd746697d2c158'
  checksumType   = 'sha256'
...
if (Is-NanoServer) {
  ...
  $packageArgs.checksum = '49e3150cf6cb15cedaeaf2471fa3c73b6c3cea64f1d7e020d55c1438d018f748'
 }
