...
$packageArgs = @{
  ...
  checksum       = '41761a30a92792469abc2f6236137d7314f0c67a95baf84e15773f8bdccddaaf'
  checksumType   = 'sha256'
...
if (Is-NanoServer) {
  ...
  $packageArgs.checksum = '89b5bdf2cd17612861cb334356785e8b4cccc457a56e5a6423584f7a11c819d6'
 }
