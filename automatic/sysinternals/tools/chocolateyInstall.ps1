...
$packageArgs = @{
  ...
  checksum       = 'a0ece4c52ee9c71c3c02038245d3e0b3c6150fff0e26bd7bdf882fc7ee54cf69'
  checksumType   = 'sha256'
...
if (Is-NanoServer) {
  ...
  $packageArgs.checksum = 'bbcefbb7d9a5024857a5a979466bfbe37ee58c4f93d7c278a6809825516a90a0'
 }
