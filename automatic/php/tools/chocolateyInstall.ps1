...
$filesInfo = @{
  filets32  = "$toolsPath\php-8.3.33-Win32-vs16-x86.zip"
  filets64  = "$toolsPath\php-8.3.33-Win32-vs16-x64.zip"
  filents32 = "$toolsPath\php-8.3.33-nts-Win32-vs16-x86.zip"
  filents64 = "$toolsPath\php-8.3.33-nts-Win32-vs16-x64.zip"
}
