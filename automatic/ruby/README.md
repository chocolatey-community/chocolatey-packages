# <img src="https://cdn.jsdelivr.net/gh/chocolatey-community/chocolatey-packages@aad7c15bfbec43c3716f8a82bc3af22e1a55579d/icons/ruby.svg" alt="red beryl icon" width="48" height="48" /> [ruby](https://chocolatey.org/packages/ruby)
...
```pwsh
choco install ruby --package-parameters="'/NoPath /InstallDir:C:\your\install\path'"
```
