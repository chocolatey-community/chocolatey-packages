...
$packageArgs = @{
  ...
  url           = 'https://product-downloads.atlassian.com/software/sourcetree/windows/ga/SourcetreeEnterpriseSetup_3.0.8.msi'
  checksum      = '270839714ed9c112c32e8d0439f1286595cdf6ed6d1d80d3c6810da62bb937b1'
  checksumType  = 'sha256'
  url64bit      = ''
  checksum64    = ''
