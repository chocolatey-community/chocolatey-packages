...
$packageArgs = @{
  ...
  url           = 'https://product-downloads.atlassian.com/software/sourcetree/windows/ga/SourcetreeEnterpriseSetup_3.4.27.msi'
  checksum      = '8999c801177338dab61680b1d80c6f2e131f6a8220565425203e87f2b60da659'
  checksumType  = 'sha256'
  url64bit      = ''
  checksum64    = ''
