...
$packageArgs = @{
  ...
  url           = 'https://product-downloads.atlassian.com/software/sourcetree/windows/ga/SourcetreeEnterpriseSetup_3.4.25.msi'
  checksum      = 'aa60cb1895bd2c0665b1bc873410b36fccc9ef98adb0b11f47a32c2e69f350bd'
  checksumType  = 'sha256'
  url64bit      = ''
  checksum64    = ''
