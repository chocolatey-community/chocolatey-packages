...
$packageArgs = @{
  ...
  url           = 'https://product-downloads.atlassian.com/software/sourcetree/windows/ga/SourcetreeEnterpriseSetup_3.4.29.msi'
  checksum      = 'bb37cdf2006e6351338866e5da6926a12de9f24ad10124362b1c312a3f6ff85b'
  checksumType  = 'sha256'
  url64bit      = ''
  checksum64    = ''
