...
$packageArgs = @{
  ...
  url           = 'https://product-downloads.atlassian.com/software/sourcetree/windows/ga/SourcetreeEnterpriseSetup_3.4.28.msi'
  checksum      = '950d4f93aa8bfed389bade9a81684411aedca39ecec76576289bfc9d9999df29'
  checksumType  = 'sha256'
  url64bit      = ''
  checksum64    = ''
