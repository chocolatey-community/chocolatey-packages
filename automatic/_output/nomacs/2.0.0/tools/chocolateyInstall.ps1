...
$urlsArray = @('http://sourceforge.net/projects/nomacs/files/nomacs-2.0.0/nomacs-setup-2.0.0-x86.exe/download', 'http://sourceforge.net/projects/nomacs/files/nomacs-2.0.0/nomacs-setup-2.0.0-x64.exe/download')
