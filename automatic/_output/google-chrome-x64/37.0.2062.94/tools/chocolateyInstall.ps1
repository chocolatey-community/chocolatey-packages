...
$fileType = 'exe'
$silentArgs = ''
$url = 'https://dl.google.com/tag/s/appguid={8A69D345-D564-463C-AFF1-A69D9E530F96}&iid={00000000-0000-0000-0000-000000000000}&lang=en&browser=4&usagestats=0&appname=Google%2520Chrome&needsadmin=prefers&ap=x64-stable/update2/installers/ChromeSetup.exe'
