...
$urlsArray = @('http://sourceforge.net/projects/avidemux/files/avidemux/2.6.8/avidemux_2.6.8_win32_v2.exe/download', 'http://sourceforge.net/projects/avidemux/files/avidemux/2.6.8/avidemux_2.6.8_win64_v2.exe/download')
$url = $urlsArray[0]
