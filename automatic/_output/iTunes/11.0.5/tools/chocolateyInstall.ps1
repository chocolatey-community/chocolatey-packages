$packageName = 'iTunes'
$url = 'http://appldnld.apple.com/iTunes11/091-9269.20130816.Azfre/iTunesSetup.exe'
$url64 = 'http://appldnld.apple.com/iTunes11/091-9270.20130816.Qw23e/iTunes64Setup.exe'
$fileType = 'msi'
$silentArgs = '/quiet'
