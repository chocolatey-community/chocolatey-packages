$packageName = 'iTunes'
$url = 'https://secure-appldnld.apple.com/iTunes11/091-9971.20131002.nerpF/iTunesSetup.exe'
$url64 = 'https://secure-appldnld.apple.com/iTunes11/091-9972.20131002.Edoir/iTunes64Setup.exe'
$fileType = 'msi'
$silentArgs = '/quiet'
