$packageName = 'iTunes'
$version = '12.0.1'
$url = 'https://secure-appldnld.apple.com/iTunes12/031-08058.20141016.34epp/iTunesSetup.exe'
$url64 = 'https://secure-appldnld.apple.com/iTunes12/031-08059.20141016.FrPFF/iTunes64Setup.exe'
$fileType = 'msi'
