$packageName = 'iTunes'
$url = 'https://secure-appldnld.apple.com/iTunes11/041-8597.20130918.PmmEw/iTunesSetup.exe'
$url64 = 'https://secure-appldnld.apple.com/iTunes11/041-8598.20130918.Exe55/iTunes64Setup.exe'
$fileType = 'msi'
$silentArgs = '/quiet'
