$packageName = 'iTunes'
$version = '11.2'
$url = 'https://secure-appldnld.apple.com/iTunes11/031-2406.20140515.33RPt/iTunesSetup.exe'
$url64 = 'https://secure-appldnld.apple.com/iTunes11/031-2407.20140515.Bbh8U/iTunes64Setup.exe'
$fileType = 'msi'
