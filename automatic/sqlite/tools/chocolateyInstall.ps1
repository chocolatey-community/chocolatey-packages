...
$packageArgs = @{
    PackageName    = 'sqlite'
    FileFullPath   = "$toolsDir\sqlite-dll-win-x86-3520000.zip"
    FileFullPath64 = "$toolsDir\sqlite-dll-win-x64-3520000.zip"
...
if (!$pp.NoTools) {
    ...
    $packageArgs.FileFullPath64 = "$toolsDir\sqlite-tools-win-x64-3520000.zip"
    Get-ChocolateyUnzip @packageArgs
}
