...
$alreadyInstalled = (AlreadyInstalled -product $softwareName -version '140.11.1')
...
$builds = @{
  'x86' = @{ Url = "https://download.mozilla.org/?product=thunderbird-140.11.1esr&os=win&lang=${locale}"; Checksum = $checksums.Win32 }
  'x64' = @{ Url = "https://download.mozilla.org/?product=thunderbird-140.11.1esr&os=win64&lang=${locale}"; Checksum = $checksums.Win64 }
  ...
  'arm64' = @{ Url = "https://download.mozilla.org/?product=thunderbird-140.11.1esr&os=win64-aarch64&lang=${locale}"; Checksum = $checksums.Win64Arm64 }
}
