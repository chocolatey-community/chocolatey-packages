...
$alreadyInstalled = (AlreadyInstalled -product $softwareName -version '115.10.1')
...
$packageArgs = @{
  ...
  ChecksumType = 'sha512'
  Url = "https://download.mozilla.org/?product=thunderbird-115.10.1-SSL&os=win&lang=${locale}"
...
if (!(Get-32bitOnlyInstalled($softwareName)) -and (Get-OSArchitectureWidth 64)) {
  ...
  $packageArgs.Url64 = "https://download.mozilla.org/?product=thunderbird-115.10.1-SSL&os=win64&lang=${locale}"
}
